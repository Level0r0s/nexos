...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/modules/Reviews/language/english/reviews.php,v $
  $Revision: 1.7 $
  $Author: phoenix $
...
define('_RCREATEACCOUNT','<a href="'.URL::index("Your_Account").'">Create</a> an account');
...
define('_MODREVINFO','You can simply delete/modify reviews by browsing <a href="'.URL::index('Reviews').'">Reviews</a> as Admin.');
