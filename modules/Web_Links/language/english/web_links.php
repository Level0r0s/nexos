...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/modules/Web_Links/language/english/web_links.php,v $
  $Revision: 1.12 $
  $Author: phoenix $
...
define('_SUBMITONCE','Submit a unique link only once.<br />(remember the slash at the end of the URL)');
...
define('_LINKSNOTUSER8','<a href="'.URL::index("Your_Account").'">Register for an Account</a>');
...
define('_ONLYREGUSERSMODIFY','Only registered users can suggest links modifications. Please <a href="'.URL::index("Your_Account").'">register or login</a>.');
...
define('_RATENOTE4','You can view a list of the <a href="'.URL::index("&amp;l_op=TopRated").'">Top Rated Resources</a>.');
...
//Missing lang defines
define('_OWNER','Owner');
define('_ACCEPT','Accept');
define('_LADMIN','Administration');
