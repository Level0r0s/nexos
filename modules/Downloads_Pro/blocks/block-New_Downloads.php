...
/******************************************************
  ...
  *****************************************************
  ...
  $Source: /cvs/modules/Downloads_Pro/blocks/block-New_Downloads.php,v $
  $Revision: 1.5 $
  $Author: phoenix $
...
$a = 1;
$result = $db->sql_query("SELECT lid, title FROM ".$dl_mod_prefix."_downloads WHERE active=1 ORDER BY date DESC LIMIT 0,10");
