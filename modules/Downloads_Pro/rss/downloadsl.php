...
/******************************************************
  ...
  *****************************************************
  ...
  $Source: /cvs/modules/Downloads_Pro/rss/downloadsl.php,v $
  $Revision: 1.2 $
  $Author: phoenix $
...
$result = $db->sql_query('SELECT lid, title, desc_short, date FROM '.$prefix.'_downloads_downloads WHERE active=1 '.$where.' ORDER BY updated DESC LIMIT 10');
