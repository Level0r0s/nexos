...
/**
 *    CPG Table style diff formatter.
 * 
 */
class TableDiffFormatter extends DiffFormatter
{
  ...
  function _block_header( $xbeg, $xlen, $ybeg, $ylen ) {
    ...
    $l1 = $lang['line'].' '.$xbeg;
    $l2 = $lang['line'].' '.$ybeg;
        $r = '<tr><td class="row1" colspan="2">'.$l1.":</td>\n" .
          '<td class="row2" colspan="2">'.$l2.":</td></tr>\n";
        return $r;
    }
    ...
    $line = str_replace('  ','&nbsp; ',$line);
        return '<td>+</td><td class="row2" style="color: #090;">'.$line.'</td>';
    }

    function deletedLine( $line ) {
        $line = str_replace('  ','&nbsp; ',$line);
        return '<td>-</td><td class="row2" style="color: #900;">'.$line.'</td>';
    }
    ...
    function contextLine( $line ) {
        $line = str_replace('  ','&nbsp; ',$line);
        return '<td> </td><td class="row2" style="color: #009;">'.$line.'</td>';
    }
