 ...
 *
 * 07-22-04 changed vars to be more compatable with gameservers RA Butterbean
 */
...
/* some vars */
$i=4;
$output['game']      	= $this->aux->tribesString($d, $i, FALSE);
$output['version']   	= $this->aux->tribesString($d, $i, FALSE);
