...
class FCKeditor
{
	...
	function FCKeditor($instanceName, $width='100%', $height='300px', $value='')
 	{
...
/* 	// PHP 4 Contructor
	function FCKeditor($instanceName, $width='100%', $height='300px', $value='')
	{
		$this->__construct($instanceName, $width='100%', $height='300px', $value='') ;
	} */
...
//			$Link = $this->BasePath.'editor/'.$File.'?InstanceName='.$this->InstanceName;
			$Link = "includes/wysiwyg/fckeditor/editor/fckeditor.html?InstanceName={$this->InstanceName}";
