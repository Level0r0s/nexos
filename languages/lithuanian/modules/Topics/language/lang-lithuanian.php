...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/lithuanian/modules/Topics/language/lang-lithuanian.php,v $
  $Revision: 1.2 $
  $Author: akamu $
  $Date: 2004/10/09 04:26:38 $
***********************************************************************/
if (!defined('CPG_NUKE')) { die('You do not have permission to access this file'); }
define('_ACTIVETOPICS','Aktyvios temos');
define('_CLICK2LIST','Paspauskite, kad pamatytumėte visus straipsnius šioje temoje');
define('_TOTNEWS','Viso naujienų');
define('_TOTREADS','Viso perskaityta');
define('_MORE','Daugiau');
define('_NONEWSYET','...Nėra naujienų šioje temoje...');
