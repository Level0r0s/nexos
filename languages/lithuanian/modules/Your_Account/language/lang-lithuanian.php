...
***************************************************************
  ...
  Last modification:
  Now UTF-8 encoded                                                    
  $Id: lang-lithuanian.php,v 1.2 2004/10/09 04:26:38 akamu Exp $    
***************************************************************/
...
define('_BLANKFORAUTO','Palikite tusčią, jei norite, kad slaptažodis būtų sugeneruotas automatiškai');
...
define('_THISISYOURPAGE','Tai jūsų asmeninis puslapis');
define('_PERSONALINFO','Asmeninė informacija');
...
define('_WEBSITE','Interneto svetainė');
define('_RA_LOCATION','Location');
define('_RA_OCCUPATION','Occupation');
define('_RA_INTERESTS','Interests');
define('_RA_SIGNATURE','Signature');
define('_USERSTATUS','Vartotojo būsena');
define('_ONLINE','Prisijungęs');
define('_OFFLINE','Atsijungęs');
define('_NOTSUBSCRIBED','Jūs neužsisakėte mūsų laikraščio');
define('_SUBSCRIBED','Jūs esate užsisakęs mūsų laikraštį');
define('_MA_BROADCAST','Broadcast Public Message');
define('_BROADCASTTEXT','Jūs galite siųsti <i>viešą žinutę</i> (maks. 255 simboliai). Ši žinutė bus rodoma 10 minučių visiems vartotojams. Kiekvienas prisijungęs lankytojas matys tik vieną kartą raudona spalva po svetainės logotipu. Bet kuris vartotojas gali deaktyvuoti šią galimybę <a href="modules.php?name=Your_Account&amp;op=edithome">čia</a>. Prašau nepiktnaudžiauti. HTML naudojimas neleidžiamas.');
define('_BROADCASTSENT','Jūsų vieša žinutė buvo išsiųsta.');
define('_BROADCASTNOTSENT','<b>KLAIDA:</b> Jūsų vieša žinutė yra tuščia arba jūs jau neseniai siuntėte kitą žinutę. Norėdami siųsti kitą žinutę, jūs turite palaukti 10 minučių.');
define('_RETURNPAGE','Grįžti į asmeninį puslapį');
define('_MA_MYHEADLINES','My Headlines');
define('_SELECTASITE','Pasirinkite svetainę kurios antraštes norite matyti:');
define('_SELECTASITE2','Pasirinkite svetainę');
define('_ORTYPEURL','arba įveskite pasirinktos svetainės antraščių RSS/XML adresą:');
define('_MA_GO','Go');
define('_HEADLINESFROM','Antraštės iš');
...
define('_NOINFOFOR','Nėra informacijos');
define('_SORRYNOUSERINFO','Atsiprašome, atitinkamo vartotojo informacijos nerasta');
define('_LOGININCOR','Prisijungimas neteisingas! Bandykite dar kartą...');
define('_UPDATEFAILED','Negalime atnaujinti vartotojo įrašą. Prašome kreiptis į administratorių.');
...
define('_CHANGEHOME','Jūsų puslapis');
define('_CHANGEYOURINFO','Jūsų informacija');
define('_CONFIGCOMMENTS','Komentarai');
define('_DELETEACCT','Delete<br>Account');
define('_LOGOUTEXIT','Atsijungti');
define('_MA_MESSAGES','Messages');
define('_RETURNACCOUNT','Grįžti į pagrindinį profilio puslapį');
define('_SELECTTHETHEME','Temos');
...
define('_USERLOGIN','Vartotojo prisijungimas');
define('_REGNEWUSER','Naujo vartotojo registracija');
define('_PASSWORDLOST','Pametėte slaptažodį?');
define('_NOPROBLEM','Jokių problemų. Įrašykite pravardę ir paspauskite mygtuką siųsti. Mes atsiųsime jums laišką su patvirtinimo kodu, tada jums reikės surinkti pravardę bei patvirtinimo kodą ir mes išsiųsime slaptažodį.');
define('_CONFIRMATIONCODE','Patvirtinimo kodas');
define('_SENDPASSWORD','Siųsti slaptažodį');
define('_MA_YOUARELOGGEDOUT','You are now logged out!');
define('_USERACCOUNT','Vartotojo sąskaita');
define('_AT','');
define('_HASTHISEMAIL','el. paštas susijęs.');
define('_AWEBUSERFROM','Lankytojas iš');
define('_HASREQUESTED','tik ką paprašė, kad būtų išsiųstas slaptažodis.');
define('_YOURNEWPASSWORD','Jūsų naujas slaptažodis yra:');
define('_YOUCANCHANGE','Jūs galėsite jį pasikeisti kai prisijungsite');
define('_IFYOUDIDNOTASK','Jei jūs to neprašėte, nepergyvenkite. Šią žinutę matote jūs, o ne \'jie\'. Jei tai buvo jūsų klaida, tiesiog prisijunkite su naujų slaptažodžiu.');
define('_PASSWORD4','Slaptažodis');
define('_MAILED','išsiųstas.');
define('_CODEREQUESTED','tik ką paprašė patvirtinimo kodo slaptažodžiui pakeisti.');
define('_YOURCODEIS','Jūsų patvirtinimo kodas:');
define('_WITHTHISCODE','Su šiuo kodu jūs galite nustatyti naują slaptažodį');
define('_IFYOUDIDNOTASK2','Jei jūs neprašėte šio laiško, nepergyvenkite. Tiesiog ištrinkite šį laišką.');
define('_CODEFOR','Patvirtinimo kodas');
define('_USERPASSWORD4','Vartotojo slaptažodis');
define('_255CHARMAX','(maks. 255 simboliai. Įrašykite parašą HTML koduote)');
define('_CANKNOWABOUT','(maks. 255 simboliai. Įrašykite tai ką kiti galės žinoti apie jus)');
define('_SOMETHINGWRONG','Kažkas nepavyko... ar nepradedate nekęsti to?');
define('_COMMENTSCONFIG','Komentarų taikymas');
define('_DISPLAYMODE','Demonstravimo režimas');
define('_NOCOMMENTS','Be komentarų');
define('_NESTED','Įterptas');
define('_FLAT','Plokščias');
define('_THREAD','Gija');
define('_SORTORDER','Rūšiavimo tvarka');
define('_OLDEST','Pirmiau seniausi');
define('_NEWEST','Pirmiau naujausi');
define('_HIGHEST','Pirmiau aukščiausi rezultatai');
define('_THRESHOLD','Slenkstis');
define('_COMMENTSWILLIGNORED','Komentarai įvertinti mažiau nei nustatyta čia bus ignoruojami.');
define('_UNCUT','Nesutrumpintas ir pilnas');
define('_EVERYTHING','Beveik viskas');
define('_FILTERMOSTANON','Filtras beveik anoniminis');
define('_USCORE','Rezultatas');
define('_SCORENOTE','Anonimus talpinimai prasideda 0, prisijungusiųjų talpinimai prasideda 1? Moderatoriai prideda ir atima taškus.');
define('_NOSCORES','Nerodyti rezultatų');
define('_HIDDESCORES','(Paslėpti rezultatai: Jie skaičiuojami, bet jūs jų nematote.)');
define('_MAXCOMMENT','Maks. komentarų ilgis');
define('_TRUNCATES','(Komentarai padalinami ir pridedama nuoroda Plačiau. Nustatykite didelį skaičių norėdami išjungti)');
define('_BYTESNOTE','baitai (1024 baitai = 1K)');
//define('_PRIVATEMESSAGES', 'Your Private Messages');
define('_BROWSEUSERS','Naršyti lankytojus');
define('_SEARCHUSERS','Ieškoti lankytojų');
define('_SENDPRIVATEMSG','Send a Private Message to');
define('_THEME','Theme');
define('_MA_HOMECONFIG','Homepage Configuration');
define('_MAX127','(maks. 127):');
define('_MESSAGEACTIVATE','Aktyvuoti viešų žinučių siuntimą?');
define('_ACTIVATEPERSONAL','Aktyvuoti asmeninį meniu');
define('_PERSONALMENUCONTENT','Personal Menu Content');
define('_CHECKTHISOPTION','(Pažymėkite čia ir žemiau esantis testas atsiras pirmame puslapyje)');
...
define('_MYHEADLINES','Mano antraštės');
...
define('_EDITUSER','Redaguoti vartotoją');
...
define('_LOCATION','Vietovė');
define('_OCCUPATION','Užsiėmimas');
define('_INTERESTS','Pomėgiai');
