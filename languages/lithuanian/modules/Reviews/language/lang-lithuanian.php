...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/lithuanian/modules/Reviews/language/lang-lithuanian.php,v $
  $Revision: 1.2 $
  $Author: akamu $
  $Date: 2004/10/09 04:26:37 $
***********************************************************************/
if (!defined('CPG_NUKE')) { die('You do not have permission to access this file'); }
define('_PREVIOUS','Ankstesnis puslapis');
define('_NEXT','Sekantis puslapis');
...
define('_RCREATEACCOUNT','<a href=modules.php?name=Your_Account>Sukurkite</a> sąskaitą');
...
define('_PAGEBREAK','Jei norite kelių puslapių, rašykite <b>&lt;!--pagebreak--&gt;</b> ten, kur norite naujo puslapio.');
define('_PREVIEW','Peržvelgti');
define('_LANGUAGE','Kalba');
