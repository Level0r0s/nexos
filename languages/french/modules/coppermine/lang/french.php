...
$lang_meta_album_names = array('random' => 'Images au hasard',
    ...
    'lastupby' => 'Mes dermiers Ajouts', // new 1.2.2
    'lastalb' => 'Derniers albums mis en ligne',
    'lastcom' => 'Derniers commentaires',
    'lastcomby' => 'Mes Derniers commentaires', // new 1.2.2
...
$lang_errors = array('access_denied' => 'Vous n\'avez pas la permission d\'accéder à cette page.',
    ...
    'not_with_udb' => 'Cette fonction est désactivée dans Coppermine parce que la gallerie est intégrée à un forum. Soit l\'action que vous essayez d\'effectuer n\'est pas disponible dans cette configuration, soit vous devez l\'effectuer à partir du forum auquel vous avez intégré la galerie.',
    'members_only' => 'Cette fonction est réservée aux membres, enregistrez vous.', // changed in cpg1.2.0nuke
    'mustbe_god' => 'Cette foncton est réservée à l\'administrateur. Vous devez être loggué en tant que superadmin, pour accéder à cette fonction'
    );
// ------------------------------------------------------------------------- //
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Aller à la liste des albums',
    ...
    'upload_pic_lnk' => 'Envoyer une image',
    ...
    'toprated_lnk' => 'Images les mieux not&eacute;es',
...
if (defined('CONFIG_PHP')) $lang_config_php = array('title' => 'Configuration',
        ...
        'rating_a' => 'évaluation ascendante',  // new in cpg1.2.0nuke
        'rating_d' => 'évaluation descendante', // new in cpg1.2.0nuke
...
// for postnuke change
        array(
            'Thème', 'cpgtheme', 6),
        array(
            'Titres spécifiques de la page au lieu de \'Coppermine\'', 'nice_titles', 1), 
        array('Montrez les blocs du côté droit', 'right_blocks', 1), // new 1.2.2
        // 'Album list view',
        ...
        array(
            'Nombre minimum de votes nécessaires pour qu\'une image apparaisse dans la liste des images les mieux not&eacute;es', 'min_votes_for_rating', 0),
        array(
        ...
        array(
            'Permettre plusieurs commentaires consécutifs sur une image par le même utilisateur', 'disable_flood_protection', 1), // new in cpg1.2.0nuke
        array(
            'Envoyer un Email a l\'administrateur avant de soumettre un commentaire' , 'comment_email_notification', 1), // new in cpg1.2.0nuke
        array(
        ...
        array(
            'Permettre au anomyme de voir une image en taille réelle', 'allow_anon_fullsize', 1), // new in cpg1.2.0nuke
        array('Nombre de jours avant de pouvoir voter pour la même image','keep_votes_time',0), // new in cpg1.2.2c nuke
//'Pictures and thumbnails settings',
        ...
        array(
            'Largeur ou hauteur maximale pour une image intermédiaire <b>*</b>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Lire les informations IPTC dans les fichiers JPEG', 'read_iptc_data', 1), // new in cpg1.2.0nuke
        array(
            'Répertoire de stockage de l\'album <b>*</b>', 'fullpath', 0),
        array(
            'Répertoire pour les images des utilisateurs <b>*</b>', 'userpics', 0),
        array(
            'Préfixe des images intermédiares <b>*</b>', 'normal_pfx', 0),
        array(
            'Préfixe pour les vignettes <b>*</b>', 'thumb_pfx', 0),
        array(
            'Mode par défaut des répertoires', 'default_dir_mode', 0),
        array(
            'Mode par défaut des images', 'default_file_mode', 0),
        array(
            'Infos de l\'image : montrer le nom du fichier', 'picinfo_display_filename', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer le nom de l\'album', 'picinfo_display_album_name', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer la taille du fichier', 'picinfo_display_file_size', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer les dimensions', 'picinfo_display_dimensions', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer le nombre de fois vu', 'picinfo_display_count_displayed', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer le lien vers le fichier', 'picinfo_display_URL', '1'), // new in cpg1.2.0nuke
        array(
            'Picinfo display URL as bookmark link', 'picinfo_display_URL_bookmark', '1'), // new in cpg1.2.0nuke
        array(
            'Infos de l\'image : montrer le lien de l\'album favori', 'picinfo_display_favorites', '1'), // new in cpg1.2.0nuke
        ...
        array(
'Activer le mode debug avancé', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
array(
'Avertir l\'administrateur des mise à jour de Coppermine', 'showupdate', 1), // new 1.2.2
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array('empty_name_or_com' => 'Vous devez taper votre nom et un commentaire',
        'com_added' => 'Votre commentaire à été ajouté',
...
if (defined('DISPLAYIMAGE_PHP')) {
    $lang_display_image_php = array('confirm_del' => 'Voulez vous vraiment SUPPRIMER cette image?\\nLes commentaires seront également supprimés.',
        ...
        'edit_pic' => 'Editer les informations de l\'image', // new in cpg1.2.0nuke
        );
    $lang_picinfo = array('title' => 'Informations sur l\'image',
        ...
        'iptcTitle' => 'IPTC Titre', // new in cpg1.2.0nuke
        'iptcCopyright' => 'IPTC Copyright', // new in cpg1.2.0nuke
        'iptcKeywords' => 'IPTC Mots clfs', // new in cpg1.2.0nuke
        'iptcCategory' => 'IPTC Catégorie', // new in cpg1.2.0nuke
        'iptcSubCategories' => 'IPTC Sous-Catégorie', // new in cpg1.2.0nuke
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array('pic_info' => 'Informations sur l\'image',
        ...
        'del_pic' => 'Supprimer l\'image',
        'read_exif' => 'lire a nouveau les infos EXIF', // new in cpg1.2.0nuke
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Nom du groupe',
        ...
        'approval_1' => 'Autorisation d\'upload public (1)',
        'approval_2' => 'Autorisation d\'upload privré (2)',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Rechercher les nouvelles photos',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : signifie que l\'image a bien été mise en ligne' . '<li><b>DP</b> : signifie que la photo existe déjà dans la base de données' . '<li><b>PB</b> : signifie que la photo n\'a pas pu être ajoutée, vérifiez votre configuration et les permissions des répertoires dans lesquels les images se trouvent' . '<li>Si les signes OK, DP, PB n\'apparaissent pas, cliquez sur l\'image cassée afin de voir le message d\'erreur généré par PHP' . '<li>Si votre browser cesse d\'effectuer la tâche (timeout), cliquez sur le bouton actualiser' . '</ul>',
        'select_album' => 'Select album', // new in nuke
        'no_album' => 'Aucun nom d\'album n\'a été choisi, revenez en arrière et choisissez un album ou mettre l\'image.',
        );
// ------------------------------------------------------------------------- //
// File thumbnails.php
// ------------------------------------------------------------------------- //
