...
define("_DELETESELECTED","Effacer la sélection");
define("_SENDNEWMSG","Envoyer Nouveau Message");
define("_REPLY","Répondre");
define("_NOSUBJECT","Il n'y a pas de Sujet dans votre Message.");
define("_NOMESSAGE","Il n'y a pas de Message. S'il vous plaît évrivez un message.");
