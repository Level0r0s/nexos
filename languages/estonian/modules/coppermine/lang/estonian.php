...
array(
'Pisipildi max laius või kõrgus <b>*</b>', 'thumb_width', 0),
array(
'Kasuta mõõte (kõrgus või laius või Max aspect pisipiltide jaoks )<b>*</b>', 'thumb_use', 7),
array(
'Loo keskmised pildid', 'make_intermediate', 1),
array(
'Keskmiste piltide laius või kõrgus <b>*</b>', 'picture_width', 0),
array(
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Otsi uusi pilte',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : tähendab, et pilt lisati edukalt' . '<li><b>DP</b> : tähendab, et pilt on dublikaat ja sisaldub juba andmebaasis' . '<li><b>PB</b> : tähendab, et pilti ei saa lisada, kontrolli oma seadeid ja kataloogi õigusi kus su pildid asuvad' . '<li>Kui märgid \'OK, DP, PB\' ei ilmu, klikka katkenud pildil nägemaks mistahes PHP poolt antud veateadet' . '<li>Kui su sirvijal on \'timeout\', vajuta reload nuppu' . '</ul>',
