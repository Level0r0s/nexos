...
array(
'Pisipildi max laius vÃµi kÃµrgus <b>*</b>', 'thumb_width', 0),
array(
'Kasuta mÃµÃµte (kÃµrgus vÃµi laius vÃµi Max aspect pisipiltide jaoks )<b>*</b>', 'thumb_use', 7),
array(
'Loo keskmised pildid', 'make_intermediate', 1),
array(
'Keskmiste piltide laius vÃµi kÃµrgus <b>*</b>', 'picture_width', 0),
array(
...
array(
'Albumi kataloog <b>*</b>', 'fullpath', 0),
array(
'Kasutajapiltide kataloog <b>*</b>', 'userpics', 0),
array(
'Eesliide keskmistele piltidele <b>*</b>', 'normal_pfx', 0),
array(
'Eesliide pisipiltidele <b>*</b>', 'thumb_pfx', 0),
array(
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Otsi uusi pilte',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : tÃ¤hendab, et pilt lisati edukalt' . '<li><b>DP</b> : tÃ¤hendab, et pilt on dublikaat ja sisaldub juba andmebaasis' . '<li><b>PB</b> : tÃ¤hendab, et pilti ei saa lisada, kontrolli oma seadeid ja kataloogi Ãµigusi kus su pildid asuvad' . '<li>Kui mÃ¤rgid \'OK, DP, PB\' ei ilmu, klikka katkenud pildil nÃ¤gemaks mistahes PHP poolt antud veateadet' . '<li>Kui su sirvijal on \'timeout\', vajuta reload nuppu' . '</ul>',
