...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/portuguese/language/lang-portuguese.php,v $
  $Revision: 1.4 $
  $Author: akamu $
...
define('_ASREGISTERED','Você ainda não tem uma conta? Pode criar uma <a href="\'.getlink("Your_Account&amp;file=register").\'"><b>aqui</b></a>. Como utilizador registado, pode configurar o web site de acordo com as suas preferências, além de ter outras vantagens exclusivas.');
...
define('_YOUAREANON','Você ainda não é nosso utilizador. É grátis! Clique <a href="\'.getlink("Your_Account&amp;file=register").\'"><b>aqui</b></a>');
define('_NOTE','Nota:');
define('_ADMIN','Admin:');
