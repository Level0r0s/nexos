...
//'Pictures and thumbnails settings',
        ...
        array(
            'Μέγιστη διάσταση του thumbnail <b>*</b>', 'thumb_width', 0),
        array(
            'Χρήση διάστασης ( πλάτος ή ύψος ή Μέγιστη αναλογία για το thumbnail )<b>*</b>', 'thumb_use', 7),
        array(
            'Δημιουργία ενδιάμεσων φωτογραφιών', 'make_intermediate', 1),
        array(
            'Mέγιστο πλάτος ή ύψος ενδιάμεσης φωτογραφίας <b>*</b>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Κατάλογος άλμπουμ <b>*</b>', 'fullpath', 0),

        array(
            'Ο κατάλογος για τις φωτογραφίες των χρηστών <b>*</b>', 'userpics', 0),
        array(
            'Πρόθεμα των ενδιάμεσων φωτογραφιών <b>*</b>', 'normal_pfx', 0),
        array(
            'Πρόθεμα των thumbnails <b>*</b>', 'thumb_pfx', 0),
        array(
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Αναζήτηση νέων φωτογραφιών',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : σημαίνει πως η φωτογραφία εισήχθει επιτυχώς' . '<li><b>DP</b> : σημαίνει πως η φωτογραφία υπάρχει ήδη στην βάση δεδομένων' . '<li><b>PB</b> : σημαίνει πως η φωτογραφία δεν μπορεί να προστεθεί, ελένξτε τις ρυθμίσεις σας και αν έχετε άδεια να χρησιμοποιήσετε τους καταλόγους που βρίσκονται οι φωτογραφίες' . '<li>Εαν τα OK, DP, PB \'signs\' δεν εμφανίζονται, επιλέξτε πάνω στην μη εμφανιθείσα εικόνα τους να δείτε τι πρόβλημα παρουσιάστηκε από την γλώσσα PHP' . '<li>Εαν εμφανίσει ο browser σας timeout, ξαναφορτώστε την σελίδα με reload' . '</ul>',
