...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/spanish/modules/News/language/lang-spanish.php,v $
  $Revision: 1.4 $
  $Author: akamu $
...
define('_PUBLISHINHOME','Â¿Publicar en el Home?');
define('_ACTIVATECOMMENTS','Â¿Activar Comentarios para esta Noticia?');
define('_STORYTEXT','Texto de la Noticia');
define('_ARESUREURL','(Â¿Estás seguro de haber incluido un URL? Â¿Has revisado la ortografía?)');
define('_NOTES','Notas');
define('_PROGRAMSTORY','Â¿Quieres programar esta historia?');
...
define('_REMOVESTORY','Â¿Estás seguro de que desea borrar la Noticia ID #');
...
define('_DELCATWARNING3','Â¿Qu&#233; deseas hacer?');
