...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/spanish/modules/Surveys/language/lang-spanish.php,v $
  $Revision: 1.3 $
  $Author: akamu $
...
define('_NOANONCOMMENTS','No se permiten comentarios Anónimos, <a href="'.getlink("Your_Account&amp;op=new_user").'">Regístrese</a> por favor');
...
define('_ANNOUNCEPOLL','Â¿Anunciar la Encuesta con una Noticia?');
