...
//'Pictures and thumbnails settings',
        ...
        array(
            'Max. velikost za ikone <b>*</b>', 'thumb_width', 0),
        ...
        array(
            'Max. širina ali višina vmesnih slik <b>*</b>', 'picture_width', 0),
        array(
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Iskanje novih slik',
        ...
        'notes' => '<ul>' . '<li><b>OK</b>: pomeni, da so slike uspešno dodane' . '<li><b>DP</b>: pomeni, da je slika duplikat in je že v bazi' . '<li><b>PB</b>: pomeni, da slike ni možno dodati. Preveri nastavitve in pravice za direktorij v katerem se nahajajo' . '<li>Èe ne vidiš oznak OK, DP ali PB, klikni na manjkajoèo slikico za prikaz napake, ki jo generira PHP' . '<li>Za osvežitev prikaza pritisni tipko reload  v svojem brskalniku' . '</ul>',
