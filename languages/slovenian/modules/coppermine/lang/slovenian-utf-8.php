...
array(
'Naslov za nuke mapo je ie http://www.mysite.tld/html', 'ecards_more_pic_target', 0),
array(
'Jezik', 'lang', 5),
// for postnuke change
array(
'Tema', 'cpgtheme', 6),
array(
'Posebni naslovi strani namesto >Coppermine', 'nice_titles', 1), 
array(
'Prikaži bloke na desnit', 'right_blocks', 1), // new 1.2.2
        // 'Album list view',
        'Seznam albumov',
array(
'Širina glavne tabele (piksli ali %)', 'main_table_width', 0),
array(
...
array(
'Velikost ikon v pikslih', 'alb_list_thumb_size', 0),
array(
...
array(
'Maks. Št. tabulatorjev', 'max_tabs', 0),
array(
...
array(
'Alt-i in oznake imena pomanjšane slike kažejo naslov in ključno besedo namesto info o sliki', 'seo_alts', 1), // new in cpg1.2.0nuke
...
array(
'Izloči grde besede v komentarjih', 'filter_bad_words', 1),
array(
'Dovoli smeškote v komentarjih', 'enable_smilies', 1),
array(
'Dovoli več zaporednih komentarjev za eno sliko od istega uporabnika', 'disable_flood_protection', 1), // new in cpg1.2.0nuke
array(
'Pošlji e-pošto administratorju ob pošiljanju komentarja' , 'comment_email_notification', 1), // new in cpg1.2.0nuke
array(
'Maks. velikost za opis slike', 'max_img_desc_length', 0),
array(
'Maks. število zankov v besedi', 'max_com_wlength', 0),
array(
'Maks. število vrstic komentar', 'max_com_lines', 0),
array(
'Maks. velikost komentarja', 'max_com_size', 0),
array(
'Prikaži filmski trak z ikonami', 'display_film_strip', 1),
array(
'Št. ikon na traku', 'max_film_strip_items', 0),
array(
'Dovoli neprijavljenim uporabnikom ogled slik v polni velikosti', 'allow_anon_fullsize', 1), // new in cpg1.2.0nuke
array(
'Število dni, ki mora preteči, preden lahko ponovno glasujete za isto sliko','keep_votes_time',0), // new in cpg1.2.2c nuke
//'Pictures and thumbnails settings',
        'Nastavitve slik in ikon',
array(
'Kvaliteta za JPEG datoteke', 'jpeg_qual', 0),
array(
'Maks. velikost za ikone <b>*</b>', 'thumb_width', 0),
array(
'Velikost uporabi za širino ali višino ali razmerje ikone <b>*</b>', 'thumb_use', 7),
array(
'Ustvari vmesne slike', 'make_intermediate', 1),
array(
'Maks. širina ali višina vmesnih slik <b>*</b>', 'picture_width', 0),
array(
'Maks. velikost datotek/slik (kB)', 'max_upl_size', 0),
array(
'Maks. širina ali višina dodanih slik (piksli)', 'max_upl_width_height', 0), 
array(
...
array(
'Uporabnik ima lahko zasebni album', 'allow_private_albums', 1), 
...
array(
'Prikaži ikone zasebnih albumov neprijavljenim uporabnikom', 'show_private', 1),
array(
...
array(
'Direktorij za albume <b>*</b>', 'fullpath', 0),
array(
'Direktorij za slike od uporabnikov <b>*</b>', 'userpics', 0),
array(
'Predpona za vmesne slike <b>*</b>', 'normal_pfx', 0),
array(
'Predpona za ikone <b>*</b>', 'thumb_pfx', 0),
array(
'Privzete pravice za direktorije', 'default_dir_mode', 0),
array(
'Privzete pravice za slike', 'default_file_mode', 0),
array(
'Info o sliki - prikaži ime datoteke', 'picinfo_display_filename', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - prikaži ime albuma', 'picinfo_display_album_name', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - prikaži velikost datoteke', 'picinfo_display_file_size', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - prikaži dimenzije', 'picinfo_display_dimensions', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - štej prikazane', 'picinfo_display_count_displayed', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - prikaži URL', 'picinfo_display_URL', '1'), // new in cpg1.2.0nuke
array(
'Info o sliki - prikaži URL kot povezavo k zaznamku', 'Info o sliki - prikaži najljubšo povezavo za album', '1'), // new in cpg1.2.0nuke
array(
...
'Kodiranje strani', 'charset', 4), 
        ...
        'Ostale nastavitve',
array(
'Vključi način za odkrivanje napak', 'debug_mode', 1),
array(
'Vključi napredni način za odkrivanje napak', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
array(
'Prikaži adminu alarm Coppermine', 'showupdate', 1), // new 1.2.2
        '<br /><div align=\"center\">(*) Polja označena z * se ne smejo spreminjati, če so v galeriji še slike</div><br />'
        );
// ------------------------------------------------------------------------- //
// File db_input.php
// ------------------------------------------------------------------------- //
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'PoÅ¡lji e-razglednico',
        'invalid_email' => '<b>Opozorilo</b>: napaÃ¨ni e-mail naslov!',
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Domov',
        'stat1' => 'Å t. slik:<b>[pictures]</b> - Å¡t. albumov:<b>[albums]</b> - Å¡t. kategorij:<b>[cat]</b>  - Å¡t. komentarjev:<b>[comments]</b> - Å¡t. ogledov:<b>[views]</b>',
        'stat2' => 'Å t. slik:<b>[pictures]</b> - Å¡t. albumov:<b>[albums]</b> - Å¡t. ogledov<b>[views]</b>',
        'xx_s_gallery' => 'Galerija od %s',
        'stat3' => 'Å t. slik:<b>[pictures]</b> - Å¡t. albumov:<b>[albums]</b> - Å¡t. komentarjev:<b>[comments]</b>  - Å¡t. ogledov:<b>[views]</b>'
        );
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'Iskanje novih slik',
        ...
        'notes' => '<ul>' . '<li><b>OK</b>: pomeni, da so slike uspeÅ¡no dodane' . '<li><b>DP</b>: pomeni, da je slika duplikat in je Å¾e v bazi' . '<li><b>PB</b>: pomeni, da slike ni moÅ¾no dodati. Preveri nastavitve in pravice za direktorij v katerem se nahajajo' . '<li>Ãˆe ne vidiÅ¡ oznak OK, DP ali PB, klikni na manjkajoÃ¨o slikico za prikaz napake, ki jo generira PHP' . '<li>Za osveÅ¾itev prikaza pritisni tipko reload  v svojem brskalniku' . '</ul>',
