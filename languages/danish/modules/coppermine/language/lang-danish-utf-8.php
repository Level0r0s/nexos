...
define('TRANS_EMAIL', '');
define('TRANS_WEBSITE', 'http://www.cpgnuke.dk');
...
define('NO_IMG_TO_APPROVE', 'Ingen bilder at godkende');
...
define('HELP_LNK', "<img src=\"modules/$module_name/images/help.gif\"  vspace=\"2\" height=\"20\" width=\"20\" align=\"middle\" alt=\"HJÆLP\"  border=\"0\" />");
...
define('SORT_TITLE', 'Sorter bilder efter:');
...
$lang_meta_album_names = array(
    ...
    'favpics' => 'Favorit Bilder' // changed in cpg1.2.0nuke
    );
// ------------------------------------------------------------------------- //
// File config.php
// ------------------------------------------------------------------------- //
...
$lang_config_data = array(
    ...
    array('Adressen til nuke folderen f.eks: http://www.mysite.tld/html/', 'ecards_more_pic_target', 0), // new in cpg1.2.0nuke
...
//    array('Character encoding', 'charset', 4), 
    ...
    array('Aktiver avancerede fejlfindings tilstand', 'advanced_debug_mode', 1), // new in cpg1.2.0nuke
    array('Vis Coppermine Opdateringer til Admin', 'showupdate', 1), // new 1.2.2
