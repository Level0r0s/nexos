 ...
 *
 *     $Id: lang_main.php,v 1.4 2004/10/10 13:02:20 lexsus Exp $
 *
 ****************************************************************************/
$lang['ENCODING'] = "utf-8";
$lang['DIRECTION'] = "ltr";
...
$lang['Post_reply_pm'] = 'Besvar besked';
$lang['Post_quote_pm'] = 'Citere besked';
$lang['Edit_pm'] = 'Redigere besked';
...
$lang['Too_many_registers'] = 'Du har forsøgt at registrer dig for mange gange. Prøv igen senere.';
...
// Viewonline
//
$lang['Reg_users_zero_online'] = 'Der er 0 tilmeldte brugere og '; // There are 5 Registered and
...
$lang['Hidden_users_zero_online'] = '0 skjulte brugere online'; // 6 Hidden users online
...
$lang['Guest_users_zero_online'] = 'Der er 0 gæstebruger online'; // There are 10 Guest users online
...
$lang['tz']['1'] = "(GMT +1:00 time) København, Amsterdam, Berlin, Brussels, Madrid, Paris, Rome";
...
$lang['Merge_topics'] = 'Flet emner sammen';
$lang['Merge_title'] = 'Ny titel på emne';
$lang['Merge_title_explain'] = 'Dette vil blive den nye titel på det færdige emne. Lad det stå tomt hvis du vil lade systemet bruge titlen fra bestemmelsessteds emne';
...
$lang['Merge_topic_to_explain'] = 'Dette emne vil få alle posteringer fra " Emne der skal flettes til". Du kan skrive emne id, url\'en til emnet, eller url\'en af en postering i dette emne';
...
$lang['Merge_from_not_authorized'] = 'Du har ikke redaktør adgang til flette dette emne sammen';
$lang['Merge_to_not_authorized'] =  'Du har ikke redaktør adgang til flette dette emne sammen';
...
$lang['Merge_confirm_process'] = 'Er du sikker på at du vil flette <br />"<b>%s</b>"<br /> sammen med<br />"<b>%s</b>"';
$lang['Merge_topic_done'] = 'Emnerne blev vellykket flettede sammen.';
//-- fin mod : merge -------------------------------------------------------------------------------

// Quick Reply Mod
$lang['Quick_Reply'] = 'Hurtig Svar';
$lang['Quick_quote'] = 'Medtage sidste besked';

// PM Quick Reply Mod
$lang['PMQR_Quick_Reply'] = 'Hurtig Svar';
$lang['PMQR_Quick_quote'] = 'Medtage sidste besked';
$lang['PMQR_QuoteSelelected'] = 'medtag valgt tekst';
$lang['PMQR_QuoteSelelectedEmpty'] = 'Vælg tekst hvor som helst og prøv igen';
...
// Auth Related Entries
$lang['Rules_attach_can'] = 'Du <b>kan</b> tilføje filer i dette forum';
$lang['Rules_attach_cannot'] = 'Du <b>kan ikke</b> tilføje filer i dette forum';
$lang['Rules_download_can'] = 'Du <b>kan</b> downloade filer fra dette forum';
$lang['Rules_download_cannot'] = 'Du <b>kan ikke</b> downloade filer fra dette forum';
$lang['Sorry_auth_view_attach'] = 'Beklager, men du har ikke adgang til at se eller downloade det vedhæftede';
...
$lang['Extension_disabled_after_posting'] = 'Filendelsen \'%s\' er blevet deaktiveret af en admin, derfor bliver det vedhæftede ikke vist.'; // used in Posts and PM's, replace %s with mime type

// Posting/PM -> Initial Display
$lang['Attach_posting_cp'] = 'Vedhæft Kontrolpanel';
$lang['Attach_posting_cp_explain'] = 'Hvis du klikker på tilføj et vedhæft, vil du se en boks for at tilføjede vedhæft.<br />Hvis du klikker på Postet vedhæft, vil du se en liste over vedhæft og du har mulighed for at ændre dem.<br />Hvis du vil erstatte (Upload ny version) et vedhæft, skal du klikke på begge links. Tilføj et vedhæft som du normalt gør. Men, klik ikke på Tilføj et vedhæft, men klik på upload ny version på det vedhæft du vil opdatere';

// Posting/PM -> Posting Attachments
$lang['Add_attachment'] = 'Tilføj et vedhæft';
$lang['Add_attachment_title'] = 'Tilføj et vedhæft';
$lang['Add_attachment_explain'] = 'Hvis du ikke vil tilføje et vedhæft, lad da venligst felterne stå tomme';
$lang['File_name'] = 'Filnavn';
$lang['File_comment'] = 'Fil Kommentar';

// Posting/PM -> Posted Attachments
$lang['Posted_attachments'] = 'Postet vedhæft';
$lang['Options'] = 'Indstillinger';
$lang['Update_comment'] = 'Opdatere Kommentar';
$lang['Delete_attachments'] = 'Slette vedhæft';
$lang['Delete_attachment'] = 'Slet vedhæftget';
$lang['Delete_thumbnail'] = 'Slet Minibilde';
...
$lang['Attachment_php_size_na'] = 'vedhæftget er for stort.<br />Kunne ikke hente information om maks. størrelse defineret i PHP.<br />Attachment Mod kan ikke finde maks. filstørrelse for upload i php.ini.';
$lang['Attachment_php_size_overrun'] = 'vedhæftget er for stort.<br />Maks. størrelse for upload er: %d MB.<br />Dette er størrelsen defineret i php.ini. Dette er sat af PHP og Attachment Mod kan ikke overstyre dette.'; // replace %d with ini_get('upload_max_filesize')
$lang['Disallowed_extension'] = 'Filendelsen %s er ikke tilladt'; // replace %s with extension (e.g. .php)
$lang['Disallowed_extension_within_forum'] = 'Du har ikke lov til at poste filer med endelsen %s i dette forum'; // replace %s with the Extension
$lang['Attachment_too_big'] = 'vedhæftget er for stort.<br />Maks. størrelse er: %d %s'; // replace %d with maximum file size, %s with size var
$lang['Attach_quota_reached'] = 'Beklager, men maks. filstørrelse for alle vedhæft er nået. Kontakt venligst Administrator hvis du har spørgsmål.';
$lang['Too_many_attachments'] = 'vedhæftget kan ikke blive lagt til, siden maks. antal (%d) vedhæft i denne post er nået'; // replace %d with maximum number of attachments
$lang['Error_imagesize'] = 'vedhæftget / Biledet skal være mindre end %d piksler bredt og %d piksler hørt';
$lang['General_upload_error'] = 'Upload fejl: Kunne ikke uploade vedhæftget til %s.'; // replace %s with local path

$lang['Error_empty_add_attachbox'] = 'Du skal skrive noget i \'Tilføj et vedhæft\' Boksen';
$lang['Error_missing_old_entry'] = 'Kan ikke opdatere vedhæftget, kan ikke finde det gamle vedhæft';

// Errors -> PM Related
$lang['Attach_quota_sender_pm_reached'] = 'Beklager, men maks. filstørrelse for alle vedhæft i Private Beskeder er nået. Slet venligst nogen af dine modtaget/sendte vedhæft.';
$lang['Attach_quota_receiver_pm_reached'] = 'Beklager, men maks filstørrelse på alle vedhæft er nået i Private Beskeder for \'%s\'. Giv ham venligst besked, eller vendt til han/hun har slettet nogen af sine vedhæft.';

// Errors -> Download
$lang['No_attachment_selected'] = 'Du har ikke valgt nogen vedhæft at se på eller downloade.';
$lang['Error_no_attachment'] = 'Det valgte vedhæft findes ikke mere';

// Delete Attachments
$lang['Confirm_delete_attachments'] = 'Er du sikker på at du vil slette det valgte vedhæft?';
$lang['Deleted_attachments'] = 'Det valgte vedhæft er slettet.';
$lang['Error_deleted_attachments'] = 'Kunne ikke slette vedhæftget.';
$lang['Confirm_delete_pm_attachments'] = 'Er du sikker på at du vil slette alle vedhæft i denne PM?';

// General Error Messages
$lang['Attachment_feature_disabled'] = 'Vedhæft funktionen er slået fra.';

$lang['Directory_does_not_exist'] = 'Folderen \'%s\' eksisterer ikke eller kan ikke blive fundet.'; // replace %s with directory
$lang['Directory_is_not_a_dir'] = 'tjek Venligst om \'%s\' er en folder.'; // replace %s with directory
$lang['Directory_not_writeable'] = 'Folderen \'%s\' er ikke skrivbar. Du skal gemme uploads stien og sætte adgangen	 med \'chmod til 777\' (eller ændre ejeren til din httpd-servers ejer) for at uploade filer.<br />Hvis du kun har en ordinær ftp-adgang ændre så \'Attribute\' på folderen til rwxrwxrwx.'; // replace %s with directory

$lang['Ftp_error_connect'] = 'Kan ikke nå FTP Server: \'%s\'. tjek venligst dine FTP indstillinger.';
$lang['Ftp_error_login'] = 'Kan ikke logge på FTP Serveren. Brugernavnet \'%s\' eller kodeordet  er forkert. Tjek venligst dine FTP indstillinger.';
$lang['Ftp_error_path'] = 'Kunne ikke nå ftp folderen: \'%s\'. Tjek venligst dine FTP indstillinger.';
$lang['Ftp_error_upload'] = 'Kunne ikke uploade filer til ftp folderen: \'%s\'. Tjek venligst dine FTP indstillinger.';
$lang['Ftp_error_delete'] = 'Kunne ikke slette filer fra ftp folderen: \'%s\'. Tjek venligst dine FTP indstillinger <br />En anden grund til denne fejl kan være ikke eksisterende filer, tjek venligst dette først i Skyggevedhæft.';
$lang['Ftp_error_pasv_mode'] = 'Kan ikke slå FTP Passive Mode til/fra';

// Attach Rules Window
$lang['Rules_page'] = 'Vedhæftsregler';
$lang['Attach_rules_title'] = 'Tilladt filendelse grupper og deres størrelser';
$lang['Group_rule_header'] = '%s -> Maks. uploadstørrelse: %s'; // Replace first %s with Extension Group, second one with the Size STRING
$lang['Allowed_extensions_and_sizes'] = 'Tilladte filendelser og størrelser';
$lang['Note_user_empty_group_permissions'] = 'BEMERK:<br />Du har som normalt adgang til at tilføje vedhæft i dette forum, <br />men siden ingen filendelsegruppe er tilladt her, <br />er det umulig for dig at tilføje nogen. Hvis du prøver, <br />vil du bare få en fejlmelding.<br />';

// Quota Variables
$lang['Upload_quota'] = 'Uploadskvote';
$lang['Pm_quota'] = 'PM Kvote';
$lang['User_upload_quota_reached'] = 'Beklager, du har nået din maksimum Uploadskvote på %d %s'; // replace %d with Size, %s with Size Lang (MB for example)

// User Attachment Control Panel
$lang['User_acp_title'] = 'Bruger VKP';
$lang['UACP'] = 'Bruker VedhæftKontrolPanel';
$lang['User_uploaded_profile'] = 'Uploaded: %s';
$lang['User_quota_profile'] = 'Kvote: %s';
$lang['Upload_percent_profile'] = '%d%% ad totalt';

// Common Variables
$lang['Bytes'] = 'Bytes';
$lang['KB'] = 'KB';
$lang['MB'] = 'MB';
$lang['Attach_search_query'] = 'søg vedhæft';
$lang['Test_settings'] = 'Test Indstillingerne';
$lang['Not_assigned'] = 'Ikke tildelt';
$lang['No_file_comment_available'] = 'Ingen filkommentarer er tilgængelig';
$lang['Attachbox_limit'] = 'Din vedhæftsboks er %d%% fuld';
