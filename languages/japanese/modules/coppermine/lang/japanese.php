...
//'Pictures and thumbnails settings',
        ...
        array(
            'サムネイルの最大幅又は高さ <b>*</b>', 'thumb_width', 0),
        array(
            '寸法を使用する ( 幅 または 高さ または サムネイルの最大サイズ )<b>*</b>', 'thumb_use', 7),
        array(
            '中間写真を作成する', 'make_intermediate', 1),
        array(
            '中間写真の最大幅又は高さ <b>*</b>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'アルバムディレクトリ <b>*</b>', 'fullpath', 0),
        array(
            'ユーザ写真のディレクトリ <b>*</b>', 'userpics', 0),
        array(
            '中間写真の接頭辞 <b>*</b>', 'normal_pfx', 0),
        array(
            'サムネイルの接頭辞 <b>*</b>', 'thumb_pfx', 0),
        array(
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => '新しい写真の検索',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : 正常に写真が追加されました。' . '<li><b>DP</b> : 写真が重複して既にデータベースに登録されています。' . '<li><b>PB</b> : 写真を追加出来ませんでした、設定及び写真が登録されるディレクトリのパーミッションを確認してください。' . '<li>OK、DP、PBサインのいずれも表示されなかった場合は、PHPエラーを表示するために破損した写真をクリックしてください。' . '<li>タイムアウトが発生した場合、ブラウザの更新ボタンをクリックしてください。' . '</ul>',
