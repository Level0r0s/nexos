 ...
 *
 *     $Id: lang_main.php,v 1.1 2004/07/24 21:27:46 akamu Exp $
 *
 ****************************************************************************/
...
$lang['Smilies_are_ON'] = "スマイリー: <u>	効</u>";
...
$lang['IP_info'] = "IP情報";
$lang['Lookup_IP'] = "IPを検∢㬀ഀ਀ഀ਀ഀ਀⼀⼀ഀ਀⼀⼀ 吀椀洀攀稀漀渀攀猀 ⸀⸀⸀ 昀漀爀 搀椀猀瀀氀愀礀 漀渀 攀愀挀栀 瀀愀最攀ഀ਀⼀⼀ഀ਀␀氀愀渀最嬀✀䄀氀氀开琀椀洀攀猀✀崀 㴀 ∀䄀氀氀 琀椀洀攀猀 愀爀攀 ─猀∀㬀 ⼀⼀ 攀最⸀ 䄀氀氀 琀椀洀攀猀 愀爀攀 䜀䴀吀 ⴀ ㄀㈀ 䠀漀甀爀猀 ⠀琀椀洀攀猀 昀爀漀洀 渀攀砀琀 戀氀漀挀欀⤀ഀ਀ഀ਀␀氀愀渀最嬀✀ⴀ㄀㈀✀崀 㴀 ∀䜀䴀吀 ⴀ㄀㈀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㄀㄀✀崀 㴀 ∀䜀䴀吀 ⴀ㄀㄀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㄀　✀崀 㴀 ∀케ꐰᤰ陪䉮⁦⠀케ꐰ⤰∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㤀✀崀 㴀 ∀䜀䴀吀 ⴀ㤀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㠀✀崀 㴀 ∀⨀獙୞ᥭ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㜀✀崀 㴀 ∀焀ぜᥗ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㘀✀崀 㴀 ∀ⴀᦐ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㔀✀崀 㴀 ∀焀ᦐ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㐀✀崀 㴀 ∀䜀䴀吀 ⴀ㐀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㌀⸀㔀✀崀 㴀 ∀䜀䴀吀 ⴀ㌀㨀㌀　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㌀✀崀 㴀 ∀뀀쬰쌰렰ᤰ陪䉮⁦ⴀ㌀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀ⴀ㈀✀崀 㴀 ∀ⴀ⹎❙罙உ≭㬀ഀ਀␀氀愀渀最嬀✀ⴀ㄀✀崀 㴀 ∀䜀䴀吀 ⴀ㄀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀　✀崀 㴀 ∀䜀䴀吀∀㬀ഀ਀␀氀愀渀最嬀✀㄀✀崀 㴀 ∀ⴀ⹎ﰰ쌰터ᤰ陪䉮⁦⠀✀���⥝∀㬀ഀ਀␀氀愀渀最嬀✀㈀✀崀 㴀 ∀焀ﰰ쌰터ᤰ陪䉮⁦⠀✀���⥝∀㬀ഀ਀␀氀愀渀最嬀✀㌀✀崀 㴀 ∀䜀䴀吀 ⬀㌀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㌀⸀㔀✀崀 㴀 ∀䜀䴀吀 ⬀㌀㨀㌀　∀㬀ഀ਀␀氀愀渀最嬀✀㐀✀崀 㴀 ∀䜀䴀吀 ⬀㐀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㐀⸀㔀✀崀 㴀 ∀䜀䴀吀 ⬀㐀㨀㌀　∀㬀ഀ਀␀氀愀渀最嬀✀㔀✀崀 㴀 ∀䜀䴀吀 ⬀㔀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㔀⸀㔀✀崀 㴀 ∀䜀䴀吀 ⬀㔀㨀㌀　∀㬀ഀ਀␀氀愀渀最嬀✀㘀✀崀 㴀 ∀䜀䴀吀 ⬀㘀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㘀⸀㔀✀崀 㴀 ∀䜀䴀吀 ⬀ 㘀⸀㔀∀㬀 ഀ਀␀氀愀渀最嬀✀㜀✀崀 㴀 ∀䜀䴀吀 ⬀㜀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㠀✀崀 㴀 ∀缀璉ᥐ陪䉮⁦⠀樀���⥝∀㬀ഀ਀␀氀愀渀最嬀✀㤀✀崀 㴀 ∀䜀䴀吀 ⬀㤀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㤀⸀㔀✀崀 㴀 ∀ⴀᦐ陪䉮⁦⠀✀���⥝∀㬀ഀ਀␀氀愀渀最嬀✀㄀　✀崀 㴀 ∀焀ᦐ陪䉮⁦⠀✀���⥝∀㬀ഀ਀␀氀愀渀最嬀✀㄀㄀✀崀 㴀 ∀䜀䴀吀 ⬀㄀㄀㨀　　∀㬀ഀ਀␀氀愀渀最嬀✀㄀㈀✀崀 㴀 ∀䜀䴀吀 ⬀㄀㈀㨀　　∀㬀ഀ਀ഀ਀⼀⼀ 吀栀攀猀攀 愀爀攀 搀椀猀瀀氀愀礀攀搀 椀渀 琀栀攀 琀椀洀攀稀漀渀攀 猀攀氀攀挀琀 戀漀砀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㄀㈀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㄀㈀㨀　　⤀ ꠀ쬰꘰ꜰ젰꼰İ꼰꠰렰ꜰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㄀㄀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㄀㄀㨀　　⤀ ���쌰줰꘰ꜰﰰŜ따ꈰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㄀　✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㄀　㨀　　⤀ 케ꐰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㤀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㤀㨀　　⤀ ꈀ뤰ꬰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㠀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㠀㨀　　⤀ ⨀獙୞ᥭ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰Ⰰ 였ꌰ픰ꄰ쨰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㜀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㜀㨀　　⤀ 焀ぜᥗ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰Ⰰ ꈀ븰쨰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㘀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㘀㨀　　⤀ ⴀᦐ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰Ⰰ 괰뜰댰뜰옰ꌰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㔀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㔀㨀　　⤀ 焀ᦐ陪䉮⁦⠀猀ﵼ䩖蠰猰ꬰ쨰쀰⤰Ⰰ ���됰뼰ⰰ ���ⰰ 관젰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㐀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㐀㨀　　⤀ ✀罙உᥭ陪䉮⁦⠀꬀쨰쀰⤰Ⰰ ꬀ꬰ뤰ⰰ 터뤰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㌀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㌀㨀㌀　⤀ 쬀ﰰ픰ꄰ줰줰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㌀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㌀㨀　　⤀ 혀렰ꈰⰰ 혀꠰츰뤰ꈰꐰ뤰ⰰ 렀ﰰ렰뼰꘰ⰰ 픀ꤰﰰ꼰줰≜㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㈀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㈀㨀　　⤀ ⴀ⹎❙罙உⱭ ꈀ묰뜰ⱜ 묀젰���쨰≜㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀ⴀ㄀✀崀 㴀 ∀⠀䜀䴀吀 ⴀ㄀㨀　　⤀ ꈀ븰뤰ⱜ ꬀ﰰ������윰≜㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀　✀崀 㴀 ∀⠀䜀䴀吀⤀ ꬀따혰ꬰⰰ 쀀혰ⰰ ꠀ렰퀰ⰰ 줰ⰰ 뤰���ⰰ 팰ꈰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㄀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㄀㨀　　⤀ ꈀ뤰옰쀰ⰰ ���ⰰ 혀쌰묰ⰰ ���줰ﰰ줰ⰰ 턀ⰰ ﰰ���∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㈀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㈀㨀　　⤀ ꬀ꐰⰰ ���뜰괰ⰰ ꬀ﰰ쬰뀰ﰰ줰ⰰ 圀ꉓ픰ꬰⰰ 뜰‰∀㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㌀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㌀㨀　　⤀ 퀀뀰쀰쌰줰ⰰ 줰ⰰ 뤰꼰ⰰ 쨀ꐰ팰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㌀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㌀㨀㌀　⤀ 였���∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㐀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㐀㨀　　⤀ ꈀ혰쀰팰ⰰ 퀀꼰ⰰ ���뤰ꬰ쌰젰ⰰ 저팰뜰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㐀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㐀㨀㌀　⤀ ꬀혰ﰰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㔀㨀　　⤀ ꠀꬰ옰퀰ﰰ뀰ⰰ ꐀ뤰���퀰ﰰ줰ⰰ ꬀섰ⰰ 뼀뜰넰젰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㔀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㔀㨀㌀　⤀ ������ꐰⰰ ꬀ꬰ쌰뼰ⰰ ���줰뤰ⰰ 쬀ﰰ윰ﰰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㘀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㘀㨀　　⤀ ꈀ���옰ꌰⰰ 대���ⰰ 쀀쌰ꬰⰰ 츀���뜰팰뤰꼰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㘀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㘀㨀㌀　⤀ 뀰ﰰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㜀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㜀㨀　　⤀ 퀀댰꼰ⰰ 케츰ꐰⰰ 렀ꬰ뼰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㠀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㠀㨀　　⤀ ᜀ걓ⱎ 餀⾙Ɱ 턀ﰰ뤰ⰰ 뜀갰���ﰰⰰ ᝓ≓㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㤀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㤀㨀　　⤀ ✀⩙Ⲗ ⴀ䱧ⱞ 봀꘰ⰰ 焀걧ⱎ 꼰ﰰ쐰꼰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㤀⸀㔀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㤀㨀㌀　⤀ ꈀ윰ﰰ줰ⰰ 쀀ﰰ꘰ꌰ∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㄀　✀崀 㴀 ∀⠀䜀䴀吀 ⬀㄀　㨀　　⤀ 관���ⰰ 뀀ꈰⰰ ���ⰰ 뜀줰쬰ﰰⰰ ꘀ렰ꨰ뤰젰꼰∰㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㄀㄀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㄀㄀㨀　　⤀ ���갰쀰ⰰ 쬀ﰰꬰ줰쬰ꈰⰰ 봀≜㬀ഀ਀␀氀愀渀最嬀✀琀稀✀崀嬀✀㄀㈀✀崀 㴀 ∀⠀䜀䴀吀 ⬀㄀㈀㨀　　⤀ ꨀﰰ꼰줰ⰰ ꘀꜰ젰ⰰ 픀ꌰ렰ﰰⰰ ���ﰰ뜰≜㬀ഀ਀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀甀渀搀愀礀✀崀 㴀 ∀���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀漀渀搀愀礀✀崀 㴀 ∀ࠀ���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀吀甀攀猀搀愀礀✀崀 㴀 ∀欀���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀圀攀搀渀攀猀搀愀礀✀崀 㴀 ∀㐀���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀吀栀甀爀猀搀愀礀✀崀 㴀 ∀⠀���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䘀爀椀搀愀礀✀崀 㴀 ∀턀���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀愀琀甀爀搀愀礀✀崀 㴀 ∀ἀ���≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀甀渀✀崀 㴀 ∀≥㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀漀渀✀崀 㴀 ∀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀吀甀攀✀崀 㴀 ∀欀≰㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀圀攀搀✀崀 㴀 ∀㐀≬㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀吀栀甀✀崀 㴀 ∀⠀≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䘀爀椀✀崀 㴀 ∀턀⊑㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀愀琀✀崀 㴀 ∀ἀ≗㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀愀渀甀愀爀礀✀崀 㴀 ∀㄀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䘀攀戀爀甀愀爀礀✀崀 㴀 ∀㈀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀愀爀挀栀✀崀 㴀 ∀㌀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䄀瀀爀椀氀✀崀 㴀 ∀㐀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀愀礀✀崀 㴀 ∀㔀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀甀渀攀✀崀 㴀 ∀㘀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀甀氀礀✀崀 㴀 ∀㜀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䄀甀最甀猀琀✀崀 㴀 ∀㠀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀攀瀀琀攀洀戀攀爀✀崀 㴀 ∀㤀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀伀挀琀漀戀攀爀✀崀 㴀 ∀㄀　ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀一漀瘀攀洀戀攀爀✀崀 㴀 ∀㄀㄀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䐀攀挀攀洀戀攀爀✀崀 㴀 ∀㄀㈀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀愀渀✀崀 㴀 ∀㄀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䘀攀戀✀崀 㴀 ∀㈀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀愀爀✀崀 㴀 ∀㌀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䄀瀀爀✀崀 㴀 ∀㐀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䴀愀礀✀崀 㴀 ∀㔀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀甀渀✀崀 㴀 ∀㘀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䨀甀氀✀崀 㴀 ∀㜀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䄀甀最✀崀 㴀 ∀㠀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀匀攀瀀✀崀 㴀 ∀㤀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀伀挀琀✀崀 㴀 ∀㄀　ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀一漀瘀✀崀 㴀 ∀㄀㄀ࠀ≧㬀ഀ਀␀氀愀渀最嬀✀搀愀琀攀琀椀洀攀✀崀嬀✀䐀攀挀✀崀 㴀 ∀㄀㈀ࠀ≧㬀ഀ਀ഀ਀⼀⼀ഀ਀⼀⼀ 䔀爀爀漀爀猀 ⠀渀漀琀 爀攀氀愀琀攀搀 琀漀 愀ഀ਀⼀⼀ 猀瀀攀挀椀昀椀挀 昀愀椀氀甀爀攀 漀渀 愀 瀀愀最攀⤀ഀ਀⼀⼀ഀ਀␀氀愀渀最嬀✀䤀渀昀漀爀洀愀琀椀漀渀✀崀 㴀 ∀씀ㅠ≘㬀ഀ਀␀氀愀渀最嬀✀䌀爀椀琀椀挀愀氀开䤀渀昀漀爀洀愀琀椀漀渀✀崀 㴀 ∀촀膑檉씰ㅠ≘㬀ഀ਀ഀ਀␀氀愀渀最嬀✀䜀攀渀攀爀愀氀开䔀爀爀漀爀✀崀 㴀 ∀ ⱎꢂﰰ∰㬀ഀ਀␀氀愀渀最嬀✀䌀爀椀琀椀挀愀氀开䔀爀爀漀爀✀崀 㴀 ∀촀➑ꡙﰰ∰㬀ഀ਀␀氀愀渀最嬀✀䄀渀开攀爀爀漀爀开漀挀挀甀爀攀搀✀崀 㴀 ∀ꠀﰰ䰰稰ὶ坵縰地弰∰㬀ഀ਀␀氀愀渀最嬀✀䄀开挀爀椀琀椀挀愀氀开攀爀爀漀爀✀崀 㴀 ∀촀➑ꡙﰰ䰰稰ὶ坵縰地弰∰㬀ഀ਀ഀ਀⼀⼀ഀ਀⼀⼀ 吀栀愀琀✀猀 愀氀氀 䘀漀氀欀猀℀ഀ਀⼀⼀ ⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀⴀഀ਀ഀ਀㼀㸀∀