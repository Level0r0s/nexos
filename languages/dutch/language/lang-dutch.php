...
*******************************************************************************************************************
  Main language file
  Last modification: 
  Sams bruutus@zonnet.nl                                                    
  $Id: lang-dutch.php,v 1.5 2004/09/18 19:53:54 akamu Exp $              
*******************************************************************************************************************/
...
define("_YOUHAVEONEMSG", "Je hebt 1 nieuw prive bericht");
define("_NEWPMSG", "nieuwe prive berichten");
...
define("_coppermineLANG", 'Fotogalerij');
define("_DownloadsLANG", 'Downloads');
define("_EncyclopediaLANG", 'Encyclopedie');
define("_ForumsLANG", 'Gemeenschap Forums');
define("_ContactLANG", 'Contacteer ons');
define("_FAQLANG", 'FAQ - Hulp');
define("_JournalLANG", 'Dagboek');
define("_Members_ListLANG", 'Ledenlijst');
define("_NewsLANG", 'Nieuws');
define("_ReviewsLANG", 'Overzichten');
define("_SearchLANG", 'Onderzoek');
define("_SectionsLANG", 'Specialen pagina`s');
define("_StatisticsLANG", 'Statistieken');
define("_Stories_ArchiveLANG", 'Verhalen Archief');
define("_Submit_NewsLANG", 'Plaats Nieuws');
define("_SurveysLANG", 'Onderzoeken');
define("_TopLANG", 'Top 10');
define("_TopicsLANG", 'Onderwerpen');
define("_Private_MessagesLANG", 'Mijn Privé Berichten');
define("_Recommend_UsLANG", 'Adviseer ons');
define("_Web_LinksLANG", 'Verbindingen');
define("_Your_AccountLANG", 'Mijn Lidmaatschap');
...
define("_RULES", "Huishoudelijken Regelementen");
...
define("_SENDPM","Send Privat Besked");
define("_LINKAPPROVEDMSG", "Congratulations! The web link you submitted to our links database has been approved. Please link back to use and send an email with the url where you have done so.");
define("_BOTH", "Both");
