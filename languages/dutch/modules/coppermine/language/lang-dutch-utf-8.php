...
/*****************************************************************************/
/*   $Id: lang-dutch-utf-8.php,v 1.1 2004/07/14 09:17:07 akamu Exp $              */
/*****************************************************************************/
// KokkieBlanda cpgnuke@kokkieblanda.nl 
...
define('LASTCOMBY', 'Mijn laatste opmerkingen');
...
define('MEMBERS_ONLY', 'Deze functie is alleen voor leden beschikbaar, U knt lid worden');
define('MUSTBE_GOD', 'Deze functie is alleen voor de administrateur beschikbaar. u moet ingelogd zijn als hoofd administrateur, god account om deze functie te kunnen gebruiken');
...
define('MY_PROF_TITLE','controleer uw beschikbare ruimte en groepen');
...
define('LASTUP_TITLE', 'laatste geuploade foto\'s');
define('LASTCOM_TITLE',  'foto\'s gerangschikt naar laatste commentaar');
define('LASTCOM_LNK',  'Laatste commentaar');
define('TOPN_TITLE', 'foto\'s die het meest bekeken zijn');
define('TOPN_LNK', 'Meest bekeken');
define('TOPRATED_TITLE', 'Top rated pictures');
define('TOPRATED_LNK',  'best beoordeelde foto\'s');
...
define('SORT_TA', 'Sorteer op titel oploopend');
define('SORT_TD', 'Sorteer op titel afloopend');
...
define('SLIDESHOW_DISABLED_MSG', 'Deze functie is alleen voor leden, u kunt lid worden.');
...
define('NO_MORE_IMAGES', 'Er zijn geen foto\'s meer in deze galerij');
define('NO_LESS_IMAGES', 'Dit is de eerste foto\'s in deze galerij');
...
define('MANAGE_CAT', 'Beheer categorieëen');
...
define('MAKE_INTERMEDIATE', 'Creäer tussen foto\'s');
...
define('USER_SETTING_TITLE', 'Gebruiker instellingen');
...
define('CUSTOM_FIELDS_TITLE', 'Eigen velden voor foto beschrijving (laat leeg indien niet gebruikt)');
...
define('PIC_ADV_SETTING_TITLE', 'Foto\'s en thumbnails speciale instellingen');
define('SHOW_PRIVATE', 'Laat privÃ© album icoon zien aan niet ingelogde gebruiker');
...
define('IMPATH', 'Pad naar ImageMagick \'convert\' utility (voorbeeld /usr/bin/X11/)');
...
define('COOKIE_SETTING_TITLE', 'Cookies &amp; Tekenset instellingen');
...
define('ADVANCED_DEBUG_MODE', 'Aanzetten geadvanceerde debug modus');
...
define('CREATE_ALB', 'creëeren album \'%s\'');
...
define('DEL_PIC', 'VERWIJDER DEZE FOTO');
