...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/romanian/modules/Downloads/language/lang-romanian.php,v $
  $Revision: 1.5 $
  $Author: akamu $
...
define('_DOWNLOADSNOTUSER8','<a href="modules.php?name=Your_Account">Înregistraţi-vă pentru un cont</a>');
...
define('_DOWNLOADPROFILE','Profi Download');
...
define('_DONLYREGUSERSMODIFY','Numai utilizatorii înregistraţi pot sugera modificări. Vă rugăm să vă <a href="modules.php?name=Your_Account">înregistraţi sau să vă logaţi</a>.');
...
define('_DRATENOTE4','Puteţi vedea o listă a <a href="modules.php?name=Downloads&amp;d_op=TopRated">Celor mai bune resurse</a>.');
...
define('_SHOWTOP','Arataţi primele');
