...
$Header: /cvs/languages/english/modules/News/language/lang-english.php,v 1.2 2004/08/19 04:29:22 akamu Exp $
*************************************************************/
...
define("_NOANONCOMMENTS","No Comments Allowed for Anonymous, please <a href=\"".getlink("Your_Account&amp;op=new_user")."\">register</a>");
...
define('_NOTES','Notes');
define('_PROGRAMSTORY','Do you want to program this story to be published at a later date?');
