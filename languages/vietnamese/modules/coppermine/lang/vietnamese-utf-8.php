...
//'Pictures and thumbnails settings',
        ...
        array(
            'KÃ­ch thá»©Æ¡c cao nháº¥t 1 thumnail <b>*</b>', 'thumb_width', 0),

        array(
            'KÃ­ch thá»©Æ¡c bá» ngoÃ i Thumnail<b>*</b>', 'thumb_use', 7),

        array(
            'Táº¡o hÃ¬nh trung gian', 'make_intermediate', 1),
        array(
            'Tá»‘i Ä‘a chiá»u rá»™ng hay cao 1 hÃ¬nh trung gian<b>*</b>', 'picture_width', 0),
        array(
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array(
            'Äá»«Æ¡ng dáº«n Album <b>*</b>', 'fullpath', 0),
        array(
            'Äá»«Æ¡ng dáº«n Ä‘áº¿n nÆ¡i lÆ°u giá»¯ hÃ¬nh cá»§a User <b>*</b>', 'userpics', 0),
        array(
            'KÃ½ tá»± phÃ­a trá»©Æ¡c tÃªn cá»§a má»—i file hÃ¬nh má»Ÿ rá»™ng  <b>*</b>', 'normal_pfx', 0),
        array(
            'KÃ½ tá»± phÃ­a trá»©Æ¡c má»—i thumnail <b>*</b>', 'thumb_pfx', 0),
        array(
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php = array('title' => 'Gá»­i an e-card',
        'invalid_email' => '<b>Cáº£nh bÃ¡o</b> : Ä‘á»‹a chá»‰ mail khÃ´ng há»£p lÃ½ !',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'tÃªn nhÃ³m',
        ...
        'note1' => '<b>(1)</b> Ä‘á»±Æ¡c táº£i há»‰nh lÃªn chá»— cáº§n Ä‘á»±Æ¡c Ban Quáº£n Trá»‹ Ä‘á»“ng Ã½ ',
        'note2' => '<b>(2)</b> Ä‘á»±Æ¡c upload lÃªn nÆ¡i mÃ  user cáº§n Ban Quáº£n Tri cho phÃ©p',
        'notes' => 'Ghi chÃº'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('INDEX_PHP')) {
    ...
    $lang_list_categories = array('home' => 'Trang chá»§',
        'stat1' => '<b>[pictures] </b> hÃ¬nh trong <b>[albums]</b> album vÃ  <b>[cat]</b> PhÃ¢n loáº¡i vá»›i <b>[comments]</b> nháº­n xÃ©t, xem <b>[views]</b> láº§n',
        'stat2' => '<b>[pictures]</b> hÃ¬nh trong <b>[albums]</b> album Ä‘á»±Æ¡c xem <b>[views]</b> láº§n',
        'xx_s_gallery' => 'hÃ¬nh cá»§a %s\ ',
        'stat3' => '<b>[pictures]</b> hÃ¬nh trong <b>[albums]</b> album vá»›i <b>[comments]</b> nháº­n xÃ©t, Ä‘á»±Æ¡c xem <b>[views]</b> láº§n'
        );
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'TÃ¬m hÃ¬nh má»›i',
        ...
        'target_album' => '<b>Äáº·t hÃ¬nh cá»§a  &quot;</b>%s<b>&quot; vÃ o </b>%s',
        'folder' => 'ThÆ° má»¥c',
        'image' => 'HÃ¬nh',
        'album' => 'Album',
        'result' => 'Káº¿t quáº£',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : hÃ¬nh Ä‘Ã£ Ä‘á»±Æ¡c thÃªm vÃ o' . '<li><b>DP</b> : hÃ¬nh nÃ y trÃ¹ng láº·p vÃ  Ä‘Ã£ cÃ³ trong cÆ¡ sá»Ÿ dá»¯ liá»‡u' . '<li><b>PB</b> : hÃ¬nh cá»§a báº¡n khÃ´ng thá»ƒ Ä‘á»±Æ¡c thÃªm vÃ o, kiá»ƒm tra láº¡i cáº¥u hÃ¬nh hoáº·c quyá»n.' . '<li>Náº¿u OK, DP, PB \'signs\' khÃ´ng xuáº¥t hiá»‡n thÃ¬ click vÃ o hÃ¬nh Ä‘á»ƒ PHP thÃ´ng bÃ¡o lá»—i gáº·p pháº£i' . '<li>Náº¿u web bá»‹ Ä‘á»©ng, báº¥m F5 hoáº·c refresh' . '</ul>',
