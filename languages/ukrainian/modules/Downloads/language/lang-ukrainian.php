...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/ukrainian/modules/Downloads/language/lang-ukrainian.php,v $
  $Revision: 1.2 $
  $Author: akamu $
...
define('_PREVIOUS','Попередня сторінка');
...
define('_DONLYREGUSERSMODIFY','в других поисковых системах');
...
define('_DRATENOTE4','Ви можете проглянути список <a href="modules.php?name=Downloads&amp;d_op=TopRated">Рейтингу ресурсів</a>.');
