...
define('EVIL OR VERY MAD', 'Gonosz vagy őrült');
...
define('GALLERY_ADMIN_EMAIL', 'Képtár adminisztrátor email címe');
...
define('MAIN_TABLE_WIDTH', 'Főtáblázat szélessége (pixel vagy %)');
define('SUBCAT_LEVEL', 'Kategóriák megjelenítendő száma');
define('ALBUMS_PER_PAGE', 'Oldalanként megjelenítendő albumok száma');
define('ALBUM_LIST_COLS', 'Albumlista oszlopainak száma');
define('ALB_LIST_THUMB_SIZE', 'Ikonok mérete pixelben');
define('MAIN_PAGE_LAYOUT', 'A főoldal tartalma');
define('FIRST_LEVEL', 'Első szintű albumok ikonok megjelenítése a kategóriákban');
...
define('MAX_TABS', 'Megjelenítendő tab- fülek maximális száma');
...
define('FILTER_BAD_WORDS', 'Trágár szavak kiszűrése a hozzászólásokból');
...
define('PIC_THUMB_SETTING_TITLE', 'Kép- és ikonbeállítások');
define('JPEG_QUAL', 'JPEG fájlok minősége');
...
define('MAKE_INTERMEDIATE', 'Közbenső méretű kép generálása');
define('PICTURE_WIDTH', 'Közbenső méretű képmaximális szélessége ésmagassága <b>*</b>');
...
define('USER_SETTING_TITLE', 'Felhasználó beállítások');
define('ALLOW_USER_REGISTRATION', 'Új felhasználók regisztrálhatnak');
define('REG_REQUIRES_VALID_EMAIL', 'Regisztráció email megerősítéshez kötött');
...
define('CUSTOM_FIELDS_TITLE', 'Saját mezők a képek leírásához (hagyd üresen, ha nem használod)');
define('USER_FIELD1_NAME', '1. mezőnév');
define('USER_FIELD2_NAME', '2. mezőnév');
define('USER_FIELD3_NAME', '3. mezőnév');
define('USER_FIELD4_NAME', '4. mezőnév');
define('PIC_ADV_SETTING_TITLE', 'Képek és ikonok különleges beállításai');
...
define('IMPATH', 'ImageMagick/netpbm \'convert\' programjához vezető útvonal  (pld. /usr/bin/X11/)');
...
define('NORMAL_PFX', 'Középméretezett képek előtagja <b>*</b>');
define('THUMB_PFX', 'Ikonfájlok előtagja <b>*</b>');
...
define('COOKIE_SETTING_TITLE', 'Cooky és karakterkészlet beállítások');
...
define('MISC_SETTING_TITLE', 'Egyéb beállítások');
...
define('NOCHANGE_FOOTER_TITLE', '<br /><div align="center">(*) * -gal jelölt mezőket nem szabad megváltoztatni, ha már nem üres a képtár</div><br />');
...
define('EXPOSURE TIME', 'Expozíció időpontja');
...
<br />
Ez a weblap cookie formájában információt tárol a számítógépeden. Ezek a cookie-k csak azt a célt szolgálják, hogy fokozzák a nézhetőségi élményt. Az email cím csak a regisztrációs adataidnak és jelszavadnak nyugtázására szolgál.<br />
<br />
...
define('REQUIRED_INFO', 'Kötelező adat');
...
define('INTERESTS', 'Érdeklődési kör');
define('WEBSITE', 'Honlap');
define('OCCUPATION', 'Foglalkozás');
define('ERROR', 'HIBA');
define('CONFIRM_EMAIL_SUBJECT', '%s - Regisztráció nyugtázása');
define('INFORMATION', 'Információ');
define('FAILED_SENDING_EMAIL', 'A regisztrációs megerősítő emailt nem sikerült elküldeni !');
...
define('SEE_PREV', 'Előző');
define('SEE_NEXT', 'Következő');
...
define('NOTES', '<ul><li><b>OK</b> : azt jelenti, hogy a kép hozzáadása sikeres volt<li><b>DP</b> : azt jelenti, hogy a kép már az adatbázisban volt<li><b>PB</b> : azt jelenti, hogy a kép nem volt hozzáadható, ellenőrizd a konfigurációt és a képeket tartalmazó könyvtárak jogosultságait <li>Ha az OK, DP, PB \'jelek\' nem láthatók, klikkelj a hibás képre a PHP hibaüzenetének megjelenítéséhez<li>Ha a browser leidőzített, nyomja meg a frissítés gombot</ul>');
...
define('BACK', 'vissza a főoldalra');
...
define('DELETE', 'Kép címek vagy eredeti méretű képek törlése');
