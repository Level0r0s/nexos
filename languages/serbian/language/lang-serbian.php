...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/languages/serbian/language/lang-serbian.php,v $
  $Revision: 1.4 $
  $Author: akamu $
...
define('_PASSWORD','ifra');
define('_WELCOMETO','Dobrodoli na');
define('_EDIT','Edituj');
define('_DELETE','Obrii');
...
define('_WAITINGCONT','Sadraj na čekanju');
define('_WREVIEWS','Recenzije na čekanju');
define('_WLINKS','Linkovi na čekanju');
define('_ONEDAY','Jedan dan kao danas...');
define('_ASREGISTERED','Jo nemate svoj nalog? Moete da se <a href="\'.getlink(\'Your_Account&amp;file=register\').\'">registrujete ovde</a>. Kao registrovani korisnik dobijate mnoge pogodnosti kao to su promena izgleda, konfiguracija komentara i postavljanje komentara pod vaim imenom.');
define('_MENUFOR','Menu za');
define('_NOBIGSTORY','Nema najčitanijeg članka dana, za sada.');
define('_BIGSTORY','Najčitaniji članak danas:');
define('_SURVEY','Anketa');
define('_POLLS','Svi upitnici');
define('_PCOMMENTS','Komentara:');
define('_RESULTS','Trenutni rezultati');
define('_HREADMORE','pročitaj jo...');
define('_CURRENTLY','Trenutno je prisutno,');
define('_GUESTS','gostiju i');
define('_MEMBERS','članova koji su on-line.');
define('_YOUARELOGGED','Prijavljeni ste pod imenom');
define('_YOUHAVE','Imate');
define('_PRIVATEMSG','privatnih poruka.');
define('_YOUAREANON','Vi ste anonimni korisnik. Moete se registrovati ako kliknete <a href="\'.getlink(\'Your_Account&amp;file=register\').\'">ovde</a>');
define('_NOTE','Napomena:');
define('_ADMIN','Administracija:');
define('_WERECEIVED','Imali smo');
define('_PAGESVIEWS','posećenih stranica od');
define('_TOPIC','Tema');
define('_UDOWNLOADS','Downloads');
define('_VOTE','Glasajte');
define('_VOTES','Glasova');
define('_MVIEWADMIN','Vidljivo: Samo administratoru');
define('_MVIEWUSERS','Vidljivo: Samo registrovanim korisnicima');
define('_MVIEWANON','Vidljivo: Samo gostima');
define('_MVIEWALL','Vidljivo: Svim posetiocima');
define('_EXPIRELESSHOUR','Vreme trajanja: manje od jednog sata');
define('_EXPIREIN','Rok ističe za');
define('_UNLIMITED','Neograničeno');
define('_HOURS','Sati');
define('_RSSPROBLEM','Trenutno imamo problem sa pregledom naslova vesti sa ovog sajta');
define('_SELECTLANGUAGE','Odaberite jezik');
define('_SELECTGUILANG','Odaberite jezik interfejsa:');
define('_NONE','Nespecifikovano');
define('_BLOCKPROBLEM','<center>Postoji problem sa ovim blokom.</center>');
define('_BLOCKPROBLEM2','<center>Trenutno nema sadraja za ovaj blok.</center>');
define('_MODULENOTACTIVE','Naalost, ovaj modul nije aktivan!');
...
define('_FORADMINTESTS','(za administrativno testiranje)');
define('_BBFORUMS','Forumi');
define('_ACCESSDENIED','Nemate ovlatenje pristupa');
define('_RESTRICTEDAREA','Pokuali ste da pristupite zoni sa ograničenim pristupom.');
define('_MODULEUSERS','Naalost, ova sekcija naeg sajta je <i>isključivo za registrovane korisnike.</i><br><br>Moete da se registrujete besplatno ako kliknete <a href="\'.getlink(\'Your_Account&amp;file=register\').\'">ovde</a>, tada ćete moći da pristupite ovoj sekciji<br>bez ograničenja. Hvala.<br><br>');
...
define('_MODULESADMINS','Ovaj deo sajta je isključivo za <i>Administratore.</i><br><br>');
define('_MODULESGROUPS','group access required');
define('_HOME','Home');
define('_HOMEPROBLEM','Imamo veliki problem: nema početne stranice!!!');
define('_ADDAHOME','Dodajte modul na početnu stranicu');
define('_HOMEPROBLEMUSER','Trenutno imamo problem na početnoj stranici, molimo vas pokuajte da pristupite kasnije.');
define('_MORENEWS','Jo u sekciji vesti');
...
define('_MODREQLINKS','Modifikacija linkova');
define('_BROKENLINKS','Problematični linkovi');
define('_MODREQDOWN','Modifikacija fajlova');
define('_BROKENDOWN','Problematični fajlovi');
define('_PAGEGENERATION','Stranica generisana:');
define('_SECONDS','Sekundi');
define('_YOUHAVEONEMSG','Imate jednu novu privatnu poruku');
define('_NEWPMSG','novih privatnih poruka');
define('_CONTRIBUTEDBY','Priloio');
define('_CHAT','Chat');
define('_REGISTERED','Registrovanih');
define('_CHATGUESTS','Gostiju');
define('_USERSTALKINGNOW','Korisnici koji trenutno razgovaraju');
define('_ENTERTOCHAT','Ulazak na Chat');
define('_CHATROOMS','Dostupne sobe');
define('_ALLTOPICS','All Topics');
define('_ASSOTOPIC','Slične Teme');
...
define('_TYPESECCODE','Upii sigurnosni kod');
