 ...
 *
 *     $Id: lang_main.php,v 1.1 2004/07/31 21:13:45 akamu Exp $
 *
 ****************************************************************************/
...
$lang['Reply_to_topic'] = "Odpovědět na téma";
$lang['Reply_with_quote'] = "Odpovědět s citátem";

$lang['Click_return_topic'] = "Klikněte %szde%s pro návrat do seznamu témat"; // %s's here are for uris, do not remove!
$lang['Click_return_login'] = "Klikněte %szde%s pro opakování volby";
$lang['Click_return_forum'] = "Klikněte %szde%s pro návrat do na obsah fóra";
...
$lang['Board_disable'] = "Promiňte, ale toto fórum je momentálně nedostupné, zkuste opakovat volbu pozědji";
...
$lang['Forgotten_password'] = "Zapoměli jste svoje heslo ?";
...
$lang['Topic_Moved'] = "<b>Přesunout:</b>";
...
$lang['Rules_post_can'] = "<b>Můžete</b> odesílat nové téma do tohoto fóra";
...
$lang['No_longer_watching'] = "Přestal(a) jste sledovat toto téma";
...
$lang['Topic_locked'] = "Toto téma je zamknuto bez možnosti úpravy příspěvků a psaní odpovědí";
$lang['No_post_id'] = "Musíte zvolit příspěvek pro úpravu";
$lang['No_topic_id'] = "Musíte zvolit téma na které chcete odpovědět";
$lang['No_valid_mode'] = "Můžete jen odesílat, upravovat nebo citovat příspěvky, proveďte návrat zpět a zkuste to znovu";
$lang['No_such_post'] = "Takovýto příspěvek neexistuje, proveďte návrat zpět a zkuste to znovu";
...
$lang['Cannot_delete_replied'] = "Promiňte, ale nemůžete mazat příspěvky, na které bylo odpovězeno";
...
$lang['Poll_delete'] = "Vás hlas byl úspěšně odstraněn";
...
$lang['bbcode_s_help'] = "Barva písma: [color=red]text[/color]  Typ: můžete použít také color=#FF0000";
...
$lang['Styles_tip'] = "Typ: Styl můžete aplikovat rychleji na označeném textu";
...
$lang['Login_check_pm'] = "Přihlásit, pro kontrolu soukromých zpráv";
...
$lang['No_unread_pm'] = "Nemáte nepřečtené zprávy";
...
$lang['You_no_new_pm'] = "Žádné nové soukromé zprávy nečekají";
...
$lang['Disable_Smilies_pm'] = "Zakázat smajlíky (emotikony) v této zprávě";
...
$lang['Avatar_panel'] = "Obrázky postaviček";
...
$lang['Search_user_posts'] = "Hledat příspěvky tohoto uživatele";
...
$lang['No_send_account_inactive'] = "Promiňte, ale vaše heslo nemůže být nalezeno, protože je váš účet momentálně aktivní. Pro více informací kontaktujte administrátora tohoto fóra";
...
$lang['Always_notify_explain'] = "Pošle e-mail když někdo odpoví na vámi poslané téma. Toto může být změněno kdykoli před odesláním";

$lang['Board_style'] = "Vzhled fóra";
$lang['Board_lang'] = "Jazyk fóra";
$lang['No_themes'] = "Vzhled není v databázi";
$lang['Timezone'] = "Časové pásmo";
$lang['Date_format'] = "Formát datumu a času";
...
$lang['Upload_Avatar_file'] = "Přihraj obrázek postavičky ze svého počítače";
...
$lang['Account_inactive'] = "Váš uživatelský účet byl vytvořen. Ovšem toto fórum vyžaduje aktivaci účtu. Aktivační klíčem, vám byl zaslán na vámi poskytnutou e-mailovou adresu. Bližší informace obdržíte na vaší e-mailovou adresu";
$lang['Account_inactive_admin'] = "Váš uživatelský účet byl vytvořen. Ovšem toto fórum vyžaduje aktivaci účtu administrátorem. Po aktivaci administrátorem, budete vyrozuměn(a) na vaší e-mailovou adresu";
$lang['Account_active'] = "Váš účet byl aktivován. Děkujeme za registraci";
$lang['Account_active_admin'] = "Účet byl aktivován";
$lang['Reactivate'] = "Přeaktivujte svůj účet!";
...
$lang['Wrong_activation'] = "Vámi poskytnutý aktivační klíč neodpovídá se neshoduje s žádným z databáze";
...
$lang['No_group_members'] = "Tato skupina nemá členy";
...
$lang['characters_posts'] = "znaků ze příspěvku";
...
$lang['Too_many_error'] = "Vybal(a) jste příliš mnoho příspěvků. Můžete vybrat pouze jeden příspěvek, od kterého chcete téma rozdělit!";
...
$lang['IP_info'] = "Informace o IP adresáře";
