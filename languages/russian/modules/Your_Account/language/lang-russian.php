...
***************************************************************
  ...
  Last modification:
  Now UTF-8 encoded                                                    
  $Id: lang-russian.php,v 1.2 2004/10/09 04:26:41 akamu Exp $    
***************************************************************/
...
define('_THISISYOURPAGE','Ð­Ñ‚Ð¾ Ð²Ð°ÑˆÐ° Ð¿ÐµÑ€ÑÐ¾Ð½Ð°Ð»ÑŒÐ½Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°');
define('_PERSONALINFO','ÐŸÐµÑ€ÑÐ¾Ð½Ð°Ð»ÑŒÐ½Ð°Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ');
...
define('_AVATAR','ÐœÐ¾Ñ€Ð´Ð°ÑˆÐºÐ°');
define('_WEBSITE','Ð’ÐµÐ± ÑÐ°Ð¹Ñ‚');
define('_RA_LOCATION','Location');
define('_RA_OCCUPATION','Occupation');
define('_RA_INTERESTS','Interests');
define('_RA_SIGNATURE','Signature');
define('_USERSTATUS','ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ');
define('_ONLINE','ÐžÐ½Ð›Ð°Ð¹Ð½');
define('_OFFLINE','ÐžÑ„Ñ„Ð›Ð°Ð¹Ð½');
...
define('_NOINFOFOR','Ð­Ñ‚Ð¾ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð°Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð´Ð»Ñ');
define('_SORRYNOUSERINFO','ÐŸÑ€Ð¾ÑÑ‚Ð¸Ñ‚Ðµ, Ð½ÐµÑ‚ ÑÐ¾Ð¾Ñ‚Ð²ÐµÑ‚ÑÑ‚Ð²ÑƒÑŽÑ‰ÐµÐ¹ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ð¸ Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ðµ');
define('_LOGININCOR','ÐÐµÐ¿Ñ€Ð°Ð²ÐµÐ»ÑŒÐ½Ñ‹Ð¹ Ð»Ð¾Ð³Ð¸Ð½! ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹Ñ‚Ðµ ÐµÑ‰Ðµ...');
define('_UPDATEFAILED','ÐÐµÐ²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ Ð¾Ð±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸ÑŽ Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ðµ. ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° ÑÐ²ÑÐ¶Ð¸Ñ‚ÐµÑÑŒ Ñ Ð°Ð´Ð¼Ð¸Ð½Ð¸ÑÑ‚Ñ€Ð°Ñ‚Ð¾Ñ€Ð¾Ð¼.');
...
define('_CHANGEHOME','Ð¡Ð²Ð¾Ðµ Ð¼ÐµÐ½ÑŽ');
define('_CHANGEYOURINFO','Ð¡Ð²Ð¾Ñ Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ');
define('_CONFIGCOMMENTS','ÐšÐ¾Ð½Ñ„Ð¸Ð³. ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸ÐµÐ²');
define('_DELETEACCT','Delete<br>Account');
define('_LOGOUTEXIT','Ð’Ñ‹Ñ…Ð¾Ð´');
define('_MA_MESSAGES','Messages');
define('_RETURNACCOUNT','Return to Your Account Page');
define('_SELECTTHETHEME','Ð’Ð½ÐµÑˆÐ½Ð¸Ð¹ Ð²Ð¸Ð´');
...
define('_USERLOGIN','Ð’Ð¾Ð¹Ñ‚Ð¸');
define('_REGNEWUSER','Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ñ Ð½Ð¾Ð²Ð¾Ð³Ð¾ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ');
define('_PASSWORDLOST','ÐŸÐ°Ñ‚ÐµÑ€ÑÐ»Ð¸ ÑÐ²Ð¾Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ?');
define('_NOPROBLEM','ÐÐµÑ‚ Ð¿Ñ€Ð¾Ð±Ð»ÐµÐ¼. ÐŸÑ€Ð¾ÑÑ‚Ð¾ Ð²Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÑÐ²Ð¾Ð¹ Ð½Ð¸Ðº Ð¸ Ð½Ð°Ð¶Ð¼Ð¸ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑƒ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ. ÐŸÐ°Ñ€Ð¾Ð»ÑŒ Ð±ÑƒÐ´ÐµÑ‚ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½ Ð½Ð° ÑƒÐºÐ°Ð·Ð°Ð½Ð½Ñ‹Ð¹ Ð¿Ñ€Ð¸ Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¸ Email. Ð’Ñ‹ Ð¿Ð¾Ð»ÑƒÑ‡Ð¸Ñ‚Ðµ Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´, ÐºÐ¾Ñ‚Ð¾Ñ€Ñ‹Ð¹ Ð² Ð´Ð°Ð»ÑŒÐ½ÐµÐ¹ÑˆÐ¸Ð¼ Ð½Ð°Ð´Ð¾ Ð±ÑƒÐ´ÐµÑ‚ Ð²Ð²ÐµÑÑ‚Ð¸ Ð½Ð¸Ð¶Ðµ.');
define('_CONFIRMATIONCODE','ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´');
define('_SENDPASSWORD','Ð’Ñ‹ÑÐ»Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ');
define('_MA_YOUARELOGGEDOUT','You are now logged out!');
define('_USERACCOUNT','ÐÐºÐºÐ°ÑƒÐ½Ñ‚ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ');
define('_AT','at');
define('_HASTHISEMAIL','has this email associated with it.');
define('_AWEBUSERFROM','ÐŸÐ¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ Ð¸Ð·');
define('_HASREQUESTED','has just requested that password be sent.');
define('_YOURNEWPASSWORD','Ð’Ð°Ñˆ Ð½Ð¾Ð²Ñ‹Ð¹ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ:');
define('_YOUCANCHANGE','Ð’Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ ÑÑ‚Ð¾ Ð¿Ð¾ÑÐ»Ðµ Ð²Ñ…Ð¾Ð¶Ð´ÐµÐ½Ð¸Ñ Ð¿Ð¾Ð´ ÑÐ²Ð¾Ð¸Ð¼ Ð¸Ð¼ÐµÐ½ÐµÐ¼u ');
define('_IFYOUDIDNOTASK','Ð•ÑÐ»Ð¸ Ð²Ñ‹ Ð½Ðµ ÑÐ¿Ñ€Ð°ÑˆÐ¸Ð²Ð°Ð»Ð¸ Ð¿Ñ€Ð¾ ÑÑ‚Ð¾, Ð½Ðµ Ð±ÐµÑÐ¿Ð¾ÐºÐ¾Ð¹Ñ‚ÐµÑÑŒ. Ð’Ñ‹ Ð²Ð¸Ð´ÐµÑ‚Ðµ ÑÑ‚Ð¾ ÑÐ¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµe, Ð½Ðµ ÑÑ‚Ð¾. Ð•ÑÐ»Ð¸ ÑÑ‚Ð¾ Ð±Ð°Ð»Ð° Ð¾ÑˆÐ¸Ð±ÐºÐ° Ð¿Ñ€Ð¾ÑÑ‚Ð¾ Ð²Ð¾Ð¹Ð´Ð¸Ñ‚Ðµ Ð¿Ð¾Ð´ ÑÐ²Ð¾Ð¸Ð¼ Ð½Ð¾Ð²Ñ‹Ð» Ð¿Ð°Ñ€Ð¾Ð»ÐµÐ¼.');
define('_PASSWORD4','ÐŸÐ°Ñ€Ð¾Ð»ÑŒ Ð´Ð»Ñ');
define('_MAILED','ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¾.');
define('_CODEREQUESTED','Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ñ€ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´ Ð´Ð»Ñ Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ñ Ð¿Ð°Ñ€Ð¾Ð»Ñ.');
define('_YOURCODEIS','Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´:');
define('_WITHTHISCODE','Ð¡ ÑÑ‚Ð¸Ð¼ ÐºÐ¾Ð´Ð¾Ð¼ Ð²Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð¿Ð¾Ð¼ÐµÐ½ÑÑ‚ÑŒ Ð¿Ð°Ñ€Ð¾Ð»ÑŒ');
define('_IFYOUDIDNOTASK2','If you didn\'t asked for this, don\'t worry. Just delete this Email.');
define('_CODEFOR','Ð ÐµÐ³Ð¸ÑÑ‚Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ð½Ñ‹Ð¹ ÐºÐ¾Ð´ Ð´Ð»Ñ');
define('_USERPASSWORD4','ÐŸÐ°Ñ€Ð¾Ð»ÑŒ Ð´Ð»Ñ');
define('_255CHARMAX','(ÐœÐ°ÐºÑÐ¸Ð¼ÑƒÐ¼ 255 ÑÐ¸Ð¼Ð²Ð¾Ð»Ð¾Ð². Ð˜ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐ¹Ñ‚Ðµ HTML ÐºÐ¾Ð´)');
define('_CANKNOWABOUT','(ÐœÐ°ÐºÑÐ¸Ð¼ÑƒÐ¼ 255 ÑÐ¸Ð¼Ð²Ð¾Ð»Ð¾Ð². Ð Ð°ÑÑÐºÐ°Ð¶Ð¸Ñ‚Ðµ Ð½ÐµÐ¼Ð½Ð¾Ð³Ð¾ Ð¾ ÑÐµÐ±Ðµ)');
define('_SOMETHINGWRONG','Something screwed up... don\'t you hate that?');
define('_COMMENTSCONFIG','ÐšÐ¾Ð½Ñ„Ð¸Ð³ÑƒÑ€Ð°Ñ†Ð¸Ñ ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸ÐµÐ²');
define('_DISPLAYMODE','Ð Ð°ÑÐ¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð¸Ðµ Ð³Ð¾Ð»Ð¾ÑÐ¾Ð²');
define('_NOCOMMENTS','Ð‘ÐµÐ· ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ñ');
define('_NESTED','Ð¢ÑƒÐ¿Ð¾');
define('_FLAT','ÐŸÐ»Ð¾ÑÐºÐ¾');
define('_THREAD','Ð¢Ð¾Ð½ÐºÐ¾');
define('_SORTORDER','Ð¡Ð¾Ñ€Ñ‚Ð¸Ñ€Ð¾Ð²ÐºÐ° Ð³Ð¾Ð»Ð¾ÑÐ¾Ð²');
define('_OLDEST','ÐŸÐ¾ Ð²Ð¾Ð·Ñ€Ð°ÑÑ‚Ð°Ð½Ð¸ÑŽ');
define('_NEWEST','ÐŸÐ¾ ÑƒÐ±Ñ‹Ð²Ð°Ð½Ð¸ÑŽ');
define('_HIGHEST','Ð›ÑƒÑ‡ÑˆÐ°Ñ');
define('_THRESHOLD','ÐŸÐ¾Ñ€Ð¾Ð³');
define('_COMMENTSWILLIGNORED','ÐžÑ‚Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸ÐµÐ² Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ð¹ ÐºÐ°Ñ‚ÐµÐ³Ð¾Ñ€Ð¸Ð¸.');
define('_UNCUT','Ð’ÑÐµ Ð¾Ñ‚Ñ€Ð¸Ñ†Ð°Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ðµ');
define('_EVERYTHING','ÐŸÐ¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ');
define('_FILTERMOSTANON','Ð¢Ð¾Ð»ÑŒÐºÐ¾ ÐÐ½Ð¾Ð½Ð¸Ð¼Ð½Ñ‹Ðµ');
define('_USCORE','Ð‘Ð°Ð»Ð»Ñ‹');
define('_SCORENOTE','ÐÐ½Ð¾Ð½Ð¸Ð¼Ð½Ñ‹Ðµ Ð½Ð°Ñ‡Ð°Ð½Ð°ÑŽÑ‚ÑÑ Ñ 0, ÐžÑÑ‚Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ñ 1.');
define('_NOSCORES','ÐÐµ Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°Ñ‚ÑŒ Ð±Ð°Ð»Ð»Ñ‹');
define('_HIDDESCORES','(Ð•ÑÐ»Ð¸ ÑÑ‚Ð¾ Ð°ÐºÑ‚Ð¸Ð²Ð¸Ð·Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¾ Ð½Ð¾ ÐºÐ¾Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ð¸ Ð½Ðµ Ð±ÑƒÐ´ÑƒÑ‚ Ð¾Ñ‚Ð¾Ð±Ñ€Ð°Ð¶Ð°Ñ‚ÑŒÑÑ)');
define('_MAXCOMMENT','ÐœÐ°ÐºÑÐ¸Ð¼Ð°Ð»ÑŒÐ½Ð°Ñ Ð´Ð»Ð¸Ð½Ð½Ð° ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ñ');
define('_TRUNCATES','(Ð§ÐµÐ¼ Ð±Ð¾Ð»ÑŒÑˆÐµ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ Ñ‚ÐµÐ¼ Ð´Ð»Ð¸Ð½ÐµÐµ ÐºÐ¾Ð¼Ð¼ÐµÐ½Ñ‚Ð°Ñ€Ð¸Ð¸ Ð²Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð¿Ñ€Ð¾ÑÐ¼Ð°Ñ‚Ñ€Ð¸Ð²Ð°Ñ‚ÑŒ)');
define('_BYTESNOTE','Ð±Ð°Ð¹Ñ‚ (1024 Ð±Ð°Ð¹Ñ‚ = 1KÐ¸Ð»Ð¾Ð‘Ð°Ð¹Ñ‚)');
...
define('_MAX127','(Ð¼Ð°ÐºÑÐ¸Ð¼ÑƒÐ¼. 127):');
define('_MESSAGEACTIVATE','Activate Broadcast Public Messages?');
define('_ACTIVATEPERSONAL','Ð¡Ð¾Ð±ÑÑ‚Ð²ÐµÐ½Ð½Ð¾Ðµ Ð¼ÐµÐ½ÑŽ');
define('_PERSONALMENUCONTENT','Personal Menu Content');
define('_CHECKTHISOPTION','(ÐŸÑ€Ð¾Ð²ÐµÑ€ÑŒÑ‚Ðµ Ð¿Ñ€Ð°Ð²ÐµÐ»ÑŒÐ½Ð¾ÑÑ‚ÑŒ Ð²ÑÐµÑ… ÑÑÑ‹Ð»Ð¾Ðº Ð¿ÐµÑ€ÐµÐ´ Ñ‚ÐµÐ¼ ÐºÐ°Ðº Ð¿Ð¾Ð¼ÐµÑ‰Ð°Ñ‚ÑŒ Ð¸Ñ….)');
...
define('_EDITUSER','Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ');
...
define('_LOCATION','ÐÐµÑÑ‚Ð¾Ð½Ð°Ñ…Ð¾Ð¶Ð´ÐµÐ½Ð¸Ðµ');
define('_OCCUPATION','Ð Ð¾Ð´ Ð·Ð°Ð½ÑÑ‚Ð¸Ð¹');
define('_INTERESTS','Ð˜Ð½Ñ‚ÐµÑ€ÐµÑÑ‹');
