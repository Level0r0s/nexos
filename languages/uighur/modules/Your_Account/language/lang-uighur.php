...
***************************************************************
  ...
  Last modification:
  Now UTF-8 encoded                                                    
  $Id: lang-uighur.php,v 1.2 2004/10/09 04:26:47 akamu Exp $    
***************************************************************/
...
define('_BLANKFORAUTO','Bosh qaldursingiz parolingiz aptomatik shekillinidu ');
...
define('_THISISYOURPAGE','Bu sizning shexsiy bétingiz');
define('_PERSONALINFO','Shexsiy Uchur');
...
define('_AVATAR','Awatar');
define('_WEBSITE','Tor Bét');
define('_RA_LOCATION','Location');
define('_RA_OCCUPATION','Occupation');
define('_RA_INTERESTS','Interests');
define('_RA_SIGNATURE','Signature');
define('_USERSTATUS','Hazirqi Qollanchi Haletliri');
define('_ONLINE','Liniyede');
define('_OFFLINE','Biliniyede');
define('_NOTSUBSCRIBED','Xewerxétimizge mushtiri bolmapsiz');
define('_SUBSCRIBED','Xewerxétimizge mushtiri bopsiz');
define('_MA_BROADCAST','Broadcast Public Message');
define('_BROADCASTTEXT','Siz bu yerdin bir <i>Ammiwiy Meséj</i> eweteleysiz(maksimum 255 herp). Bu meséj 10 minut ichide liniyediki barliq qollanchilargha körsitilidu. Liniyediki her bir qollanchi bu betning logosi astida bu meséjni köreleydu. Her bir qollanchi bu iqtidarni <a href="modules.php?name=Your_Account&amp;op=edithome">bu yer</a> arqiliq taqiwételeydu. Buni qalaymiqan ishletmeng. Bu yerde HTML kodini qollunalmaysiz.');
define('_BROADCASTSENT','Ammiwiy meséjingiz ewetildi.');
define('_BROADCASTNOTSENT','<b>Xataliq:</b> Sizning yollighan meséjingiz quruq yaki siz bayila bir meséj yollidingiz. Yéngi ammiwiy meséj ewetish üchün 10 minut saqlishingiz zörür.');
define('_RETURNPAGE','Shexsiy bétingizge qaytish');
define('_MA_MYHEADLINES','My Headlines');
define('_SELECTASITE','Bash maqalilisini oqumaqchi bolghan tor bétini tallang:');
define('_SELECTASITE2','Tor Bet Tallash');
define('_ORTYPEURL','Yaki yaxshi köridighan bash maqalining RSS/XML url adrésini kirgüzüng:');
define('_MA_GO','Go');
define('_HEADLINESFROM','Bash Maqale:');
...
define('_NOINFOFOR','Hazirche héchqandaq uchur yoq:');
define('_SORRYNOUSERINFO','Kechürüng, muwapiq qollanchi uchuri tépilmidi');
define('_LOGININCOR','Kirish Xata! Qayta sinang...');
define('_UPDATEFAILED','Qollanchi xatirlesh yéngiöanmidi, bashqurghuchi bilen alaqilishing.');
...
define('_CHANGEHOME','Bash Bétingiz');
define('_CHANGEYOURINFO','Profilingiz');
define('_CONFIGCOMMENTS','Bahalar');
define('_DELETEACCT','Delete<br>Account');
define('_LOGOUTEXIT','Chiqish/Logout');
define('_MA_MESSAGES','Messages');
define('_RETURNACCOUNT','Hésab bétingizge qaytish ');
define('_SELECTTHETHEME','Témilar');
...
define('_USERLOGIN','Qollanchi Kirishi');
define('_REGNEWUSER','Yéngi Qollanchi Tizimlitish');
define('_PASSWORDLOST','Parolingizni Untupsizmu?');
define('_NOPROBLEM','Chataq yoq. Namingizni kirgüzüp ewetish kunupkisini chéking. Biz aptomatik halda sizge jezimlesh kodi ewetimiz, andin siz namingiz bilen biz ewetken jezimlesh kodini kirgüzüp yéngi parolgha érishisiz.');
define('_CONFIRMATIONCODE','Jezimlesh Kodi');
define('_SENDPASSWORD','Parol Ewetish');
define('_MA_YOUARELOGGEDOUT','You are now logged out!');
define('_USERACCOUNT','Qollanchi Hésabi');
define('_AT','da');
define('_HASTHISEMAIL','bu e-mail bilen munasiwetlik.');
define('_AWEBUSERFROM','Qollanchi:');
define('_HASREQUESTED','parol ewetishni telep qildi.');
define('_YOURNEWPASSWORD','Yéngi parolingiz:');
define('_YOUCANCHANGE','Siz kirgendin kéyin uni özgerteleysiz ');
define('_IFYOUDIDNOTASK','Özgertishni telep qilmighan bolsingiz kérek yoq, buni sizla qobul qildingiz. Siz yéngi parol bilen kirsingiz boliwéridu.');
define('_PASSWORD4','Qollanchi');
define('_MAILED','Yollandi.');
define('_CODEREQUESTED','parol özgertishke kéreklik jezimlesh kodini telep qildi.');
define('_YOURCODEIS','Jezimlesh kodingiz:');
define('_WITHTHISCODE','Bu kod arqiliq yéngi parol alidighan orun:');
define('_IFYOUDIDNOTASK2','Siz buni telep qilmighan bolsingiz héchqisi yoq. Bu e-mailni öchürüwetsingizla boldi.');
define('_CODEFOR','Jezimlesh Kodi:');
define('_USERPASSWORD4','Qollanchi Paroli:');
define('_255CHARMAX','(Imzayingiz üchün maksimum 255 herp kirgüzüng. HTML kodi ishletsingiz bolidu)');
define('_CANKNOWABOUT','(Özingiz heqqide bashqa uchurlarni kirgüzüng. Maksimum 255 herp)');
define('_SOMETHINGWRONG','Qalaymiqanchiliq tughuldi...');
define('_COMMENTSCONFIG','Pikir Konfigratsiyesi');
define('_DISPLAYMODE','Körsütish Modéli');
define('_NOCOMMENTS','Pikir Yoq');
define('_NESTED','Oralghan');
define('_FLAT','Tüz');
define('_THREAD','Yip');
define('_SORTORDER','Sortlash Tertipi');
define('_OLDEST','Konisi Awwal');
define('_NEWEST','Yéngisi Awwal');
define('_HIGHEST','Yuqiri Nomurluqi Awwal');
define('_THRESHOLD','Bosugha');
define('_COMMENTSWILLIGNORED','Baha nomuri belgilimidin kichikliri körünmeydu.');
define('_UNCUT','Qaychilanmigan we Xam');
define('_EVERYTHING','Hemmisi Dégidek');
define('_FILTERMOSTANON','Bamsizlarni Süzüsh');
define('_USCORE','Nomur');
define('_SCORENOTE','Namsizning nomuri 0 din, tizimlatqanlarning 1 din bashlinidu. Nazaretchi nomurlarni qoshalaydu hem éliwételeydu.');
define('_NOSCORES','Nomurni Yoshurush');
define('_HIDDESCORES','(Yoshurun nomur: Bu nomur inawetlik, biraq siz körelmeysiz.)');
define('_MAXCOMMENT','Bahaning maksimum uzunluqi ');
define('_TRUNCATES','(Uzun baha qisqartilip dawami ulunush qilinidu. Bek chong qiliwetse inawetsiz)');
define('_BYTESNOTE','bytes (1024 bytes = 1K)');
//define('_PRIVATEMESSAGES', 'Your Private Messages');
define('_BROWSEUSERS','Qollanchilarni Körsütish');
define('_SEARCHUSERS','Qollanchi Izdesh');
define('_SENDPRIVATEMSG','Send a Private Message to');
define('_THEME','Theme');
define('_MA_HOMECONFIG','Homepage Configuration');
define('_MAX127','(maksimum 127):');
define('_MESSAGEACTIVATE','Ammiwiy meséj yollashni aktiplamsiz?');
define('_ACTIVATEPERSONAL','Shexsiy Menüni Aktiplash');
define('_PERSONALMENUCONTENT','Personal Menu Content');
define('_CHECKTHISOPTION','(Bu tallashni aktiplang andin töwendiki tékst bash bette körünidu)');
...
define('_BROADCASTMSG','Xewer tarqitishni aktiplamsiz?');
define('_MYHEADLINES','Bash Maqalem');
define('_USERSHOMENUM','Qollanchilargha bash bettiki xewer numurini özgertsih ijaziti béremsiz?');
define('_PASSWDLEN','Parolning minimum uzunluqi');
...
define('_EDITUSER','Qollanchi Tehririlesh');
define('_SELECTAUSER','Select a User');
define('_ICQ','ICQ Nomuri');
define('_AIM','AIM Nomuri');
define('_YIM','YIM Nomuri');
define('_MSNM','MSNM Nomuri');
define('_LOCATION','Orun');
define('_OCCUPATION','Kesip');
define('_INTERESTS','Qiziqishlar');
define('_EXTRAINFO','Qoshumche Uchur');
