...
// 'Pictures and thumbnails settings',
        ...
        array('Dimensionen ( Höhe, Breite oder Maximaler Aspekt für die thumbnails )<b>*</b>', 'thumb_use', 7),
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'neue Bilder suchen',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : bedeuted, daß das Bild erfolgreich hinzugefügt wurde' . '<li><b>DP</b> : bedeutet, daß das Bild ein Duplikat ist und schon in der Datenbank vorhanden ist' . '<li><b>PB</b> : bedeutet, daß das Bild nicht hinzugefügt werden konnte; überprüfe Deine Einstellungen und die Berechtigungen der Verzeichnisse, in dem die Bilder liegen' . '<li>Falls die OK, DP, PB \'Zeichen\' nicht erscheinen klicke auf die nicht-funktionierenden Bilder, um die Fehlermeldungen von PHP zu sehen' . '<li>Wenn Dein Browser in ein Timeout läuft, klicke auf die Aktualisieren-Schaltfläche' . '</ul>',
