...
// for postnuke change
       ...
       // 'Pictures and thumbnails settings',
        ...
        array('Welche Dimension soll genutzt werden f&uuml;r den Fingerabdruck ( Breite oder H&ouml;he oder das, was jeweils gr&ouml;sser ist)<b>*</b>', 'thumb_use', 7),

        array('Maximale H&ouml;he oder Breite vom Fingerabdruck <b>*</b>', 'thumb_width', 0),
        array('Bilder in Zwischengr&ouml;ße erzeugen', 'make_intermediate', 1),
        array('Maximale Breite oder H&ouml;he von Bildern in Zwischengr&ouml;ße <b>*</b>', 'picture_width', 0),
...
//'Custom fields for image description (leave blank if unused)',
        ...
        array('Vorsilbe f&uuml;r Bilder in Zwischengr&ouml;ße <b>*</b>', 'normal_pfx', 0),
        array('Vorsilbe f&uuml;r den Fingerabdruck <b>*</b>', 'thumb_pfx', 0),
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array('group_name' => 'Gruppen-Name',
        ...
        'note1' => '<b>(1)</b> Das Hochladen in ein &ouml;ffentliches Album muß durch den Admin best&auml;tigt werden',
        'note2' => '<b>(2)</b> Das Hochladen in ein privates Album muß durch den Admin best&auml;tigt werden',
        'notes' => 'Anmerkungen'
        );
// ------------------------------------------------------------------------- //
// File index.php
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array('page_title' => 'neue Bilder suchen',
        ...
        'notes' => '<ul>' . '<li><b>OK</b> : bedeuted, daß das Bild erfolgreich hinzugef&uuml;gt wurde' . '<li><b>DP</b> : bedeutet, daß das Bild ein Duplikat ist und schon in der Datenbank vorhanden ist' . '<li><b>PB</b> : bedeutet, daß das Bild nicht hinzugef&uuml;gt werden konnte; &uuml;berpr&uuml;fe Deine Einstellungen und die Berechtigungen der Verzeichnisse, in dem die Bilder liegen' . '<li>Falls die OK, DP, PB \'Zeichen\' nicht erscheinen klicke auf die nicht-funktionierenden Bilder, um die Fehlermeldungen von PHP zu sehen' . '<li>Wenn Dein Browser in ein Timeout l&auml;uft, klicke auf die Aktualisieren-Schaltfl&auml;che' . '</ul>',
