...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/dutch_formal/main.php,v $
  $Revision: 1.30 $
  $Author: estlane $
...
define('_MODULEUSERS2','U kunt uzelf gratis registreren door op <a href="'.getlink('Your_Account&amp;file=register').'">deze</a> link te klikken, hierdoor krijgt u toegang tot dit deel van onze site. <br /><br />Wij danken u voor uw begrip.');
...
define('_RESET','Reset');
define('_AT','at');
define('_LASTMSGS','Laatste %s Forum berichten');
define('_LASTPOSTBY','Laatste bericht door %1$s in %2$s op %3$s');
...
define('_NEWSLETTERBLOCKSUBSCRIBED','U <strong>bent </strong> geabonneerd op <br /> onze nieuwsbrief');
define('_NEWSLETTERBLOCKNOTSUBSCRIBED','U bent <strong>niet</strong> geabonneerd op <br /> onze nieuwsbrief ');
define('_NEWSLETTERBLOCKREGISTER','U moet een <br /><strong>geregistreerde gebruiker</strong<br /> zijn om onze nieuwsbrief te ontvangen');
...
define('_UM_TOGGLE','Activeer Ipdate Monitor');
...
define('_ERROR_ALREADYEXIST','%s bestaat al');
