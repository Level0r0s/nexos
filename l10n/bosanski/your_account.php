...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/bosanski/your_account.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
...
global $MAIN_CFG;
define('_MA_HIDDEN','Sakrivneo');
define('_MA_VISIBLE','Vidljivo');
define('_MA_REQUIRED','Traženo');
define('_MA_PROFILE_INFO','Informacija Profila');
define('_MA_ADDITIONAL','Additional Information');
define('_MA_REALNAME','Pravo Ime');
define('_MA_FAKEMAIL','Lažni E-mail');
define('_MA_HOMEPAGE','Stranica');
define('_MA_ICQ','ICQ Broj');
define('_MA_AIM','AIM Ime');
define('_MA_YIM','Yahoo! Messenger ID');
define('_MA_MSNM','MSN Adresa');
define('_MA_LOCATION','Lokacija');
define('_MA_OCCUPATION','Zanimanje');
define('_MA_INTERESTS','Hobij');
define('_MA_SIGNATURE','Potpis');
define('_MA_EXTRAINFO','Extra Informacija');
define('_MA_PREFERENCES','Postavi');
define('_MA_TIMEZONE','Vremenska Zona');
define('_MA_DATEFORMAT','Postav Vremena');
define('_MA_RECEIVENEWSLETTER','Primi Novine');
define('_MA_SHOWEMAIL','Prikaži Email Adresu');
define('_MA_SHOWONLINE','Prikazi Kad Sam Prisutan');
define('_MA_ALLOWBBCODE','Uvijek Odobri BBKOD');
define('_MA_ALLOWHTML','Uvijek Odobri HTML');
define('_MA_ALLOWSMILIES','Uvjek Odobri Smjeske');
define('_MA_NOTIFYREPLY','Obavjesti Me O Odgovorima');
