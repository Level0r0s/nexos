...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/ukrainian/content.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_PUBLISHEDON','Опубліковано ');
define('_PAGESLIST','Список сторінок');
define('_LISTOFCONTENT','Список доступного вмісту в');
define('_YOURADMINLIST','Ви адміністратор: далі йде список деактивованих сторінок:');
define('_COPYRIGHT','Copyright &copy; ');
define('_COPYRIGHT2','Всі права захищені');
define('_CONTENTCATEGORIES','Доступні категорії змісту');
define('_NONCLASSCONT','Зміст поза категоріями');
