...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/ukrainian/web_links.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account").'">Реєстрація</a>');
...
define('_ONLYREGUSERSMODIFY','Тільки зареєстровані користувачі можуть скачувати модифікації. Будь ласка, <a href="'.getlink("Your_Account").'">зареєструйтесь або ввійдіть в систему</a>.');
