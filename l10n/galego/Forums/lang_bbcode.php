 ...
 *
 *   $Source: /cvs/l10n/galego/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
...
$faq[] = array("Creando un enlace a outro sitio", "phpBB BBCode soporta varias formas de facer un enlace, a primeira é con [url=][/url], por exemplo, para facer un enlace a phpBB.com pode usar:[url=http://phpbb.com/]Visite phpBB![/url], os enlaces abriranse nunha nova fiestra, outra forma é [url]http://phpbb.com/[/url]. Este foro ten tamén ENLACES MÁXICOS, por exemplo, se teclea phpbb.com na súa mensaxe aparecerá automaticamente como enlace. Para facer un enlace a un correo electrónico deberá poñer: [email]alguen@seuenderezo.com[/email] ou simplemente teclea-lo enderezo e convertirase nun enlace. Pode combina-lo coa etiqueta [img][/img] para que o enlace sexa unha imaxe, así: [url=http://phpbb.com/][img]http://phpbb.com/images/phplogo.gif[/url][/img].");

$faq[] = array("--", "Publicando imaxes nas mensaxes");
$faq[] = array("Engadindo unha imaxe á mensaxe", "Para poñer unha imaxe simplemente escriba [img]URL[/img] donde URL é o enderezo donde está a súa imaxe, por exemplo [img]http://phpbb.com/images/phplogo.gif[/img], tamén pode xerar enlaces do seguinte xeito: [url=][/url] así [url=http://phpbb.com/][img]http://phpbb.com/images/phplogo.gif[/img][/url]");
