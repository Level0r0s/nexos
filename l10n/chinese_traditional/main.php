...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/chinese_traditional/main.php,v $
  $Revision: 9.31 $
  $Author: estlane $
...
define('_PASSWORD','暱稱');
define('_WELCOMETO','歡迎光臨');
define('_EDIT','編輯');
define('_DELETE','刪除');
define('_POSTEDBY','貼出者為');
define('_READS','閱讀');
define('_GOBACK','[ '.(isset($_SERVER['HTTP_REFERER']) ? '<a href="'.str_replace('&', '&amp;', $_SERVER['HTTP_REFERER']).'">回到上一頁</a>' : '<a href="javascript:history.go(-1)">回到上一頁</a>').' ]');
define('_COMMENTS','意見');
...
define('_YOUAREANON','您正匿名使用中, 請來<a href="'.getlink('Your_Account&amp;file=register').'">免費註冊</a>');
define('_NOTE','註：');
define('_ADMIN','管理');
...
define('_MODULEUSERS','對不起，這個區域只有<i>已註冊使用者</i>才能讀取。<br /><br />您可以<a href="'.getlink("Your_Account&amp;file=register").'">點這裡</a>免費註冊, 註冊後<br />您便可以自由讀取此區域。謝謝。<br /><br />');
...
define('_MODULESGROUPS','需要有群組存取權限');
define('_HOME','首頁');
...
define('_ABR_MONDAY','一');
define('_ABR_TUESDAY','二');
define('_ABR_WEDNESDAY','三');
define('_ABR_THURSDAY','四');
define('_ABR_FRIDAY','五');
define('_ABR_SATURDAY','六');
...
define('_PRINTER','友善列印頁面');

define('_CREDITS_TITLE','Credits');
define('_CREDITS_PRODUCT','產品');
define('_CREDITS_DESC','描述');
define('_CREDITS_AUTHORS','作者(們)');

define('_PP_TITLE','Privacy Policy');
define('_PP_MODIFY','修改這篇訊息');

define('_SENDEREMAIL','寄件人 Email');
define('_SENDERNAME','寄件人大名');
...
define('_ERROR_DELETE_CONF','您確定要刪除 %s?');
define('_ERROR_NO_EXIST','%s 不存在');
define('_ERROR_ALREADYEXIST','%s 已經存在');
define('_TASK_COMPLETED','操作完成!');
