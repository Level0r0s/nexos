 ...
 *
 *   $Source: /cvs/l10n/chinese_traditional/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
...
$faq[] = array("--", "建立連結");
$faq[] = array("連結到其它網站", "phpBB BBCode 代碼支援數種產生網址的方式, 一般來說, 最常用的就是 URLs 功能.<ul><li>使用這個方法必須先使用 <b>[url=][/url]</b> 標籤, 在等號 ( = ) 之後, 無論您輸入任何資料, 皆會使得此一標籤連結到您指定的 URL. 舉例說明, 要連結 phpBB.com 時, 您可以使用:<br /><br /><b>[url=http://phpbb.com/]</b>參觀 phpBB!<b>[/url]</b><br /><br />這會產生以下連結, <a href=\"http://phpbb.com/\" target=\"_blank\">參觀 phpBB!</a> 您必須注意的是, 點選連結將開啟一個新的視窗, 這是為了方便瀏覽者能繼續瀏覽版面內容而設的.<br /><br /></li><li>如果您想要 URL 自行顯示成連結, 您可以使用簡單的設定:<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />這將會產生以下連結, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a><br /><br /></li><li>在附加的 phpBB 功能中, 有一個<b>神奇連結</b>的功能, 這個功能將轉換所有正確的 URL 句型成為連結, 您無需指定任何標籤也不需要在句首加上 http://. 例如您在文章中輸入 phpbb.com, 當您瀏覽時, 將自動轉換成 <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> 顯示.<br /><br /></li><li>這個功能也支援電子郵件位址, 您可以指定一個特定位址, 例如:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />將會顯示為 <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> 或是您只要輸入 no.one@domain.adr 系統會自動轉換為預設的電子郵件位址.<br /><br /></li></ul>當您使用 BBCode  URLs 的標籤時也可以加入其它標籤功能, 如 <b>[img][/img]</b> (可參考下一個說明), <b>[b][/b]</b>...等等, 您可以搭配使用任何的標籤, 但切記需正確的開啟及關閉標籤, 例如:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />就是個不正確的語法, 不當的使用將導致您的文章被刪除, 所以請小心使用.");

$faq[] = array("--", "在文章中插入圖片");
$faq[] = array("在文章中插入圖片", "phpBB BBCode 代碼提供標籤在您的文章中顯示圖像. 使用前, 請記住兩件重要的事;  第一, 許多使用者並不樂於見到文章中有太多的圖片, 第二, 您的圖片必須是能在網路上顯示的 (例如: 不能是您電腦上的檔案 (除非您的電腦是台網路伺服器). phpBB 目前沒有提供儲存圖片的功能  (在下一版的 phpBB 或許會加入此項功能). 目前, 若要顯示圖像, 您必須使用 <b>[img][/img]</b> 標籤並指定圖像連結網址,  例如:<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />如同在先前網址連結的說明一樣, 您也可以使用圖片網址超連結 <b>[url][/url]</b> 的標籤, 例如:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />將產生:<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
