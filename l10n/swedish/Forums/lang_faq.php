 ...
 *
 *   $Id: lang_faq.php,v 9.2 2006/02/10 14:02:58 djmaze Exp $
 *
 *
...
$faq[] = array("Kan jag posta bilder?", "Bilder kan visas i ditt meddelande. Dock finns det för tillfället ingen funktion för att ladda upp bilder till forumet. Därför måste du länka till en bild som lagras på en publik webserver, t.ex. <pre>http://some-unknown-place.net/my-picture.gif</pre>. Du kan inte länka till bilder som lagras på din lokala PC (såvida den inte är en publikt tillgänglig server) eller till bilder som lagras bakom auktoriserings mekanismer, e.g. hotmail eller yahoo mailkonto, lösenordsskyddade siter, etc. För att visa en bild så använd antingen BBCode [img] taggen eller motsvarande HTML (om det tillåts).");
