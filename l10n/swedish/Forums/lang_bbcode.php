 ...
 *
 *   $Source: /cvs/l10n/swedish/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
 *   $Date: 2006/02/10 14:02:58 $
...
$faq[] = array("Länka till en annan sida", "phpBB BBCode stödjer ett antal olika sätt att skapa URIs, Uniform Resource Indicators mer kända som URLs.<ul><li>De första sättet använder <b>[url=][/url]</b> taggen, allt du än skriver in efter = tecknet kommer att tolkas som URL och göra så att du kan skriva in t.ex. en text mellan taggarna. För att t.ex. länka till phpBB.com kan du använda:<br /><br /><b>[url=http://phpbb.com/]</b>Besök phpBB!<b>[/url]</b><br /><br />Det här skriver ut följande länk, <a href=\"http://phpbb.com/\" target=\"_blank\">Besök phpBB!</a> Du kommer att märka att länken öppnas i ett nytt fönster så att användaren kan fortsätta använda forumet om de så önskar.</li><li>Om du vill att URLen själv skall visas som länk kan du skriva::<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />Det skulle skriva ut följnade länk, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a></li><li>Det finns även en funktion som kallas <i>Magiska Länkar</i>, det kommer att automatiskt att göra om en URL till en länk utan att du varken behöver specificera några taggar eller http://. Om du till exempel skriver phpbb.com i ditt meddelande så kommer det automatiskt bli <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> när inlägget visas.</li><li>Samma sak gäller email adresser, du kan antingen skriva in:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />vilket skulle skriva ut <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> eller så kan du bara skriva no.one@domain.adr i ditt meddelande och så kommer det att automatiskt bli konverterat när inlägget visas.</li></ul>Precis som med alla andra BBCode taggar kan du omgärda URLs runt andra taggar t.ex. <b>[img][/img]</b> (se nästa del), <b>[b][/b]</b>, etc. Precis som med formaterings taggarna så är det upp till dig att se till att taggarna öppnas och stängs i rätt ordning, till exempel:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />är <u>inte</u> korrekt och kan leda till att ditt inlägg blir borttaget så var försiktig.");

$faq[] = array("--", "Visa bilder i inlägg");
$faq[] = array("Lägg till en bild i ett inlägg", "phpBB BBCode har även en tag för att visa bilder i dina inlägg. Två väldigt viktiga saker bör kommas ihåg när man använder den här taggen; många användare uppskattar inte stora mängder av bilder i inlägg och i andra hand att bilden du vill visa måste finnas tillgänglig på internet (den kan alltså inte bara finnas på din dator, om du inte kör en webserver!). Det finns för tillfället inte något sätt att spara bilder lokalt med phpBB (alla dessa frågor förväntas bli åtgärdade i nästa utgåva av phpBB). För att visa en bild måste du omgärda URLen som pekar mot bilden med <b>[img][/img]</b> taggar. Till exempel:<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />Du kan även omgärda en bild med <b>[url][/url]</b> taggarna om du så önskar, t.ex<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />skulle skriva ut:<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
