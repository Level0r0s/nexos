...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/swedish/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_DL_NOEXISTS','Den filen du önskade att ladda ner finns inte.');
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Registrera dig som medlem</a>');
...
define('_DRATENOTE4','Du kan se en lista av de <a href="'.getlink("Downloads&amp;d_op=TopRated").'">högst betygsatta resurserna</a>.');
...
define('_EZTRANSFERDOWNLOADS','Flytta alla nerladdningar från kategorien');
define('_DELEZDOWNLOADSCATWARNING','VARNING: Är du säker på att du vill ta bort denna kategori? Du kommer också att ta bort alla under kategorier och dess filer!');
define('_DELCONTENTCAT','VARNING: Är du säker på att du vill ta bort denna kategori? Sidor i denna kategori, om finnes kommer inte att tas bort, men kommer inte att läggas in i en annan kategori.');
define('_DELCATEGORY','Ta bort kategori');
define('_DOWNLOADTITLE','Nerladdnins titel');
define('_DOWNLOADSINDB','Nerladdningar i vår databas');
define('_DOWNLOADSWAITINGVAL','Nerladdningar som väntar på att bli bekräftade');
define('_CLEANDOWNLOADSDB','Nollställ nerladdnings röster');
define('_BROKENDOWNLOADSREP','Brutna nerladdnings rapportet');
define('_DOWNLOADMODREQUEST','Nerladdnings modifikation önskas');
define('_ADDNEWDOWNLOAD','Lägg till en ny nerladdning');
define('_MODDOWNLOAD','Ändra en nerladdning');
define('_WEBDOWNLOADSADMIN','Sid nerladdnings administration');
define('_DNOREPORTEDBROKEN','Inga brytna nerladdningar har rapporterats.');
define('_DUSERREPBROKEN','Användar rapporter: Brytna nerladdningar');
define('_DIGNOREINFO','Ignorera (Ta bort alla <b><i>önskemål</i></b> för vald nerladdning)');
define('_DDELETEINFO','Ta bort (Ta bort <b><i>bryten nerladdning</i></b> och <b><i>önskningar</i></b> för vald nerladdning)');
define('_DOWNLOADOWNER','Nerladdnings ägare');
define('_DUSERMODREQUEST','Användar nerladdnings modification behövs ');
define('_DOWNLOADVALIDATION','Nerladdnings bekräftelse');
define('_CHECKALLDOWNLOADS','Kryssa ALLA nerladdningar');
define('_VALIDATEDOWNLOADS','Bekräfta nerladdningar');
define('_NEWDOWNLOADADDED','Ny nerladdning har lagts till i databasen');
