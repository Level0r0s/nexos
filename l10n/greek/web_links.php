...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/greek/web_links.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account").'">Εγγραφή</a>');
...
define('_RATENOTE4','Μπορείτε να δείτε μία λίστα από τους <a href="'.getlink('Web_Links&amp;l_op=TopRated').'"> 10 πρώτους</a>.');
