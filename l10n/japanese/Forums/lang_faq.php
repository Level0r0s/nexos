...
$faq[] = array("phpBB 2を作成したのは誰でしょうか？", "このソフトウェアは<a href=\"http://phpbb.com/\" target=\"_blank\">phpBB Group</a>によって作られたもので、著作権はphpBB Groupが有しています。phpBB 2は、GNU 一般公有使用許諾書に定められている条件に従って使用や配布が許諾されています。詳細については、phpBB Groupのサイトを見てください。");
