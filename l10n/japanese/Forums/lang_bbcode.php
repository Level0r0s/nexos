 ...
 *
 *   $Source: /cvs/l10n/japanese/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
...
$faq[] = array("--", "リンクの作成");
$faq[] = array("他のサイトのリンクを作る方法", "BBCodeでは特定のURLへのリンクを作る方法をいくつかサポートしています。<ul><li>リンクしたい文字を<b>[url=][/url]</b>で囲みます。\"=\"の後にリンク先のURLを入力します。例えばphpBB.comへのリンクを作る場合は次のようにします：<br /><br /><b>[url=http://phpbb.com/]</b>Visit phpBB!<b>[/url]</b><br /><br />上記のようにすると <a href=\"http://phpbb.com/\" target=\"_blank\">Visit phpBB!</a> と表示されます。デフォルトではリンクをクリックすると新しいウィンドウにリンク先のページが表示されるようになっています。</li><li>URLそのものをリンクにしたい場合は、単純に次のようにします：<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />上記のようにすれば <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a> と表示されます。</li><li>phpBBには<i>自動リンク機能</i>が含まれています。自動リンクは構文的に正しいURLをタグを使用していなくてもリンクにする機能です。例えば phpbb.com と入力すると、これは自動的に <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> と表示されます</li><li>メールアドレスに関しても自動リンク機能が有効になっています：<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />上記のようにすれば <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> となります。しかし、タグをつけずに no.one@domain.adr と入力するだけでも自動的にリンクが作られます</li></ul>リンクのタグは <b>[img][/img]</b> （このタグについては次の項目を見てください）, <b>[b][/b]</b> など他の全てのBBCodeタグを囲むことができます。一つの部分に複数のタグを使用する場合は開始タグと終了タグを正しく並べてください。次のタグの使い方は間違ったものです：<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />上記の例は<u>誤った並べ方</u>なので注意してください");

$faq[] = array("--", "画像の表示");
$faq[] = array("画像を載せる方法", "BBCodeを用いて画像を投稿記事に載せることができます。画像を使用する場合は2つほど注意することがあります。1つ目は多くのユーザーは大量の画像が表示される記事を好ましく思っていませんので、載せる画像の数やサイズに注意する必要があります。2つ目は使用する画像は既にインターネット上で利用できるものに限られるということです。現在のバージョンでは一時的にphpBBが画像を保管する機能はありません。画像を載せるには画像のURLを<b>[img][/img]</b>で囲みます：<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />リンクに関する項目でも述べていますが、画像にリンクを張る場合は上記の構文を<b>[url][/url]</b>で囲みます：<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />上記のようにすれば次のようになります：<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
