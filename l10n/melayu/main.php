...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/melayu/main.php,v $
  $Revision: 9.29 $
  $Author: estlane $
...
define('_GOBACK','[ '.(isset($_SERVER['HTTP_REFERER']) ? '<a href="'.str_replace('&', '&amp;', $_SERVER['HTTP_REFERER']).'">Undur</a>' : '<a href="javascript:history.go(-1)">Undur</a>').' ]');
...
define('_MONDAY','Isin');
define('_TUESDAY','Salasa');
define('_WEDNESDAY','Rabu');
define('_THURSDAY','Khamis');
define('_FRIDAY','Jumat');
define('_SATURDAY','Sabtu');
define('_SUNDAY','Mingu');
//three letter abbrev.
...
define('_CREDITS_TITLE','Runchanan');
...
define('_Tell_a_FriendLANG','Cadangkan Kami');
