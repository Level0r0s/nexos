...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/lithuanian/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Registruokitės</a>');
...
define('_DONLYREGUSERSMODIFY','Tik registruoti vartotojai gali siūlyti programų pakeitimus. Prašome <a href="'.getlink("Your_Account").'">užsiregistruoti arba prisijungti</a>.');
...
define('_DRATENOTE4','Jūs galite pažiūrėti <a href="'.getlink("Downloads&l_op=TopRated").'">geriausių programų sąrašą</a>.');
