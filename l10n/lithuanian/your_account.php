...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/lithuanian/your_account.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_BROADCASTTEXT','Jūs galite siųsti <i>viešą žinutę</i> (maks. 255 simboliai). Ši žinutė bus rodoma 10 minučių visiems vartotojams. Kiekvienas prisijungęs lankytojas matys tik vieną kartą raudona spalva po svetainės logotipu. Bet kuris vartotojas gali deaktyvuoti šią galimybę <a href="'.getlink('Your_Account&edit=prefs').'">čia</a>. Prašau nepiktnaudžiauti. HTML naudojimas neleidžiamas.');
