 ...
 *
 *   $Id: lang_faq.php,v 9.2 2006/02/12 16:02:13 djmaze Exp $
 *
 *
 *********************************************************/
...
$faq[] = array("Kalbø sàraðe að nerandu savo kalbos!", "Greièiausiai jûsø norima kalba neádiegta arba tiesiog niekas dar neiðvertë ðios diskusijø lentos á tà kalbà. Jeigu vertimas egzistuoja, pabandykite papraðyti administratoriaus, kad jis ádiegtø jums reikiamà kalbà. Kitu atveju galite iðsiversti patys. Daugiau informacijos rasite phpBB grupës puslapyje (phpbb.com).");
...
$faq[] = array("Ar galiu á praneðimà átraukti paveikslëlá?", "Taip. Taèiau to negalima padaryti tiesiogiai, t.y. paveikslëliai nebus saugomi diskusijø duomenø bazëje. Jums reikës nurodyti kelià iki paveiklëlio Internete, pvz http://kazkoks-puslapis.com/paveikslelis.jpg. Atsiminkite, jûs negalite nurodyti kelio á savo kompiuterá (nebent jis yra tuo paèiu ir web serveris)! Taip pat negalite átraukti paveikslëlio kuris yra uþ tam tikrø autentifikacijos mechanizmø, tokiø kaip paðto deþutë. Norëdami ávesti kelià iki paveikslëlio naudokite BBKodà arba HTML (jeigu turite teisæ).");
...
$faq[] = array("Kas paraðë ðià diskusijø lentà?", "Ðis produktas (savo originalioje formoje) yra pagamintas ir iðleistas <a href=\"http://phpbb.com/\" target=\"_blank\">phpBB Grupës</a>. Ði diskusijø lenta, kaip programinis produktas yra platinamas po GNU GPL licenzija. Daugiau informacijos rasite adresu <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a>.");
