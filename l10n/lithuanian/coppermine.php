...
/*********************************************
  ...
  ********************************************
  $Source: /cvs/l10n/lithuanian/coppermine.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('PIC_VIEWS', 'Žiūrėjimai');//new in 1.2.2nuke
define('PIC_VOTES', 'Balsai');//new in 1.2.2nuke
define('PIC_COMMENTS', 'Komentarai');//new in 1.2.2nuke

// lang_translation_info
define('LANG_NAME_ENGLISH', 'Lithuanian');
define('LANG_NAME_NATIVE', 'Lietuviškai');
define('LANG_COUNTRY_CODE', 'lt');
...
define('RANDOM', 'Atsitiktini Paveiksliukai');
define('LASTUP', 'Paskutinės Foto');
define('LASTUPBY', 'My Last Additions');
define('LASTALB', 'Last updated albums');
define('LASTCOM', 'Paskutiniai Komentarai');
define('LASTCOMBY', 'My Last comments');
define('TOPN', 'Daugiausiai Žiūrėtos');
define('TOPRATED', 'Didžiausiai Įvertintos');
define('LASTHITS', 'Paskutinės Žiūrėtos');
