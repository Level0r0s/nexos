 ...
 *
 *   $Source: /cvs/l10n/indonesian/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
...
$faq[] = array("Link ke situs lain", "BBCode phpBB menyediakan berbagai cara untuk membuat URI, Uniform Resource Indicators atau lebih dikenal dengan URL.<ul><li>Metode pertama menggunakan tag <b>[url=][/url]</b>, apapun yang ditulis setelah tanda = akan berfungsi sebagai URL. Contohnya, untuk membuat link ke phpBB.com, ketik:<br /><br /><b>[url=http://phpbb.com/]</b>Kunjungi phpBB!<b>[/url]</b><br /><br />yang akan menghasilkan, <a href=\"http://phpbb.com/\" target=\"_blank\">Kunjungi phpBB!</a> Anda akan melihat bahwa link terbuka di window lain sehingga user dapat melanjutkan browsing di forum sesuai keinginannya.</li><li>Jika Anda ingin menampilkan alamat URL sendiri sebagai teks untuk link, gunakan:<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />Ini akan menghasilkan link, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a></li><li>Tambahan lainnya, phpBB memiliki fitur yang disebut <i>Magic Links</i>, yang akan membuat semua yang valid sebagai URL ditampilkan sebagai link tanpa harus dibuatkan tag secara khusus, atau bahkan http://. Contoh, menulis phpbb.com dalam pesan Anda secara otomatis akan menghasilkan <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> sewaktu pesan ditampilkan.</li><li>Hal yang sama terjadi pada alamat email. Anda dapat secara explicit menulis:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />yang akan menghasilkan <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> atau dapat langsung menuliskan no.one@domain.adr pada isi pesan yang selanjutnya akan otomatis dikonversi sewaktu dilihat.</li></ul>Seperti tag BBCode lainnya, URL dapat mengapit tag lain seperti <b>[img][/img]</b> (lihat bagian selanjutnya), <b>[b][/b]</b>, dll. Seperti juga tag lain, Anda bertanggung jawab untuk membuka dan menutup tag dengan benar. Contoh:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br /> <u>tidak tepat</u> dan dapat menyebabkan pesan Anda dapat dihapus. Jadi berhati-hatilah.");

$faq[] = array("--", "Menampilkan gambar pada pesan");
$faq[] = array("Menambahkan gambar pada isi pesan", "BBCode phpBB menggunakan suatu tag untuk menampilkan gambar pada posting Anda. Dua hal sangat penting yang harus diingat waktu menggunakan tag ini adalah; banyak user yang tidak senang terlalu banyak gambar pada pesan dan kedua, gambar yang Anda masukkan harus tersedia di internet (gambar ini tidak boleh hanya tersedia pada komputer Anda sendiri contohnya, kecuali jika Anda menjalankan webserver sendiri!). Saat ini tidak tersedia fasilitas untuk menyimpan gambar secara lokal di phpBB (semua masalah ini diharapkan akan diselesaikan pada rilis selanjutnya dari phpBB). Untuk menampilkan gambar, Anda harus mengapit URL yang mengarah ke gambar tersebut dengan tag <b>[img][/img]</b>. Contohnya <br /><br /><b>[img]</b>http://phpbb.com/images/mainlogo.gif<b>[/img]</b><br /><br />Seperti telah dijelaskan pada bagian URL di atas, Anda dapat mengapit gambar dengan tag <b>[url][/url]</b> jika diinginkan, contohnya <br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/mainlogo.gif<b>[/img][/url]</b><br /><br /> akan menghasilkan <br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"http://phpbb.com/images/mainlogo.gif\" border=\"0\" alt=\"\" /></a><br />");
