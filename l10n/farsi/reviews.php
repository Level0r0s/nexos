...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/farsi/reviews.php,v $
  $Revision: 9.6 $
  $Author: nanocaiordo $
...
define('_SORTASC','مرتب کردن صعودی');
define('_SORTDESC','مرتب کردن نزولی');
define('_CANCEL','لغو کردن');
define('_SCORE','امتیاز:');
define('_REPLYMAIN','ارسال نظر');
define('_ALLOWEDHTML','استفاده مجاز از html :');
define('_POSTANON','ارسال مهمان');
define('_WRITEREVIEW','نوشتن نقد نامه');
define('_WRITEREVIEWFOR','نوشتن نقد برای');
define('_ENTERINFO','Please enter information according to the specifications');
define('_PRODUCTTITLE','عنوان محصول');
define('_NAMEPRODUCT','نام محصول بررسی شده.');
define('_REVIEW','بررسی و نقد');
