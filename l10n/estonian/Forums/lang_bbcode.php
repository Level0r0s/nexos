<?php
/*************************************************
 *                         lang_bbcode.php [estonian]
 *                            -------------------
 *   begin                : Wednesday Oct 3, 2001
 *   copyright            : (C) 2001 The phpBB Group
 *   email                : support@phpbb.com
 *
 *   $Source: /cvs/l10n/estonian/Forums/lang_bbcode.php,v $
 *   $Revision: 9.5 $
 *   $Author: estlane $
 *   $Date: 2010/02/23 05:17:00 $
...
$faq[] = array("--","Tutvustus");
$faq[] = array("Mis on BBkood?", "BBkood on HTMLi lihtsustatud versioon. Administraator saab otsustada, kas BBkood on foorumis lubatud või mitte.Postituse lehel saab ka ise otsustada, kas su postituses BBkood töötab. Kood ise on HTMLile sarnane: tagid ääristatakse kandiliste sulgudega  [ ja ]. BBkoodi saab lisada ka nuppude abil postitusalakohal.");

$faq[] = array("--","Teksti Formaadid");
$faq[] = array("Kuidas luua boldi, kursiivis ja allajoonitud teksti?", "BBkoodi abil saad kiiresti muuta oma teksti välimust. Seda tehakse järgnevalt: <ul><li>Et teha tekst boldiks, kirjuta see <b>[b]</b> ja <b>[/b]</b> vahele, näiteks <br /><br /><b>[b]</b>Tere<b>[/b]</b><br /><br />kuvab <b>Tere</b></li><li>Allajoonimiseks kasuta <b>[u][/u]</b>, näiteks:<br /><br /><b>[u]</b>Hommikust<b>[/u]</b><br /><br />muutub <u>Hommikust</u></li><li>Kursiivi jaoks kasuta <b>[i][/i]</b>, näiteks<br /><br />See on <b>[i]</b>Tore!<b>[/i]</b><br /><br />kuvab See on <i>Tore!</i></li></ul>");
...
$faq[] = array('Mis see PHP värk on!?', 'PHP BBkood on sarnane koodi BBkoodiga, ainult et seda peaks ainult PHP koodi jaoks kasutama. Miks? Sest see annab kindlatele PHP koodi osadele omad värvid, mille abil on kergem lugeda.');
