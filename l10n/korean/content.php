...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/korean/content.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_PAGE','');
define('_PUBLISHEDON','표');
define('_PAGESLIST',' ');
define('_LISTOFCONTENT','結諛�  ');
define('_YOURADMINLIST',' 都求 :  활화  都求:');
define('_COPYRIGHT','Copyright  by');
define('_COPYRIGHT2','All Right Reserved.');
define('_CONTENTCATEGORIES','結諛� 카陋磁� ');
define('_NONCLASSCONT','카陋磁��  ');
