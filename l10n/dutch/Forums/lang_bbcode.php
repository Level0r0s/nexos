 ...
 *
 *   $Source: /cvs/l10n/dutch/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
 *   $Date: 2006/01/29 16:21:39 $
 *
 *********************************************************/
...
$faq[] = array("Link naar een andere site", "phpBB BBCode ondersteund een aantal manieren om  URIs, (Uniform Resource Indicators) te maken beter gekend als URLs.<ul><li>De eerste die je kan gebruiken is de <b>[url=][/url]</b> tag, wat je ook typt na het = teken zal zich voordoen als een URL. Als voorbeeld een link naar phpBB.com, kan je dit gebruiken:<br /><br /><b>[url=http://phpbb.com/]</b>Bezoek phpBB!<b>[/url]</b><br /><br />Dit maakt volgende link: <a href=\"http://phpbb.com/\" target=\"_blank\">Bezoek phpBB!</a> Je zal zien dat deze link een nieuw venster opent zodat de gebruiker in het forum kan blijvenals hij wenst.</li><li>Als je wil dat de URL zichzelf toond als link kan je dit doen door volgende tag:<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />Dit maakt volgende link, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a></li><li>Nu heeft phpBB ook iets genaamd <i>Magic Links</i>, dit maakt van elke juiste URL een link link zonder dat je een tags moet plaatsen of het begin http://. Als je bijvoorbeeld phpbb.com in een bericht typt krijg je automatisch <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> als je uw bericht bekijkt.</li><li>Hetzelfde geld ook voor een email adres, je kan ofwel een email adres specifieren:<br /><br /><b>[email]</b>nie.mand@domein.adr<b>[/email]</b><br /><br />wat hetvolgende weergeeft: <a href=\"emailto:nie.mand@domein.adr\">nie.mand@domein.adr</a> of je kan gewoon nie.mand@domein.adr in je bericht typen en het wordt onmiddelijk naar een emaillink gebracht wnneer je het bericht bekijkt.</li></ul>Zoals met alle BBCode tags kan je allerlei tags gebruike voor een URL zoals <b>[img][/img]</b> (zie volgend onderwerp), <b>[b][/b]</b>, enz. Het is aan jullie te volgend dat je de juiste open of gesloten tag gebruikt, bijvoorbeeld:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />is <u>niet</u> juist wat kan leiden tot het wissen van uw post, dus opgepast.");

$faq[] = array("--", "Afbeeldingen tonen in posts");
$faq[] = array("Een afbeelding toevoegen aan een post", "phpBB BBCode bevat een tag om afbeeldingen te plaatsen in je post. Twee belangrijke zaken te onhouden bij het gebruik van deze tag zijn; vele gebruikers hebben niet graag teveel afbeeldingen in posts en anderzijds moet de afbeelding die je wil tonen moet beschikbaar zijn op het internet (niet enkel op je computer bijvoorbeeld, of je hebt een eigen webserver!). Momenteel is er geen mogelijkheid om afbeeldingen op te slagen met phpBB (al deze zaken zijn mischien beschikbaar in de volgende release van phpBB). Om een afbeelding te tonen moet je de URL tussen <b>[img][/img]</b> tags plaatsen. Bvb:<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />Zoals in de bovenstaande URL beschrijving kan je een afbeelding in <b>[url][/url]</b> tags plaatsen om een link te maken, bvb.<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />maakt:<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
