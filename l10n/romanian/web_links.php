...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/romanian/web_links.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
  $Date: 2006/06/17 01:00:16 $
...
define('_NOMATCHES','Nu au fost găsiţi termenii potriviţi cererii Dvs.');
...
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account").'">Înregistraţi-vă pentru a vă crea un cont</a>');
...
define('_ONLYREGUSERSMODIFY','Numai utilizatorii înregistraţi pot sugera o modificare de linkuri. Vă rugăm <a href="'.getlink("Your_Account").'">înregistraţi-vă sau login</a>.');
...
define('_RATENOTE4','Puteţi vedea o listă a <a href="'.getlink('Web_Links&l_op=TopRated').'">Celor mai apreciate resurse</a>.');
...
define("_ADDEDITORIAL","Adăugaţi editorial");
define("_EDITORIALTITLE","Titlul editorialului");
define("_EDITORIALTEXT","Textul editorialului");
define("_DATEWRITTEN","Data la care a fost scris");
define("_NOREPORTEDBROKEN","Nu s-au reportat linkuri defecte.");
define("_USERREPBROKEN","Linkuri defecte raportate de utilizatori");
define("_IGNOREINFO","Ignoraţi (Ştergeţi toate <b><i>cererile</i></b> pentru un link dat)");
define("_DELETEINFO","Ştergeţi (Ştergeţi <b><i>linkul defect</i></b> şi <b><i>cererile</i></b> respective)");
define("_LINK","Link");
define("_LINKOWNER","Proprietarul linkului");
define("_USERMODREQUEST","Cereri de modificare linkuri de la utilizatori");
define("_ORIGINAL","Original");
define("_PROPOSED","Propus");
define("_NOMODREQUESTS","Nu sunt cereri pentru modificare momentan");
