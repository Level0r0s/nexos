<?php
/*************************************************
 *                         lang_bbcode.php [NORWEIGIAN]
 *                            -------------------
 *   begin                : Wednesday Oct 3, 2001
 *   copyright            : (C) 2001 The phpBB Group
 *   email                : support@phpbb.com
 *
 *   $Source: /cvs/l10n/norwegian/Forums/lang_bbcode.php,v $
 *   $Revision: 9.3 $
 *   $Author: djmaze $
...
$faq[] = array("Eksterne linker", "Du kan velge mellom flere metoder for å lage URL-er eller linker med BBCode.<ul><li><b>Med [url=][/url]</b> taggene vil teksten mellom taggene linke til det du skriver etter the = f.eks. :<br /><br /><b>[url=http://phpbb.com/]</b>Besøk phpBB!<b>[/url]</b><br /><br />gir følgende link, <a href=\"http://phpbb.com/\" target=\"_blank\">Besøk phpBB!</a> Legg merke til at linken åpnes i et nytt vindu slik at forumet beholdes i det originale nettleservinduet.<br /><br /></li><li>Hvis du ønsker at selve URL-en skal være synlig bruker du :<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />som gir følgende link, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a><br /><br /></li><li>PhpBB har en funksjon som kalles <i>Magic Links</i>, som automatisk konverterer alle korrekt formaterte URL-er til linker, du trenger ikke engang skrive http:// først. Hvis du f.eks. skriver phpbb.com i innlegget ditt vil teksten automatisk bli konvertert til <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a>.<br /><br /></li><li><i>Magic Links</i> fungerer også med e-postadresser, du kan enten skrive :<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />som formateres slik : <a href=\"mailto:no.one@domain.adr\">no.one@domain.adr</a> eller du kan skrive, som også formateres slik :  <a href=\"mailto:no.one@domain.adr\">no.one@domain.adr</a>.<br /><br /></li></ul>Som med alle andre BBCode tagger kan du bruke URL taggene sammen med andre formateringstagger, f.eks. <b>[img][/img]</b> (se neste seksjon), <b>[b][/b]</b>, osv. På lik linje med formateringstaggene må du selv sørge for at alle taggene åpnes og lukkes korrekt.<br /><br />Dette eksemplet :  <b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />er <u>ikke</u> korrekt formatert, og i et slikt tilfellet kan du risikere at innlegget ditt blir slettet.<br /><br />");

$faq[] = array("--", "Vise bilder i posteringer");
$faq[] = array("Legge til bilde(r) i et innlegg", "phpBB BBCode har en tagg som gjør det mulig å vise bilder i innleggene dine. Når du vurderer å bruke bilder i innleggene er det viktig er klar over følgende, mange brukere foretrekker temaer som ikke er overlesset med bilder. I tillegg må også bildet/bildene du skal bruke allerede finnes på www (det holder f.eks. ikke at du har bildet på pc-en din). Det er ikke mulig å lagre eller laste opp bilder til phpBB, men dette vil bli mulig i neste versjon, phpBB 2.2.<br /><br /> For å vise bilder i et innlegg må du bruke BBCode taggene <b>[img][/img]</b> rundt bildenes URLer som i eksemplet under<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />Du kan også bruke bilder som linker vha. <b>[url][/url]</b>, f.eks.<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />gir :<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br /><br />");
...
$faq[] = array('Hva er alt dette PHP tullet?', 'PHP BBCode er lik Kode BBCode, bortsett fra at den skal kun brukes for PHP kode.  Hvorfor?  Fordi den uthever diverse seksjoner av PHP koden, som gjør den enklere å lese.');
