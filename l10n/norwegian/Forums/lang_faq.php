 ...
 *
 *   $Id: lang_faq.php,v 9.3 2006/02/12 16:02:13 djmaze Exp $
 *
...
$faq[] = array("Hvordan skriver jeg et innlegg i forumet?", "Klikk på den relevante knappen enten i forum- eller emnesiden. Det er mulig at du må registrere deg før du kan skrive et innlegg. Dine rettigheter er listet opp nederst på siden i forum- og emnesidene. (F.eks. <i>Du kan starte nye emner i dette forumet, Du kan svare på emner i dette forumet, osv.</i>)");
...
$faq[] = array("Kan jeg bruke bilder?", "Du kan bruke bilder i dine innlegg. Derimot er det ingen funksjon for øyeblikket som tillater deg å laste opp bilder direkte til forumet. Du må derfor linke til et bilde som ligger på en offentlig Internett server, f.eks. http://et-ukjent-sted.net/mitt-bilde.gif. Du kan ikke linke til et bilde på din egen PC (hvis du ikke har en offentlig tilgjenglig server) eller bilder lagret bak passord mekanismer, som f.eks. hotmail eller yahoo e-post kontoer, passordbeskyttet sider, osv. For å vise et bilde kan du bruke enten BBCode [img] tagg eller HTML (hvis tillatt).");
$faq[] = array("Hva er annonseringer?", "Annonseringer er ofte viktig informasjon og bør leses snarest mulig. Annonseringer vises øverst på alle sidene i det forumet de er skrevet. Din mulighet til å skrive en annonsering er avhengig av hvilke rettigheter som er påkrevd. Disse er satt av administratoren.");
$faq[] = array("Hva er prioriterte emner?", "Prioriterte emner vises under annonseringene i forumet og kun på den første siden. De er som regel ganske viktige, så de bør leses snarest mulig. Administratoren bestemmer hvilke rettigheter du må ha for å skrive et prioritert emne i hvert forum.");
$faq[] = array("Hva er stengte emner?", "Stengte emner har blitt låst av moderatoren eller administratoren. Du kan ikke svare på et stengt emne, og eventuelle avstemninger er automatisk avsluttet. Temaer kan bli avsluttet av mange grunner.");
...
$faq[] = array("Hva er en moderator?", "En moderator er en enkelt bruker (eller en gruppe brukere) som skal overvåke forumet fra dag til dag. Denne/disse brukerne har rettighetene til å endre eller slette innlegg, og låse/låse opp, flytte, slette og dele emner i det forumet de modererer. Vanligvis er moderatorer der for å hindre brukere i og gå <i>utenfor emne</i> eller skrive upassende eller støtende innlegg.");
...
$faq[] = array("Hvem skrev dette forumet?", "Denne programvaren (i sin umodifiserte form) er produsert, lansert og har copyright av <a href=\"http://phpbb.com/\" target=\"_blank\">phpBB Group</a>. Den er gjort tilgjenglig under GNU General Public Licence og kan bli fritt distribuert, følg linken for mer informasjon.");
