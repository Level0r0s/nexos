...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/norwegian/downloads.php,v $
  $Revision: 9.10 $
  $Author: nanocaiordo $
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Registrer deg som medlem</a>');
...
define('_WEIGHNOTE','* Obs: Denne siten veier medlemmers poengsum opp mot ikke-medlemmers');
define('_NOUNREGUSERSVOTES','Ingen ikke-medlemmer har stemt');
define('_WEIGHOUTNOTE','* Obs: Denne siten veier medlemmers poengsum opp mot poengsummer fra andre siter');
...
**************************/
define('_ADDDURL','Legg til denne URL\'en');
