...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/catalan/main.php,v $
  $Revision: 1.14 $
  $Author: estlane $
...
define('_MODULESGROUPS','accés de grup necessari');
define('_HOME','Home');
...
define('_UM_F','Error al contactar amb el servei d\'actualització.');
...
define('_PREVIEW','Visualització prèvia');
define('_SEND','Send');
...
define('_SECURITYCODE','Codi de Seguretat');
define('_TYPESECCODE','Insertar el codi de Seguretat');
...
define('_NEWSLETTERBLOCKREGISTERNOW','Registrar-te ara!');
...
define('_PAGEBREAK','Si vols dividir en diverses pàgines, pots escriure <b>&lt;!--pagebreak--&gt;</b> on vulguis tallar.');
...
define('_SUPERWARNING','Si selecciones Super Usuari, tindràs accés total');
