...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/slovak/web_links.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account").'">Zaregistrujte sa</a>');
...
define('_ONLYREGUSERSMODIFY','Len registrovaní uívatežia môu da podnet na úpravu odkazu. Prosím <a href="'.getlink("Your_Account").'">registeruj sa alebo sa prihlás</a>.');
...
define('_RATENOTE4','Môete si pozrie <a href="'.getlink('Web_Links&l_op=TopRated').'">najlepie hodnotené zdroje</a>.');
...
define("_USERREPBROKEN","Uívatež ohlásil chybný link");
define("_IGNOREINFO","Ignorova (vymae vetky <b><i>oznamy o nefunkčnosti</i></b> na daný link)");
define("_DELETEINFO","Vymaza (vymae nefunkčný link spolu so vetkými oznamami)");
define("_LINK","Odkaz");
define("_LINKOWNER","Vlastník odkazu");
define("_USERMODREQUEST","Uívatež poaduje úpravu linku");
