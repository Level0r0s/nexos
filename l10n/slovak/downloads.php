...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/slovak/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
//define('_FILESIZE','Vežkos súboru');
...
define('_ADDADOWNLOAD','Prida nový download');
define('_DSUBMITONCE','Vystavi unikátny download len raz.');
define('_DPOSTPENDING','Vetky odoslané downloady budú preverené.');
define('_RESSORTED','zoradené podža');
define('_DOWNLOADSNOTUSER1','Nie ste registrovaný uívatež alebo nie ste prihlásený.');
define('_DOWNLOADSNOTUSER2','Ak sa zaregistrujete, môete pridáva downloady na tejto stránke.');
define('_DOWNLOADSNOTUSER3','Sta sa registrovaným uívatežom je krátky a žahký proces.');
define('_DOWNLOADSNOTUSER4','Prečo vyadujeme registráciu pre prístup k istým funkciám?');
define('_DOWNLOADSNOTUSER5','Pretoe  chceme poskytnú len najkvalitnejie sluby,');
define('_DOWNLOADSNOTUSER6','kadá poloka je individuálne skontrolovaná naim tímom.');
define('_DOWNLOADSNOTUSER7','Dúfame, e Vám poskytneme len hodnotné informácie.');
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Zaregisterujte sa</a>');
...
define('_DOWNLOADRECEIVED','Vďaka za poloku pre download.');
...
define('_DBESTRATED','najlepie hodnotené súbory - Top');
define('_TRATEDDOWNLOADS','spolu hodnotených súborov');
define('_SORTDOWNLOADSBY','Trieďi podža');
...
define('_DCATTHISWEEK','Nové downloady v tejto kategórii pridané za posledný týdeň');
...
define('_DONLYREGUSERSMODIFY','Poadova zmenu informácií pre download môu len registrovaní uívatelia. <a href="'.getlink("Your_Account").'">Prihláste sa</a>.');
define('_REQUESTDOWNLOADMOD','Vyiada zmenu downloadu');
define('_DOWNLOADID','Download ID');
define('_DLETSDECIDE','Pomôte ostatným uívatežom rozhodnú sa na ktorý download je najlepie kliknú');
define('_DRATENOTE4','Môete si pozrie <a href="'.getlink("Downloads&amp;d_op=TopRated").'">najlepie hodnotené zdroje');
...
define('_SECURITYBROKEN','Z dôvodu bezpečnosti bude Vae meno a IP adresa dočasne zaznamenaná.');
...
define('_DELEZDOWNLOADSCATWARNING','UPOZORNENIE: Určite chcete vymaza túto kategóriu? Vymaete tým aj vetky podkategórie a vetky v nich nachádzajúce sa downloady! ');
define('_DELCONTENTCAT','UPOZORNENIE: Určite chcete vymaza túto kategóriu? Stránky zatriedené v tejto kategótii síce nebudú vymazané, ale dočasne nebudú priradené k iadnej kategórii!');
...
define('_DNOREPORTEDBROKEN','iadny nefunkčný link nebol ohlásený');
define('_DUSERREPBROKEN','Uívatež ohlásil nefunkčný download link');
define('_DIGNOREINFO','Ignorova (vymae vetky <b><i>oznamy o nefunkčnosti</i></b> na daný download)');
define('_DDELETEINFO','Vymaza (vymae nefunkčný link spolu so vetkými oznamami)');
define('_DOWNLOADOWNER','Vlastník downloadu');
define('_DUSERMODREQUEST','Úívatež iada zmenu linku');
