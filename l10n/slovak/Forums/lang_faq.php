...
$faq[] = array("Kto napísal tento program?", "Tento software (v jeho nemodifikovanej forme) je vytvorený, zverejnený a chránený autorskými právami <a href=\"http://phpbb.com/\" target=\"_blank\">phpBB Group</a>. Je dostupný pod the GNU General Public Licence a môže byť voľne distribuovaný, kliknite pre viacíce detailov");
