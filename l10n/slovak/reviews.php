...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/slovak/reviews.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_RCREATEACCOUNT','<a href="'.getlink("Your_Account").'">Vytvor</a> konto');
...
define('_MODREVINFO','Ako administrátor môete jednoducho maza/upravova recenzie priamo cez stránku <a href="'.getlink("Reviews").'">reviews</a>.');
