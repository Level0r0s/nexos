...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/russian/downloads.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
...
define('_DLP_SUBMITTEDBY','Размещен');
define('_DLP_PUBLISHED','Дата размещения');
define('_DLP_NEW','Новый');
define('_DLP_RANDOM','Случайная загрузка');
define('_DLP_SORT','Сортировать по');
define('_DLP_UPDATED','Обновлен');
define('_dlp_back2top','В начало страницы');
define('_DLP_PAGEVIEWS','Просмотров');
define('_DLP_EDPICK','Пиектограмма Ed Pick');
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Зарегистрироваться</a>');
...
define('_DONLYREGUSERSMODIFY','Только зарегистрированные пользователи могут вносить здесь свои изменения. Пожалуйста, <a href="'.getlink("Your_Account").'">зарегистрируйтесь или войдите под своим именем</a>.');
...
define('_DRATENOTE4','Вы можете посмотреть список <a href="'.getlink("Downloads&amp;d_op=TopRated").'">Оценки лучших файлов</a>.');
...
define('_DLP_SUB','Подкатегорий');
define('_DLP_XML','RSS лента');
define('_DLP_PAGE','Страницы');
define('_NEXT','Следующая');
define('_DLP_DLNOW','Начать загрузку');
define('_DLP_HISTORY','История загрузки');
define('_DLP_WRITEREVIEW','Написать отзыв');
define('_DLP_MIRSUB','Детали о загрузке');
define('_DLP_DOWNLOAD','Загрузка');
define('_DLP_REPSUBMITTER','Пожаловался');
define('_DLP_BRMIR','Сообщения о испорченной ссылке');
define('_DLP_EDITDL','Редактировать загрузку');
define('_DLP_CONFIG','Конфигурация');
define('_DLP_CFIELDS','Поля');
define('_DLP_REPORTBROKEN','Эта ссылка не работает?');
define('_DLP_BRKNGIVEINFO','Напишите, если у вас возникли проблемы с загрузкой этого файла:');
define('_DLP_BRKNINFODATE','Дату');
define('_DLP_BRKNRESPCODE','Код ошибки - что пишет, когда пытаетесь начать загрузку');
define('_DLP_BRKNFIRSTTIME','Время');
define('_DLP_BRKNTHANKS','Ваш отзыв о загрузке принят, спасибо.');
define('_DLP_REPREM','Удалить это зеркало');
define('_DLP_REPNOTIFY','Отправить e-mail');
define('_DLP_REPDISMISS','Все работает, не пизди');
define('_DLP_MIRROR','Зеркало');
define('_DLP_MEMREVIEWS','Комментарии');
