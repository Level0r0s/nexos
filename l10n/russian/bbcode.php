...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/russian/bbcode.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
$smilies_desc = array(
    ...
    'Laughing' => 'Смеющийся',
    'Mad' => 'Безумный',
    'Razz' => 'Непристойный звук',
    'Embarassed' => 'Смущённый',
    'Crying or Very sad' => 'Плачущий или очень расстроенный',
    'Evil or Very Mad' => 'Дьявольский или очень безумный',
    'Twisted Evil' => 'Крутящийся дьявол',
    'Rolling Eyes' => 'Вращяющиеся глаза',
    'Wink' => 'Подмигнуть',
    'Idea' => 'Идея',
    'Arrow' => 'Стрелка',
    'Neutral' => 'Нейтральный',
    'Mr. Green' => 'Мистер Green',
);
