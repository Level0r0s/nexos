...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/russian/your_account.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
  $Date: 2008/02/16 05:53:32 $
Encoding test: n-array summation ∑ latin ae w/ acute ǽ
*******************************************************/
if (!defined('CPG_NUKE')) { exit; }
global $MAIN_CFG;
define('_MA_HIDDEN','Спрятано');
define('_MA_VISIBLE','Показано');
define('_MA_REQUIRED','Required');
define('_MA_PROFILE_INFO','Информация о профиле');
define('_MA_ADDITIONAL','Дополнительная информация');
define('_MA_REALNAME','Настоящее имя');
define('_MA_FAKEMAIL','Фальшивый почтовый ящик');
define('_MA_HOMEPAGE','Сайт');
define('_MA_ICQ','Номер ICQ');
define('_MA_AIM','Адрес AIM');
define('_MA_YIM','Yahoo! Messenger ID');
define('_MA_MSNM','Live! ID (MSN Passport)');
define('_MA_LOCATION','Географическое положение');
define('_MA_OCCUPATION','Род деятельности');
define('_MA_INTERESTS','Интересы');
define('_MA_SIGNATURE','Подпись');
define('_MA_EXTRAINFO','Дополнительная информация');
define('_MA_PREFERENCES','Preferences');
define('_MA_TIMEZONE','Временная зоны');
define('_MA_DATEFORMAT','Формат дат');
define('_MA_RECEIVENEWSLETTER','Подписаться на рассылку');
define('_MA_SHOWEMAIL','Показывать мой Email');
define('_MA_SHOWONLINE','Показывать мой статус online');
define('_MA_ALLOWBBCODE','Всегда разрешать BBCode');
define('_MA_ALLOWHTML','Всегда разрешать HTML');
define('_MA_ALLOWSMILIES','Всегда разрешать Smilies');
define('_MA_NOTIFYREPLY','Извещать о ответах');
define('_MA_NOTIFYPM','Извещать о новом личном сообщении по Email');
define('_MA_POPUPPM','Всплывающее окно при новом личном сообщении');
define('_MA_ATTACHSIG','Всегда прикреплять мою подпись');
define('_MA_PRIVATE','Частная информация');
define('_MA_FIRSTNAME','Имя');
define('_MA_LASTNAME','Фамилия');
define('_MA_GENDER','Gender');
define('_MALE','Male');
define('_FEMALE','Female');
define('_MA_BIRTHDAY','Дата рождения');
define('_MA_BIRTHDAYMSG','Fill in as month/day/year');
define('_MA_TELEPHONE','Телефон');
define('_MA_FAX','Fax');
...
define('_MA_ITEMS_REQUIRED','Поля, отмеченные звездочкой (*) нужно обязательно заполнить.');
define('_MA_PROFILE_INFO_NOTICE','This information will be publicly viewable');
define('_USERNAME','Псевдоним');
define('_EMAILADDRESS','Адрес электронной почты');
define('_BLANKFORAUTO','Не заполняйте, если хотите, чтобы пароль был создан автоматически и выслам вам на почту.');
define('_CONFIRMPASSWORD','Введите пароль второй раз');
...
define('_USERFINALSTEP','Регистрация нового пользователя - подтвердите данные');
define('_USERCHECKDATA','пожалуйта, проверьте вами данные. Если все верно, закночите регистрацию, нажав кнопку "Закончить", если вы нашли ошибку - кнопку "Вернуться назад".');
...
define('_YOUWILLRECEIVE2','Вам будет выслано письмо с данными регистрации на электронную почту.');
...
define('_ACCOUNTCREATED','Ваша учетная запись пользователя успешно создана!');
define('_YOUAREREGISTERED','Добро пожаловать, теперь вы - зарегистрированный участник.');
...
define('_FINISHUSERCONF2','Теперь вы можете выполнить вход, введя ваши имя пользователя и пароль в');
define('_FINISHUSERCONF3','<b>диалоге входа</b>');
...
define('_REGISTRATIONSUB','Регистрация нового пользователя');
define('_THANKSUSER','Команда сайта ');
...
define('_LAST10SUBMISSION','Последние 10 новостей пользователя');
...
define('_WEBSITE','Сайт');
define('_USERSTATUS','Actual User Status');
define('_ONLINE','Online');
define('_OFFLINE','Offline');
define('_NOTSUBSCRIBED','Подписка на новости сайта отсутствует.');
...
define('_MA_MYHEADLINES','Мои заголовки');
define('_SELECTASITE','Выберите Web узел, с которого хотите читать заголовки:');
define('_SELECTASITE2','Выберите Web узел');
define('_ORTYPEURL','Или введите адрес вашего узла RSS/XML:');
define('_MA_GO','Продолжить');
