...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/russian/web_links.php,v $
  $Revision: 9.4 $
  $Author: nanocaiordo $
...
define('_USERANDIP','Имя пользователя и IP Сохраняются, по этому не засоряйте систему.');
...
define('_LINKSNOTUSER5','Потому что мы можем предоставить вам только высокачественное содержимое,');
define('_LINKSNOTUSER6','каждая запись просматривается и одобряется нами.');
define('_LINKSNOTUSER7','Мы надеемся, что вы введете только верную информацию.');
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account&amp;file=register").'">Зарегистрироваться</a>');
