...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/russian/news.php,v $
  $Revision: 9.7 $
  $Author: estlane $
...
define('_READMORE','Отобразить целиком');
...
define('_NOANONCOMMENTS','Вы не можете отправить комментарий Анонимно, пожалуйста <a href="'.getlink("Your_Account").'">ЗАРЕГИСТРИРУЙТЕСЬ</a>');
