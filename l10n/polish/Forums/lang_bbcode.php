 ...
 *
 *   $Source: /cvs/l10n/polish/Forums/lang_bbcode.php,v $
 *   $Revision: 9.3 $
 *   $Author: djmaze $
...
$faq[] = array("Odnośniki do innych stron", "BBCode phpBB umożliwia na różne sposoby tworzenie URI, Uniform Resource Indicators znanych jako URL'e.<ul><li>Pierwsza wykorzystuje znacznik <b>[url=][/url]</b>, cokolwiek wpiszesz po znaku = zostanie zmienione na cel odnośnika. Na przykład aby wstawić link do phpBB.com możesz użyć:<br /><br /><b>[url=http://phpbb.com/]</b>Odwiedź phpBB!<b>[/url]</b><br /><br />Co zmieni się w odnośnik <a href=\"http://phpbb.com/\" target=\"_blank\">Odwiedź phpBB!</a>. Zauważ, że odnośnik otwiera się w nowym oknie, tak więc użytkownik może kontynuować forum jeśli chce.</li><li>Jeżeli chcesz aby sam URL był wyświetlany jako link możesz to zrobić używając zwyczajnie:<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />Co utworzy link <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a></li><li>Dodatkowo phpBB umożlwia wykorzystanie tzw. <i>Magicznych Linków</i>, które zmieniają prawidłowo wpisany URL w odnośnik bez potrzeby dodawania jakichkolwiek znacznikó lub nawet dopisywania na początku http://. Na przykład wpisanie phpbb.com w wiadomości zmieni się automatycznie w <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> przy wyświetlaniu wiadomości.</li><li>Podobnie jest z adresami email, możesz albo podać adres wyraźnie, np:<br /><br /><b>[email]</b>nikt@domena.adr<b>[/email]</b><br /><br />co zamieni się na <a href=\"emailto:nikt@domena.adr\">nbikt@domena.adr</a> albo wpisać jedynie nikt@domena.adr w wiadomości i zostanie to automatycznie zamienione podczas wyświetlania wiadomości.</li></ul>Podobnie jak ze wszystkimi znacznikami BBCode możesz otaczać adresy URL jakimikolwiek innymi znacznikami, jak <b>[img][/img]</b> (zobacz kolejny punkt), <b>[b][/b]</b>, itp. Jeśli chodzi o znaczniki formatujące, do ciebie należy dbałość o poprawną kolejność otwietania i zamykania, na przykład:<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />jest <u>nieprawidłowe</u> przez co twój post może zostać usunięty.");

$faq[] = array("--", "Wstawianie obrazków do postów");
$faq[] = array("Dodawanie obrazka do postu", "BBCode phpBB zawiera znacznik umożliwiający wstawianie obrazków do postów. Należy jednak pamiętać o dwóch istotnych rzeczach: wielu użytkowników nie lubi dużych ilości obrazków w postach oraz wstawiany obrazek musi być już dostępny w internecie (nie może na przykład istnieć tylko na twoim komputerze, chyba że masz u siebie serwer!). Nie ma obecnie możliwości przechowywania obrazków lokalnie wraz z phpBB (problemy te zostaną prawdopodobnie rozwiązane w następnej wersji phpBB). Aby wstawić obrazek musisz otoczyć jego adres URL znacznikami <b>[img][/img]</b>. Na przykład:<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />Jak zaznaczono w sekcji URL powyżej możesz otoczyć obrazek znacznikami <b>[url][/url]</b> jeśli chcesz, np.<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />zmieni się w:<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
