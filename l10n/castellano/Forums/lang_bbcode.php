 ...
 *
 *   $Source: /cvs/l10n/castellano/Forums/lang_bbcode.php,v $
 *   $Revision: 1.2 $
 *   $Author: djmaze $
...
$faq[] = array("¿Cómo crear texto en negrita, cursiva o subrayado?", "BBCode incluye etiquetas para esto: [b][/b] para negrita, [u][/u] para subrayar y [i][/i] para cursivas, estas se pueden combinar entre si, es genial! :)");
...
$faq[] = array("Citar texto en las respuestas", "Hay dos formas de hacerlo: con una referencia o sin ella, para hacerlo con referencia utiliza la opción CITAR del foro al dar una respuesta, el mensaje a citar es anexado al suyo automáticamente como: [quote=\"\"][/quote] El otro método (sin referencia) es poner una etiqueta parecida, pero agregando el autor del texto citado, es decir: [quote=\"Anita\"]</b>Lo que diga Anita debe ir aquí, recuerde incluir \"\" alrededor del nombre a citar, si no quiere incluir el nombre, solo encierre el texto entre las etiquetas [quote][/quote]");
...
$faq[] = array("Creando una lista desordenada", "BBCode soporta dos tipos de listas, desordenadas y ordenadas, es exactamente como en HTML, solo que con las siguientes etiquetas: Para una desordenada [list][/list], definiendo cada parte de la lista con [*]. Por ejemplo, para listar tus animales favoritos usa [list][*]Vaca[*]Cuyo[*]Conejo[/list], esto generará algo como esto:<ul><li>Vaca</li><li>Cuyo</li><li>conejo</li></ul>");
$faq[] = array("Creando una lista ordenada", "El segundo tipo de lista es la ordenada, para crearla use [list=1][/list] para crear una lista con numeración o [list=a][/list] para una con orden alfabético, cada parte de la lista se especifica también con [*] Por ejemplo: [list=1][*]Vaca[*]Cuyo[*]Conejo[/list] generará algo como: <ol><li>Vaca</li><li>Cuyo</li><li>conejo</li></ol>");

$faq[] = array("--", "Creando Enlaces");
$faq[] = array("Creando un enlace a otro sitio", "phpBB BBCode soporta varias formas de hacer un enlace, la primera es con [url=][/url], por ejemplo, para hacer un enlace a phpBB.com puede usar:[url=http://phpbb.com/]Visite phpBB![/url], los enlaces se abrirán en una nueva ventana nueva, otra forma es [url]http://phpbb.com/[/url]. Este foro tiene también ENLACES MÁGICOS, por ejemplo, si teclea phpbb.com en su mensaje aparecerá automáticamente como enlace. Para hacer un enlace a un correo electrónico deberá poner: [email]alguien@sudireccion.com[/email] o simplemente teclear la dirección y se convertirá en un enlace. Puede combinarlo con la etiqueta [img][/img] para que el enlace sea una imagen, así: [url=http://phpbb.com/][img]http://phpbb.com/images/phplogo.gif[/url][/img].");

$faq[] = array("--", "Publicando imágenes en los mensajes");
$faq[] = array("Agregando una imagen al mensaje", "Para poner una imagen simplemente escriba [img]URL[/img] donde URL es la dirección en donde está su imagen, por ejemplo [img]http://phpbb.com/images/phplogo.gif[/img], también puede generar enlaces de la siguiente forma: [url=][/url] así [url=http://phpbb.com/][img]http://phpbb.com/images/phplogo.gif[/img][/url]");
...
$faq[] = array('¿¡Qué es todo este PHP sin sentido!?', 'El código PHP BBCode es parecido al código BBCode, excepto en que este sólo debe usarse para el código PHP.  ¿Por qué? Porque colorea ciertas partes del código PHP haciéndolo más fácil de leer.');
