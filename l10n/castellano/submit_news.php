...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/castellano/submit_news.php,v $
  $Revision: 1.4 $
  $Author: nanocaiordo $
...
define('_BADTITLES','malos títulos = \'¡Mirad ésto!\' o \'¡Un Artículo\'');
define('_HTMLISFINE','¡Puedes usar HTML, pero comprueba las URLs y los comandos HTML!');
define('_AREYOUSURE','¿Estás seguro que incluíste una URL? ¿Comprobaste la ortografía?');
...
define('_ARCHIVESINDEX','Índice del Archivo de Noticias');
