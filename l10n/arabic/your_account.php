...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/arabic/your_account.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
...
define('_BROADCASTTEXT','تستطيع إرسال <i>رسالة عامة</i> من هنا (255 حرفا كحد اقصى). سوف يشاهد هذه الرسالة جميع المتصفحين خلال العشر دقائق القادمة. أي متصفح سوف تظهر له هذه الرسالة مرة واحدة تحت شعار الموقع. يستطيع أي عضو ان يوقف خاصية مشاهدة هذه الرسائل بالضغط  <a href="'.getlink('Your_Account&amp;edit=prefs').'">هنا</a>. الرجاء عدم م اساءة استخدامه وكود الهتمل غير متاح.');
