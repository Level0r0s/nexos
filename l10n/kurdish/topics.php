...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/kurdish/topics.php,v $
  $Revision: 9.5 $
  $Author: nanocaiordo $
...
define('_ACTIVETOPICS','Mijarên niha aktîv bûne');
define('_CLICK2LIST','Nûçe giştî ser vê mijarê bibîne');
define('_TOTNEWS','Hemî deng û bas');
define('_TOTREADS','Hemî yêt xandî');
define('_MORE','Hêşta');
define('_NONEWSYET','...Hêşta çi deng û bas nînin bû vêrê...');
