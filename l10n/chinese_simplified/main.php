...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/chinese_simplified/main.php,v $
  $Revision: 9.30 $
  $Author: estlane $
...
define('_SENDEREMAIL','寄件者 Email');
define('_SENDERNAME','寄件者 名稱');
...
define('_SECURITYCODE','安全确认码');
define('_TYPESECCODE','在此输入安全确认码');
define('_MEMBERSOPTIONS','会员选项');
...
define('_BHID','Hidden');
define('_WHOWHERE','在线人显示');
define('_STAFFONL','管理人显示');
define('_STAFFNONE','非管理者显示');
