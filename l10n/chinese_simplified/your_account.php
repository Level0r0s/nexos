...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/chinese_simplified/your_account.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_BROADCASTTEXT','你可以從這裏廣播一則<i>公開訊息</i> (最多一百個字). 這則訊息在往後的十分鐘會顯示給線上的使用者. 每一個在線上的使用者會在本站的LOGO下看見你的訊息. 當然也可以從 <a href="'.getlink('Your_Account&amp;edit=prefs').'">這裏</a>關閉這項功能. 請勿濫用!!還有 HTML碼在這裏不能用.');
