...
/*********************************************
  ...
  ********************************************
  $Source: /cvs/l10n/chinese_simplified/coppermine.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
  $Date: 2008/03/20 11:39:46 $
...
define('CATEGORIES_LNK', '目錄');
define('USERS_LNK', '會員');
define('GROUPS_LNK', '群組');
define('COMMENTS_LNK', 'Review Comments');
define('SEARCHNEW_LNK', '批次上傳');
define('UTIL_LNK', '調整圖片大小');
...
define('SLIDESHOW_TITLE', '幻燈片');
define('SLIDESHOW_DISABLED', '關閉幻燈片');
...
define('NEXT_TITLE', '看下一張圖');
define('PIC_POS', 'PICTURE %s/%s');
define('NO_MORE_IMAGES', '此相簿已無圖片');
...
define('MY_GALLERY', '* 我的相簿 *');
define('NO_CATEGORY', '* 沒有設定目錄 *');
define('DELETE', '刪除');
define('NEW', '最新');
