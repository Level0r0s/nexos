...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/vietnamese/your_account.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
...
define('_MA_LOCATION','Nơi ở');
define('_MA_OCCUPATION','Nghề nghiệp');
define('_MA_INTERESTS','Sở thích');
define('_MA_SIGNATURE','Chữ ký');
...
define('_MA_RECEIVENEWSLETTER','Nhận tin tức');
define('_MA_SHOWEMAIL','Hiển thị Email của tôi');
define('_MA_SHOWONLINE','Hiển thị trạng thái online');
define('_MA_ALLOWBBCODE','Luôn cho phép dùng BBCode');
define('_MA_ALLOWHTML','Luôn cho phép dùng HTML');
define('_MA_ALLOWSMILIES','Luôn hiển thị biểu tượng vui');
define('_MA_NOTIFYREPLY','Thông báo khi có trả lời');
define('_MA_NOTIFYPM','Thông báo có tin nhắn mới qua Email');
define('_MA_POPUPPM','Mở cửa sổ mới khi có tin nhắn mới');
define('_MA_ATTACHSIG','Luôn hiển thị chữ ký');
define('_MA_PRIVATE','Private Information');
define('_MA_FIRSTNAME','Tên');
define('_MA_LASTNAME','Họ');
define('_MA_GENDER','Giới tính');
define('_MALE','Nam');
define('_FEMALE','Nữ');
define('_MA_BIRTHDAY','Ngày sinh');
define('_MA_BIRTHDAYMSG','Điền theo định dạng tháng/ngày/năm');
define('_MA_TELEPHONE','Số điện thoại');
define('_MA_FAX','Số fax');
...
define('_BOUNDREGISTRATION','Khi nhấn nút Register bên dưới, bạn đã đồng ý tuân theo những quy định này.');
define('_MA_REGISTRATION','Điều lệ');
define('_MA_AGREE_OVER_13','Tôi Đồng ý với những điều lệ trên và tôi <b>trên</b> hoặc <b>đúng</b> 13 tuổi');
define('_MA_AGREE_UNDER_13','Tôi Đồng ý với những điều lệ trên và tôi <b>dưới</b> 13 tuổi');
define('_MA_DO_NOT_AGREE','Tôi không đồng ý với những điều lệ trên');
define('_MA_REGISTRATION_INFO','Thông tin đăng ký');
