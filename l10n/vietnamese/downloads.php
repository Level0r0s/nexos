...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/vietnamese/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_AUTHORNAME','Tê tác giả');
define('_AUTHOREMAIL','Thư điện tử');
define('_DOWNLOADNAME','tên chương trình');
define('_ADDTHISFILE','Thêm tập tin');
define('_INBYTES','Dung lượng');
//define('_FILESIZE','Kích th&#432;&#7899;c');
//define('_VERSION','Phiên b&#7843;n');
//define('_AUTHOR','Tác gi&#7843;');
define('_HOMEPAGE','trag chủ');
define('_DOWNLOADNOW','Tải tập tin này!');
define('_RATERESOURCE','Đánh giá nguồn');
define('_FILEURL','Tập tin liên kết');
define('_ADDDOWNLOAD','Tải thêm');
