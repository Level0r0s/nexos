...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/serbian/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Registrujte se</a>');
...
define('_DONLYREGUSERSMODIFY','Samo registrovani korisnici mogu predlagati modifikacije downloada. Ako to želite <a href="'.getlink("Your_Account").'">registrujte se ili se ulogujte</a>.');
...
define('_DRATENOTE4','Možete pogledati listu <a href="'.getlink("Downloads&amp;d_op=TopRated").'">Resursa sa najvišim ocenama</a>.');
