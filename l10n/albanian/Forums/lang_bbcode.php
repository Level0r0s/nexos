<?php
/*************************************************
 *                         lang_bbcode.php [albanian]
 *                            -------------------
 *   begin                : Wednesday Oct 3, 2001
 *   copyright            : (C) 2001 The phpBB Group
 *   email                : support@phpbb.com
 *
 *   $Source: /cvs/l10n/albanian/Forums/lang_bbcode.php,v $
 *   $Revision: 9.2 $
 *   $Author: djmaze $
 *   $Date: 2006/02/12 16:01:41 $
 *
 *********************************************************/
...
$faq[] = array("Lidhje me një websit tjetër", "BBCode i phpBB lejon disa mënyra për krijimin e URI-ve, Uniform Resource Indicators që njihen si URL.<ul><li>Mënyra e parë përdor kodin <b>[url=][/url]</b>, cdo gjë që shkruani mbas shenjës së barazimit do shkaktojë përmbajtjen e atij kodi të shërbejë si një URL. Psh. për tu lidhur me phpBB.com me këtë metodë shkruani:<br /><br /><b>[url=http://phpbb.com/]</b>Vizito phpBB!<b>[/url]</b><br /><br />kjo do prodhonte lidhjen që vijon, <a href=\"http://phpbb.com/\" target=\"_blank\">Vizito phpBB!</a> Do shikoni që lidhja hapet në një dritare të re duke i lejuar përdoruesit të vazhdojnë të përdorin forumin.</li><li>Nqs doni që adresa URL vetë të tregohet si lidhje shkruani:<br /><br /><b>[url]</b>http://phpbb.com/<b>[/url]</b><br /><br />Kjo do tregojë lidhjen që vijon, <a href=\"http://phpbb.com/\" target=\"_blank\">http://phpbb.com/</a></li><li>Për më tepër phpBB përdor dicka që quhet <i>Lidhjet Magjike</i>, kjo do e kthejë cdo URL me sintaksë korrekte në një lidhje pa patur nevojë te shkruhet ndonjë kod, nuk ka nevojë as për http://. Psh. shkruajtja e phpbb.com në mesazhin tuaj do krijojë një lidhje tek <a href=\"http://phpbb.com/\" target=\"_blank\">phpbb.com</a> në mënyrë automatike kur dikush lexon mesazhin. </li><li>E njëjta gjë aplikohet me adresat e postës elektronike, ju mund ta specifikoni adresën me anë të kodit, psh:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />e cila do tregojë <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> ose mund të shtypni thjesht no.one@domain.adr në mesazhin tuaj dhe adresa do konvertohet në lidhje në mënyrë automatike.</li></ul>Ashtu si me të gjitha kodet e tjera BBCode URL-të mund të mbështjellin cdo lloj kodi tjetër BBCode, psh <b>[img][/img]</b> (lexo më poshtë), <b>[b][/b]</b>, etj. Ashtu si me kodet e formatimit është në dorën tuaj që kodet të jenë hapur dhe mbyllur në rradhën e duhur, psh: <br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br /> <u>nuk</u> është korrekte gjë që mund të shkaktojë fshirjen e mesazhit tuaj.");

$faq[] = array("--", "Tregimi i imazheve");
$faq[] = array("Shtimi i një imazhi në mesazhin tuaj", "BBCode i phpBB përfshin një kod për tregimin e imazheve në mesazhet tuaja. Duhet të keni dy gjëra parasysh kur përdorni këtë kod; e para, shumë përdorues nuk e cmojnë vendosjen e shumë imazheve nëpër poste dhe e dyta imazhi duhet të jetë diku në internet para se të tregohet në një mesazh (nuk mund të ekzistojë vetëm në kompjuterin tuaj, përvec rastit kur keni një webserver). phpBB nuk e mundëson mbajtjen e imazheve në një dosje lokale tashti për tashti (këto cështje do adresohen në versionin e mëvonshëm të phpBB). Për të treguar një imazh duhet ta rrethoni URL-në (adresën në internet) e imazhit me kodet <b>[img][/img]</b>. Psh:<br /><br /><b>[img]</b>http://phpbb.com/images/phplogo.gif<b>[/img]</b><br /><br />Sic u tregua në seksionin e URL (mësipër) ju mund ta mbështillni një imazh me kodin <b>[url][/url]</b> nqs dëshironi që imazhi të shërbejë edhe si lidhje, psh.<br /><br /><b>[url=http://phpbb.com/][img]</b>http://phpbb.com/images/phplogo.gif<b>[/img][/url]</b><br /><br />do prodhonte:<br /><br /><a href=\"http://phpbb.com/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_phpBB_med.gif\" border=\"0\" alt=\"\" /></a><br />");
