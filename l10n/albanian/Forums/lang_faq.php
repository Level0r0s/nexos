...
/*********************************************
  ...
  ********************************************
  ...
  Translation by alket
   <alketttttt@yahoo.com>
   http://www26.brinkster.com/alketttt/

  $Source: /cvs/l10n/albanian/Forums/lang_faq.php,v $
  $Revision: 9.2 $
  $Author: djmaze $
...
$faq[] = array("A mund të postoj imazhe?", "Imazhen mund të tregohen në mesazhin tuaj. Megjithatë, nuk ka asnjë mënyrë për ti ngarkuar imazhet në regjistrin e këtij forumi. Prandaj ju duhet të krijoni një lidhje me një imazh në internet. Psh. http://diku.net/foto-ime.gif. Nuk mund të lidhni një imazh në kompjuterin tuaj ose imazhe që ruhen me fjalëkalim si psh. imazhe në inbox të hotmail apo yahoo etj. Për të krijuar lidhjen e imazhit me mesazhin tuaj përdor kodin BBCode [img] ose  HTML. (Nqs lejohet)");
...
$faq[] = array("Kush e krijoi këtë program?", "Ky program (në formën origjinale) u prodhua, lëshua dhe është pronë e  <a href=\"http://phpbb.com/\" target=\"_blank\">phpBB Group</a>. I disponueshëm sipas kushteve të GNU General Public Licence (Liçenca Publike e Përgjithshme)  dhe mund të kopjohet lirisht, kliko tek lidhja e mësipërme për detaje");
