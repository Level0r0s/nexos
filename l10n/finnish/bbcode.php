...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/finnish/bbcode.php,v $
  $Revision: 9.8 $
  $Author: nanocaiordo $
  $Date: 2006/05/14 01:10:28 $
Encoding test: n-array summation ∑ latin ae w/ acute ǽ
*******************************************************/
if (!defined('CPG_NUKE')) { exit; }
global $smilies_close, $smilies_more, $smilies_desc, $color_desc, $font_desc, $bbcode_common;

$smilies_close = 'Sulje ikkuna';
$smilies_more = 'Lisää hymiöitä';

$smilies_desc = array(
    'Exclamation' => 'Huuto',
    'Question' => 'Kysymys',
    'Very Happy' => 'Tosi onnellinen',
    'Smile' => 'Hymyilee',
    'Sad' => 'Surullinen',
    'Surprised' => 'Yllättynyt',
    'Shocked' => 'Järkyttynyt',
    'Confused' => 'Hölmistynyt',
    'Cool' => 'Cool',
    'Laughing' => 'Naurattaa',
    'Mad' => 'Vihainen',
    'Razz' => 'Turmeltunut',
    'Embarassed' => 'Nolostunut',
    'Crying or Very sad' => 'Itkee tai on tosi surullinen',
    'Evil or Very Mad' => 'Piru tai todella vihainen',
    'Twisted Evil' => 'Kiero piru',
    'Rolling Eyes' => 'Pyörittelee silmiä',
    'Wink' => 'Klikkaa silmää',
    'Idea' => 'Ajatus',
    'Arrow' => 'Nuoli',
    'Neutral' => 'Neutraali',
