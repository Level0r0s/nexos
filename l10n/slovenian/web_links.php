...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/slovenian/web_links.php,v $
  $Revision: 9.6 $
  $Author: nanocaiordo $
...
define('_LINKSNOTUSER8','<a href="'.getlink("Your_Account").'">Registrirajte se</a>');
...
define('_ONLYREGUSERSMODIFY','Samo člani lahko predlagajo spremembe downloada. Prosim <a href="'.getlink("Your_Account").'">registrirajte se ali pa se prijavite</a>.');
...
define('_RATENOTE4','Pogledate lahko listo <a href="'.getlink('Web_Links&l_op=TopRated').'">najvije ocenjenih strani</a>.');
...
define('_EZTRANSFERLINKS','Premakni vse povezave v kategoriji');
define('_CLEANLINKSDB','Očisti glaste linkov');
define('_EZTRANSFER','Premakni');
