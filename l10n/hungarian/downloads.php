...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/hungarian/downloads.php,v $
  $Revision: 9.7 $
  $Author: nanocaiordo $
...
define('_DOWNLOADSNOTUSER8','<a href="'.getlink("Your_Account").'">Regisztrálj!</a>');
...
define('_DRATENOTE4','Nézd meg a legjobbra osztályozott <a href="'.getlink("Downloads&amp;d_op=TopRated").'">Top letöltések listáját</a>.');
