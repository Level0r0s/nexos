...
/*********************************************
  ...
  ********************************************
  ...
  $Source: /cvs/l10n/tagalog/main.php,v $
  $Revision: 9.28 $
  $Author: estlane $
...
define('_SEARCH','hanapin');
define('_LOGIN','Login');
define('_WRITES','nagsusulat');
define('_POSTEDON','inilathala noong..');
define('_NICKNAME','palayaw');
define('_PASSWORD','Password');
define('_WELCOMETO','Welcome to');
define('_EDIT','baguhin');
define('_DELETE','burahin');
define('_POSTEDBY','iniliathala ni...');
define('_READS','mga bumasa');
...
define('_COMMENTS','komento');
define('_PASTARTICLES','nakaraang artikulo');
define('_OLDERARTICLES','lumang artikulo');
define('_BY','by');
define('_ON','on');
...
define('_ONEDAY','isang araw tulad ngayon...');
define('_ASREGISTERED','wala ka pang account? pwede kang <a href="'.getlink('Your_Account&amp;file=register').'">gumawa ng isa</a>.  bilang rehistradong gumagamit, magkakaroon ka ng bentahe tulad ng theme manager, konfigurasyon ng komento, at abilidad na mag lathala ng komento sa pangalan mo.');
...
define('_POLLS','Polls');
define('_PCOMMENTS','Konento:');
define('_RESULTS','Resulta:');
define('_HREADMORE','Bumasa pa...');
define('_CURRENTLY','Kasalukuyang meroong,');
define('_GUESTS','bisita at');
define('_MEMBERS','mga miyembro online.');
define('_YOUARELOGGED','nakalog ka bilang');
define('_YOUHAVE','meroon kang');
define('_PRIVATEMSG','pribadong mensahe(s).');
define('_YOUAREANON','Isa kang hindi kilalang bisita. Pwede kang magrehistro <a href="'.getlink('Your_Account&amp;file=register').'">dito</a>.');
define('_NOTE','Note:');
define('_ADMIN','Admin');
define('_WERECEIVED','Naktanggap kami');
...
define('_SELECTLANGUAGE','pumili ng linguahe');
...
define('_SENDEREMAIL','Email ng nagpadala');
define('_SENDERNAME','Pangalan ng nagpadala');
