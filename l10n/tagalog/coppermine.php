...
/*********************************************
  ...
  ********************************************
  $Source: /cvs/l10n/tagalog/coppermine.php,v $
  $Revision: 1.6 $
  $Author: nanocaiordo $
  $Date: 2008/03/20 11:59:36 $
...
define('PIC_VIEWS', 'bilang ng tumingin');//new in 1.2.2nuke
define('PIC_VOTES', 'bilang ng mga bomoto');//new in 1.2.2nuke
define('PIC_COMMENTS', 'komento');//new in 1.2.2nuke

// lang_translation_info
define('LANG_NAME_ENGLISH', 'Filipino');
define('LANG_NAME_NATIVE', 'tagalog');
define('LANG_COUNTRY_CODE', 'tl');
define('TRANS_NAME', 'poldo');
define('TRANS_EMAIL', 'whapakk@gmail.com');
define('TRANS_WEBSITE', '');
define('TRANS_DATE', '11/15/2004');
...
// some common strings
define('BACK', 'Balik');
define('CONTINU', 'Tapos');
define('INFO', 'Impormasyon');
...
define('RANDOM', 'Random na Larawan');
define('LASTUP', 'Hulind nadagdag');
define('LASTUPBY', 'Aking Huling Nadagdag');
define('LASTALB', 'Mga huling nadagdagang albums');
define('LASTCOM', 'Huling mga komento');
define('LASTCOMBY', 'Aking mga huling komento');
define('TOPN', 'Pinakaraming tumingin');
define('TOPRATED', 'Top rated');
define('LASTHITS', 'Huling tiningnan');
define('SEARCH', 'Resulta ng paghahanap');
define('FAVPICS', 'Paboritong Larawan');

// lang_errors
define('ACCESS_DENIED', 'Walang kang sapat na karapatan para sa pahinang ito');
define('PERM_DENIED', 'Wala');
define('PARAM_MISSING', 'Script called without the required parameter(s).');
define('NON_EXIST_AP', 'Ang piniling larawan/album ay wala.');
...
define('INVALID_IMAGE', 'Ang mga imaheng iyong ipinadala ay corrupted.');
