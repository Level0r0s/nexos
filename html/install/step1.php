...
/*
  ...
  | GPL V2 or higher.                                                 |
  +-------------------------------------------------------------------+
  | step1.php - NexOS installation step 1 - Server check              |
  | Authors:                                                          |
  |  Steven Sheeley                                                   |
  |  Richard R. Pufky                                                 |
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_setting'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_phpver'].'" style="cursor: help;" /></td>
	</tr><tr>
	  <td>GD</td><td>2.0</td><td>'.$gd.'</td>
	  <td align="center">'.$checks[((strpos($gd, '2.') === false)? 1 : 2)].'</td>
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_gdver'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_magic_quotes_status'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_magic_quotes_sybase_status'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_register_globals_status'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_ini_set_status'].'" style="cursor: help;" /></td>
	</tr><tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_leo_status'].'" style="cursor: help;" /></td>
	</tr><tr>
	  <td colspan="5"><hr noshade="noshade" size="1" /></td>
	</tr><tr>
	  <th colspan="4" nowrap="nowrap">'.$instlang['s1_directory_write'].'</th>
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_writeaccess'].'" style="cursor: help;" /></td>
	</tr>';
foreach ($dirs as $key => $data) {
	...
	echo '<tr>
	  ...
	  <td><img src="images/help.gif" alt="" title="'.$instlang['s1_'.$key].'" style="cursor: help;" /></td>
	</tr>';
}
	echo'</table>';
