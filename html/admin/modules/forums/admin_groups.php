 ...
 *
 *	 $Id: admin_groups.php,v 10.0 2010/11/05 00:56:57 djmaze Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
...
if (isset($_POST['group_update'])) {
	...
	else
	{
		...
		else if( $mode == 'newgroup' )
		{
			...
			$message = $lang['Added_new_group'] . '<br /><br />' . sprintf($lang['Click_return_groupsadmin'], '<a href="'.URL::admin("&amp;do=groups").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("forums").'">', '</a>');;
...
elseif (isset($_POST[POST_GROUPS_URL])) {
	...
	$template->assign_vars(array(
		...
		'S_GROUP_ACTION' => URL::admin("&amp;do=groups"),
...
else
{
	...
	$template->assign_vars(array(
		...
		'S_AUTH_ACTION' => URL::admin("&amp;do=groups"),
