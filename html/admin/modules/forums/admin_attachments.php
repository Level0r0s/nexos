 ...
 *
 *	 $Id: admin_attachments.php,v 10.0 2010/11/05 00:56:57 djmaze Exp $
 *
 ***************************************************************************/
...
if ($check_upload) {
	...
	if (!$error) {
		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="'.URL::admin("&amp;do=attachments&amp;mode=manage").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("Forums").'">', '</a>'));
		return;
	}
}
...
if ($check_image_cat) {
	...
	if (!$error) {
		message_die(GENERAL_MESSAGE, $lang['Test_settings_successful'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="'.URL::admin("&amp;do=attachments&amp;mode=cats").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("Forums").'">', '</a>'));
		return;
	}
}
...
if ($mode == 'manage') {
	if ($submit) {
		if (!$error) {
			message_die(GENERAL_MESSAGE, $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="'.URL::admin("&amp;do=attachments&amp;mode=manage").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("Forums").'">', '</a>'));
			return;
		}
	}
	...
	$template->assign_vars(array(
		...
		'S_ATTACH_ACTION' => URL::admin("&amp;do=attachments&amp;mode=manage"),
...
else if ($submit && $mode == 'shadow')
{
	...
	$message = $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="'.URL::admin("&amp;do=attachments&amp;mode=shadow").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("Forums").'">', '</a>');
	...
	$template->assign_vars(array(
		...
		'S_HIDDEN' => $hidden,
		'S_ATTACH_ACTION' => URL::admin("&amp;do=attachments&amp;mode=shadow"))
	);
	...
	if (!$error) {
		message_die(GENERAL_MESSAGE, $lang['Attach_config_updated'] . '<br /><br />' . sprintf($lang['Click_return_attach_config'], '<a href="'.URL::admin("&amp;do=attachments&amp;mode=cats").'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin("Forums").'">', '</a>'));
		return;
	}
}
else if ($mode == 'cats') {
	...
	$template->assign_vars(array(
		...
		'S_ATTACH_ACTION' => URL::admin("&amp;do=attachments&amp;mode=cats"))
	);
}
else if ($mode == 'sync') {
	if (GZIPSUPPORT) {
...
else if ($submit && $mode == 'quota')
{
	...
	$template->assign_vars(array(
		...
		'S_HIDDEN_FIELDS' => '',
		'S_ATTACH_ACTION' => URL::admin("&amp;do=attachments&amp;mode=quota"))
	);
	...
	for ($i = 0; $i < count($rows); $i++) {
		...
		$template->assign_block_vars('limit_row', array(
			...
			'U_VIEW' => URL::admin("&amp;do=attachments&amp;mode=$mode&amp;e_mode=view_quota&amp;quota_id=" . $rows[$i]['quota_limit_id']),
