 ...
 *
 *	 $Id: admin_forumauth.php,v 10.0 2010/11/05 00:56:57 djmaze Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
...
if (empty($forum_id)) {
	...
	$template->assign_vars(array(
		...
		'S_AUTH_ACTION' => URL::admin("&amp;do=forumauth"),
	...
	$switch_mode = URL::admin("&amp;do=forumauth&amp;" . POST_FORUM_URL . "=" . $forum_id . "&adv=". $adv_mode);
	...
	$template->assign_vars(array(
		...
		'S_FORUMAUTH_ACTION' => URL::admin("&amp;do=forumauth"),
