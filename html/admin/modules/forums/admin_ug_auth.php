 ...
 *
 *	 $Id: admin_ug_auth.php,v 10.2 2010/11/12 04:29:56 phoenix Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
...
else if (($mode == 'user' && (isset($_POST['username']) || $user_id ) ) || ($mode == 'group' && $group_id))
{
	...
	//
	if ($mode == 'user') {
		$row = $db->sql_ufetchrow("SELECT user_id FROM " . USER_GROUP_TABLE . " WHERE user_id = $user_id");
	...
	$template->assign_vars(array(
		...
		'S_HIDDEN_FIELDS' => $s_hidden_fields,
		'S_' . $l_type . '_ACTION' => URL::admin("&amp;do=ug_auth")
		)
	);
}
