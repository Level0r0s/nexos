 ...
 *
 *	 $Id: admin_words.php,v 10.0 2010/11/05 00:56:58 djmaze Exp $
 *
 *
 ***************************************************************************/
/***************************************************************************
...
if( $mode != "" ) {
	if( $mode == "edit" || $mode == "add" ) {
		...
		$template->assign_vars(array(
			...
			"S_WORDS_ACTION" => URL::admin("&amp;do=words"),
	...
	for($i = 0; $i < $word_count; $i++) {
		...
		$template->assign_block_vars("words", array(
			...
			"U_WORD_EDIT" => URL::admin("&amp;do=words&amp;mode=edit&amp;id=$word_id"),
			"U_WORD_DELETE" => URL::admin("&amp;do=words&amp;mode=delete&amp;id=$word_id")
			)
		);
	}
}
