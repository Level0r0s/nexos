...
*/
	...
	$message = $lang['Ban_update_sucessful'] . '<br /><br />' . sprintf($lang['Click_return_banadmin'], '<a href="'.URL::admin('&amp;do=user_ban').'">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_admin_index'], '<a href="'.URL::admin($op).'">', '</a>');
	...
	$template->assign_vars(array(
		...
		'S_BANLIST_ACTION' => URL::admin("&amp;do=user_ban")
		)
	);
	...
	$template->assign_vars(array(
		...
		'S_BAN_ACTION' => URL::admin("&amp;do=user_ban")
		)
	);
}
