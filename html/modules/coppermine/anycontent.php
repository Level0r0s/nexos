...
?><tr><td>
        <table class="tableb" width="100%" cellspacing="10">
            <tr> 
                ...
                <?php
                    if (can_admin('super')){echo'ADMIN: For info how to change this advertisment view your <a class="content" href="'.URL::index("&amp;file=help#config").'"> help file regarding content of the main page. </a><br /></td></tr><tr>
