...
function alb_list_box() {
    ...
    if ($db->sql_numrows($result)) {
        $lb = '<form method="post" action="'.URL::index("&amp;file=modifyalb",0,1).'" enctype="multipart/form-data" accept-charset="utf-8"><input type="hidden" name="name" value="'.$module_name.'" />
...
echo '
        ...
        <tr><form method="post" action="'.URL::index("&amp;file=db_input").'" enctype="multipart/form-data" accept-charset="utf-8">
