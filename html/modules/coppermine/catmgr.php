...
//<form method="post" action="'.URL::index("&amp;file=dbinput",0,1).'" enctype="multipart/form-data" accept-charset="utf-8">
//</form>
function cat_list_box($highlight = 0, $curr_cat, $on_change_refresh = true)
{
	global $CAT_LIST, $CPG_URL,$module_name,$file;
	$lb ='<form method="post" action="'.URL::index("&amp;file=catmgr",0,1).'" enctype="multipart/form-data" accept-charset="utf-8">';
