...
if (GALLERY_ADMIN_MODE) {
    ...
    echo '<tr>
            <td style="text-align:center"><form name="album_menu" method="post" action="'.URL::index('&amp;file=albmgr',0,1).'" enctype="multipart/form-data" accept-charset="'._CHARSET.'">';
    echo '
...
if (count($rowset) > 0) {
    ...
    echo '<tr>
            ...
            <tr>
                ...
                <form method="post" action="'.URL::index("&amp;file=editpics",1,1).'" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <td width="25" style="float:none;text-align:center">
                    <form method="post" action="'.URL::index("&amp;file=modifyalb",1,1).'" enctype="multipart/form-data" accept-charset="utf-8">
                        <input type="hidden" name="album" value="'.$album['aid'].'" />
                        <input name="submit" title="'.EDIT.' '.MODIFY.'" type="image" src="' . $THEME_DIR . '/images/edit.gif" /></form>' . "\n".'
                </td>
                <td width="25" style="float:none;text-align:center">
                    <form method="post" action="'.URL::index("&amp;file=delete",1,1).'" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                if ($album['pos'] > 0) {
                    echo '<form method="post" action="'.URL::index("&amp;file=albmgr",1,1).'" enctype="multipart/form-data" accept-charset="utf-8">
               ...
               <input name="submit" type="image" src="images/top.gif" /></form>'. "\n".
                    ...
                    '</td><td width="25" style="float:none;text-align:center">
                    <form method="post" action="'.URL::index("&amp;file=albmgr",1,1).'" enctype="multipart/form-data" accept-charset="utf-8">
...
echo '</table><hr />
    ...
    <form name="new_album" method="post" action="'.URL::index('&amp;file=albmgr').'" enctype="multipart/form-data" accept-charset="'._CHARSET.'">
