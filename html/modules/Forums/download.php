 ...
 *
 *	 $Id: download.php,v 9.7 2008/08/03 04:59:46 nanocaiordo Exp $
 *
 *
 ***************************************************************************/
...
function send_file_to_browser($attachment, $upload_dir)
{
	...
	if (preg_match('#Opera(/| )([0-9].[0-9]{1,2})#', $HTTP_USER_AGENT))	 {
		$browser_agent = 'opera';
	} else if (preg_match('#MSIE ([0-9].[0-9]{1,2})#', $HTTP_USER_AGENT)) {
		$browser_agent = 'ie';
	} else if (preg_match('#OmniWeb/([0-9].[0-9]{1,2})#', $HTTP_USER_AGENT)) {
		$browser_agent = 'omniweb';
	} else if (preg_match('#Netscape([0-9]{1})#', $HTTP_USER_AGENT)) {
		$browser_agent = 'netscape';
	} else if (preg_match('#Mozilla/([0-9].[0-9]{1,2})#', $HTTP_USER_AGENT)) {
		$browser_agent = 'mozilla';
	} else if (preg_match('#Konqueror/([0-9].[0-9]{1,2})#', $HTTP_USER_AGENT)) {
