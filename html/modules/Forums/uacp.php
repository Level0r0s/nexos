 ...
 *
 *	 $Id: uacp.php,v 9.11 2008/07/31 14:12:39 nanocaiordo Exp $
 *
 *
 ***************************************************************************/
...
if ( ($confirm) && (count($delete_id_list) > 0) ) {
	...
	$template->assign_vars(array(
		...
		'S_CONFIRM_ACTION' => URL::index('&amp;file=uacp'),
...
$template->assign_vars(array(
	...
	'S_MODE_ACTION' => URL::index('&amp;file=uacp'),
	...
	for ($i = 0; $i < count($attachments); $i++) {
		...
		if (count($post_titles) > 0) {
			...
			$template->assign_block_vars('attachrow', array(
				...
				'U_VIEW_ATTACHMENT' => URL::index('Forums&amp;file=download&amp;id='.$attachments[$i]['attach_id'])
	// PM error ?
