...
function Stats_Main() {
	...
	$cpgtpl->assign_vars(array(
		'S_STATS_TITLE' => $MAIN_CFG['global']['sitename'].' '._STATS,
		'S_STATS_TOTAL' => _WERECEIVED.' <b>'.$totalbr.'</b> '._PAGESVIEWS.' '.$MAIN_CFG['global']['startdate'],
		'L_STATS_DETAIL' => _VIEWDETAILED,
		'L_STATS_BROWSERS' => _BROWSERS,
		'L_STATS_OS' => _OPERATINGSYS,
		'L_STATS_MISC' => _MISCSTATS,
		'U_STATS_DETAIL' => URL::index("&amp;file=details")
	));
