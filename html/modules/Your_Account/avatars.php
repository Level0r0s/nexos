...
function display_avatar_gallery(&$userinfo)
{
	...
	if (!defined('ADMIN_PAGES')) {
		...
		echo '<br />
		<a href="'.URL::admin('users&amp;mode=edit&amp;edit=profile&amp;id='.$userinfo['user_id']).'">'._MA_PROFILE_INFO.'</a> |
		<a href="'.URL::admin('users&amp;mode=edit&amp;edit=reg_details&amp;id='.$userinfo['user_id']).'">'._MA_REGISTRATION_INFO.'</a> |
		<a href="'.URL::admin('users&amp;mode=edit&amp;edit=avatar&amp;id='.$userinfo['user_id']).'">'._AVATAR_CONTROL.'</a>';
		if ($userinfo['user_level'] > 0) {
			echo ' | <a href="'.URL::admin("users&amp;mode=edit&amp;edit=admin&amp;id=$userinfo[user_id]").'">'._MA_PRIVILEGES.'</a>';
		}
		echo '<br /><br />';
		$action = URL::admin('users&amp;mode=edit&amp;edit=avatar&amp;id='.$userinfo['user_id']);
	}
