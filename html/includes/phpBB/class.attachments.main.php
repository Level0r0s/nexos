 ...
 *
 *	 $Id: class.attachments.main.php,v 9.15 2008/07/31 14:08:07 nanocaiordo Exp $
 *
 *
 ***************************************************************************/
...
class attach_parent
{
	...
	private $post_attach = FALSE;
	private $attach_filename = '';
	private $filename = '';
	private $type = '';
	private $extension = '';
	private $file_comment = '';
	private $num_attachments = 0; // number of attachments in message
	private $filesize = 0;
	private $filetime = 0;
	private $thumbnail = 0;

	// Switches
	private $add_attachment_body = 0;
	private $posted_attachments_body = 0;
...
//display_compile_cache_clear($template->files['attachbody'], 'attachbody');
		...
		$template->assign_vars(array(
			...
			'RULES' => '<a href="' . URL::index("Forums&amp;file=attach_rules&amp;f=$u_rules_id&amp;popup=1") . '" target="_blank">' . $lang['Allowed_extensions_and_sizes'] . '</a>',
