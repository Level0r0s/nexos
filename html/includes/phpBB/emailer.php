...
/***************************************************************************
	...
	$Id: emailer.php,v 9.10 2009/03/05 16:48:27 djmaze Exp $
...
{
	public $msg;
	private $subject, $extra_headers;
	private $addresses, $reply_to, $from;
	private $use_smtp;
	...
	public function send()
	{
		...
		foreach ($this->vars as $key => $val) { $this->msg = str_replace('{'.$key.'}', $val, $this->msg); }
