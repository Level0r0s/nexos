...
/*
  ...
  | GPL V2 or higher.                                                 |
  +-------------------------------------------------------------------+
  | meta.php - NexOS meat tag generator file                          |
  | Authors:                                                          |
  |  Steven Sheeley                                                   |
  |  Richard R. Pufky                                                 |
...
switch($module_name) {
	...
	case 'Stories_Archive':
		$METATAGS['description'] = _Stories_ArchiveLANG. ' '. $MAIN_CFG['global']['slogan'];
		$METATAGS['keywords'] .= ', fast, secure, security, cms, content, management, system';
	break;
	case 'Surveys':
		$METATAGS['description'] = _SurveysLANG. ' '. $MAIN_CFG['global']['slogan'];
		$METATAGS['keywords'] .= ', fast, secure, security, cms, content, management, system';
	break;
	case 'Tell_a_Friend':
