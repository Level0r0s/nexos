...
abstract class CVS {
	...
	public static function create($path, $server, $folder, $module, $username='anonymous', $password='', $protocol='pserver') {
	...
	public static function update($path, $recursive=true) {
		if (is_dir($path.'/CVS')) {
