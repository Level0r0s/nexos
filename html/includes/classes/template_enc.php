...
class tpl_encode
{
	...
	private function compile_var_tags(&$text_blocks)
	{
		...
		$text_blocks = preg_replace('#L?_\(([a-z0-9\-_]*?)\)#is', '<?php echo (isset($lang[\'$1\']) ? $lang[\'$1\'] : _$1); ?>', $text_blocks);
	...
	private function compile_tag_define($tag_args, $option)
	{
	...
	// This is from Smarty
	private function parse_is_expr($is_arg, $tokens) {
		$expr_end =	0;
		$negate_expr = false;
	 ...
	 */
	private function generate_block_data_ref($blockname, $include_last_iterator, $defop)
	{
