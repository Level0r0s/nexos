...
define('_ASREGISTERED','Don\'t have an account yet? You can <a href="'.URL::index('Your_Account&amp;file=register').'">create one</a>. As a registered user you have some cool advantages like a theme manager, comments configuration and the ability to post comments with your name.');
...
define('_YOUAREANON','You are an anonymous user. You can register for free by following <a href="'.URL::index('Your_Account&amp;file=register').'">this</a> link');
define('_NOTE','Note:');
define('_ADMIN','Admin');
